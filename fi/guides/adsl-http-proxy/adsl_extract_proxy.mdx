...
ADSL:n IP-osoitteiden poimimiseen ja ADSL Proxyyn IP-valkoisen listan lisäämiseen voit ensin siirtyä sivuille [ADSL Proxy Extract API](https://platform.acedata.cloud/documents/d8426c17-d22c-449a-b6bf-0a7790928e4d) ja [ADSL Proxy Whitelist API](https://platform.acedata.cloud/documents/c21534fe-1f62-424b-9b10-a805cb473dd1) ja napsauttaa "Acquire" -painiketta saadaksesi tarvittavat todisteet:
...
Seuraavaksi voit täyttää vastaavat tiedot sivustolla [ADSL Proxy Extract API](https://platform.acedata.cloud/documents/d8426c17-d22c-449a-b6bf-0a7790928e4d), ja seuraavaksi näytämme, kuinka poimia ADSL:n IP-osoitteet.
