...
Per utilizzare l'API, è necessario prima richiedere il servizio corrispondente sulla pagina [SeeDream Images Generation API](https://api.xhuoapi.ai/documents/seedream-images). Una volta entrati nella pagina, cliccare sul pulsante "Acquire", come mostrato nell'immagine:
