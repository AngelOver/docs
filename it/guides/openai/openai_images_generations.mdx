...
Per utilizzare OpenAI Images Generations API, è possibile visitare la pagina [OpenAI Images Generations API](https://api.xhuoapi.ai/documents/fd932485-90c7-45d6-8394-1e14b6f07b2b) e cliccare sul pulsante "Acquire" per ottenere le credenziali necessarie per le richieste:
