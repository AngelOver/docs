...
Per utilizzare l'API OpenAI Embeddings, puoi prima andare alla pagina [OpenAI Embeddings API](https://api.xhuoapi.ai/documents/0f2e63fa-5890-4bdd-84f0-1706b5c9a387) e cliccare sul pulsante "Acquire" per ottenere le credenziali necessarie per la richiesta:
