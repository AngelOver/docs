...
Per utilizzare l'API OpenAI Chat Completion, è possibile visitare la pagina [OpenAI Chat Completion API](https://api.xhuoapi.ai/documents/1bcf3bba-102b-495d-9bba-47cd96717e45) e fare clic sul pulsante "Acquire" per ottenere le credenziali necessarie per la richiesta:
...
OPENAI_BASE_URL="https://api.xhuoapi.ai/v1/openai"  # Ricorda: se utilizzi la chiave OpenAI ufficiale, non utilizzare questo indirizzo.
```
