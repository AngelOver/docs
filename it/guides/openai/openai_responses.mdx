...
Per utilizzare l'API OpenAI Responses, puoi prima andare alla pagina [OpenAI Responses API](https://api.xhuoapi.ai/documents/81e285a6-d010-4a2d-a3a8-ca113d4ef82a) e fare clic sul pulsante "Acquire" per ottenere le credenziali necessarie per la richiesta:
