...
Per utilizzare l'API OpenAI Chat Completion 4o Image, prima di tutto puoi andare alla pagina [OpenAI Chat Completion 4o Image API](https://api.xhuoapi.ai/documents/1bcf3bba-102b-495d-9bba-47cd96717e45) e cliccare sul pulsante "Acquire" per ottenere le credenziali necessarie per la richiesta:
