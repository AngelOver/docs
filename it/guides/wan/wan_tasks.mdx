...
Per utilizzare l'API Wan Tasks, è necessario prima andare alla pagina di richiesta [Wan Videos Generation API](https://api.xhuoapi.ai/documents/52b0f490-1bbf-4fe5-b60e-96626d333d2c) per richiedere il servizio corrispondente, quindi copiare l'ID dell'attività dell'API Wan Videos Generation, come mostrato nell'immagine:

<p><img src="https://cdn.xhuoapi.ai/om6p6g.png" width="500" className="m-auto" /></p>

Infine, accedi alla pagina dell'API Tasks [Wan Tasks API](https://api.xhuoapi.ai/documents/240ef446-cbec-461c-a633-4a64178d7018) per richiedere il servizio corrispondente. Dopo essere entrato nella pagina, fai clic sul pulsante "Acquire", come mostrato nell'immagine:
...
L'API Wan Tasks può essere utilizzata per consultare i risultati dell'API Wan Videos Generation. Per informazioni su come utilizzare l'API Wan Videos Generation, fare riferimento al documento [Wan Videos Generation API](https://api.xhuoapi.ai/documents/52b0f490-1bbf-4fe5-b60e-96626d333d2c).
