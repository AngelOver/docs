...
Per utilizzare l'API Midjourney Translate, è necessario prima andare alla pagina di richiesta [Midjourney Translate API](https://api.xhuoapi.ai/documents/e067d19b-7a66-4458-a45f-0fe88c1d5d34) per richiedere il servizio corrispondente. Una volta entrati nella pagina, cliccate sul pulsante "Acquire", come mostrato nell'immagine:

![Pagina di richiesta](https://cdn.xhuoapi.ai/rci31i.png)

Se non siete ancora registrati o loggati, sarete automaticamente reindirizzati alla [pagina di login](https://api.xhuoapi.ai) che vi inviterà a registrarvi e a loggarvi. Dopo aver effettuato il login o la registrazione, sarete automaticamente riportati alla pagina corrente.
