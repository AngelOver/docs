...
Per utilizzare l'API Midjourney Shorten, è necessario prima richiedere il servizio sulla pagina [Midjourney Shorten API](https://api.xhuoapi.ai/documents/f0c6be1d-c084-43ac-bde6-44ef9cf824a2). Una volta entrati nella pagina, cliccare sul pulsante "Acquire".

Se non sei ancora loggato o registrato, verrai automaticamente reindirizzato alla [pagina di login](https://api.xhuoapi.ai) per registrarti e accedere; dopo il login, tornerai automaticamente alla pagina corrente.
