...
Per utilizzare l'API Hailuo Tasks, è necessario prima andare alla pagina di richiesta [Hailuo Videos Generation API](https://api.xhuoapi.ai/documents/ee06377b-9185-438f-ac84-3376bcb1275e) per richiedere il servizio corrispondente, quindi copiare l'ID dell'attività dell'API Hailuo Videos Generation, come mostrato nell'immagine:

<p><img src="https://cdn.xhuoapi.ai/4f9d95.png" width="500" className="m-auto" /></p>

Infine, accedi alla pagina dell'API Tasks [Hailuo Tasks API](https://api.xhuoapi.ai/documents/4b1ccdbc-b8ed-4171-9a14-48e10970ba04) per richiedere il servizio corrispondente. Una volta entrato nella pagina, fai clic sul pulsante "Acquire", come mostrato nell'immagine:
...
L'API Hailuo Tasks può essere utilizzata per interrogare i risultati dell'API Hailuo Videos Generation. Per informazioni su come utilizzare l'API Hailuo Videos Generation, fare riferimento al documento [Hailuo Videos Generation API](https://api.xhuoapi.ai/documents/d2fc9087-2996-4573-bfe5-8b1c828fdfc7).
