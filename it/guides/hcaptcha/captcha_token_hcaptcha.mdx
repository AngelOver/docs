...
Per utilizzare l'API, è necessario prima andare alla pagina corrispondente dell'[API di riconoscimento del protocollo hCaptcha](https://api.xhuoapi.ai/documents/34806b3a-f0f6-45c5-b8b1-143ced7b9393) per richiedere il servizio corrispondente. Una volta entrati nella pagina, fare clic sul pulsante "Acquire", come mostrato nell'immagine:
