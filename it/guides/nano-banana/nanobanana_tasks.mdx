...
L'API Nano Banana Tasks può essere utilizzata per interrogare i risultati dell'API Nano Banana Images. Per informazioni su come utilizzare l'API Nano Banana Images, fare riferimento al documento [Nano Banana Images API](https://api.xhuoapi.ai/documents/63e01dc3-eb21-499e-8049-3025c460058f).
