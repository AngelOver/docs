...
Prima di utilizzare, accedi alla piattaforma XHuoAPI e vai a [Nano Banana Images API](https://api.xhuoapi.ai/documents/23985a11-d713-41d1-ad84-24b021805b3d) e clicca su Acquire per richiedere l'attivazione. La prima richiesta di solito avrà un credito gratuito disponibile. Una volta completata l'attivazione, potrai ottenere il Bearer Token necessario per chiamare l'API.
