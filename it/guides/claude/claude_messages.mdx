...
Per utilizzare Claude Messages API, puoi prima andare alla pagina [Claude Messages API](https://api.xhuoapi.ai/documents/280928a2-2dce-419c-adb5-1ea835e8183a) e cliccare sul pulsante "Acquire" per ottenere le credenziali necessarie per la richiesta:
...
XHuoAPI offre due formati di API Claude, le principali differenze sono le seguenti:
