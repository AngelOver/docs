...
Per utilizzare l'API, è necessario prima richiedere il servizio corrispondente sulla pagina [API di conversione del genere facciale](https://api.xhuoapi.ai/documents/0e4e5318-060e-4976-8d3a-171301240f8c). Dopo essere entrati nella pagina, cliccare sul pulsante "Acquire", come mostrato nell'immagine:
