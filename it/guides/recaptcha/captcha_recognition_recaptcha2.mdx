...
Per utilizzare l'API, è necessario prima richiedere il servizio corrispondente sulla pagina [API di riconoscimento delle immagini Recaptcha2](https://api.xhuoapi.ai/documents/b9bf7d07-b178-4881-ae45-a852ec40f53e), una volta entrati nella pagina, cliccare sul pulsante "Acquire", come mostrato nell'immagine:
