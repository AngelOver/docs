...
Per utilizzare l'API, è necessario prima andare alla pagina corrispondente dell'[API di riconoscimento del protocollo Recaptcha3](https://api.xhuoapi.ai/documents/1083df69-f2f3-4c13-901e-e5336b0dbe3d) per richiedere il servizio corrispondente. Una volta entrati nella pagina, cliccare sul pulsante "Acquire", come mostrato nell'immagine:
