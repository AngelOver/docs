...
Per utilizzare l'API, è necessario prima visitare la pagina corrispondente all' [API di riconoscimento del protocollo Recaptcha2](https://api.xhuoapi.ai/documents/597b8f11-26d8-4a1d-9a83-8d33bc4b8af7) per richiedere il servizio corrispondente. Una volta entrati nella pagina, cliccare sul pulsante "Acquire", come mostrato nell'immagine:
