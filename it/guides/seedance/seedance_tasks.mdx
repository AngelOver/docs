...
Per utilizzare l'API SeeDance Tasks, è necessario prima visitare la pagina di richiesta [SeeDance Video Generation API](https://api.xhuoapi.ai/documents/seedance-videos) per richiedere il servizio corrispondente, quindi copiare l'ID dell'attività dell'API SeeDance Video Generation, come mostrato nell'immagine:

<p><img src="https://cdn.xhuoapi.ai/om6p6g.png" width="500" className="m-auto" /></p>

Infine, vai alla pagina dell'API Tasks [SeeDance Tasks API](https://api.xhuoapi.ai/documents/seedance-tasks) per richiedere il servizio corrispondente. Dopo essere entrato nella pagina, fai clic sul pulsante "Acquire", come mostrato nell'immagine:
...
L'API SeeDance Tasks può essere utilizzata per interrogare i risultati dell'API SeeDance Video Generation. Per informazioni su come utilizzare l'API SeeDance Video Generation, fare riferimento al documento [SeeDance Video Generation API](https://api.xhuoapi.ai/documents/seedance-videos-integration).
