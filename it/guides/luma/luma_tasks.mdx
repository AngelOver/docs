...
Per utilizzare l'API Luma Tasks, è necessario prima andare alla pagina di richiesta [Luma Videos Generation API](https://api.xhuoapi.ai/documents/5bd3597d-1ff8-44ad-a580-b66b48393e7f) per richiedere il servizio corrispondente, quindi copiare l'ID dell'attività dell'API Luma Videos Generation, come mostrato nell'immagine:

![](https://cdn.xhuoapi.ai/ynk4ow.png)

Infine, accedi alla pagina dell'API Tasks [Luma Tasks API](https://api.xhuoapi.ai/documents/7d32369c-4ead-4364-a4c5-652bc768b3ff) per richiedere il servizio corrispondente. Una volta entrato nella pagina, fai clic sul pulsante "Acquire", come mostrato nell'immagine:
...
L'API Luma Tasks può essere utilizzata per interrogare i risultati dell'API Luma Videos Generation. Per informazioni su come utilizzare l'API Luma Videos Generation, fare riferimento al documento [Luma Videos Generation API](https://api.xhuoapi.ai/documents/16bb0108-1f09-45b3-97ac-16a668750a8c).
