...
Per utilizzare l'API Sora Tasks, è necessario prima andare alla pagina di richiesta [Sora Videos Generation API](https://api.xhuoapi.ai/documents/99a24421-2e22-4028-8201-e19cb834b67e) per richiedere il servizio corrispondente, quindi copiare l'ID dell'attività dell'API Sora Videos Generation, come mostrato nell'immagine:

<p><img src="https://cdn.xhuoapi.ai/za62pb.png" width="500" className="m-auto" /></p>

Infine, accedi alla pagina dell'API Tasks [Sora Tasks API](https://api.xhuoapi.ai/documents/c9d81bad-9064-4796-86b6-4fb43cc93a16) per richiedere il servizio corrispondente. Una volta entrato nella pagina, fai clic sul pulsante "Acquire", come mostrato nell'immagine:
...
L'API Sora Tasks può essere utilizzata per interrogare i risultati dell'API Sora Videos Generation. Per informazioni su come utilizzare l'API Sora Videos Generation, fare riferimento al documento [Sora Videos Generation API](https://api.xhuoapi.ai/documents/sora-videos-integration).
