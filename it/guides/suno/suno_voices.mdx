...
Con l'ID del personaggio vocale, possiamo utilizzare la [Suno Audios Generation API](https://api.xhuoapi.ai/documents/4da95d9d-7722-4a72-857d-bf6be86036e9) per generare musica. Impostiamo `action` su `generate` e `persona_id` sull'ID del personaggio vocale ottenuto; la canzone generata sarà cantata con la voce clonata.
