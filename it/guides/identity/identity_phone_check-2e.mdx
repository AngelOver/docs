...
Per utilizzare l'API, è necessario prima andare alla pagina corrispondente dell'[API di verifica a due fattori del numero di cellulare](https://api.xhuoapi.ai/documents/1f39c948-6d9b-48f5-83fb-0719da4f6ab0) per richiedere il servizio corrispondente. Una volta entrati nella pagina, fare clic sul pulsante "Acquire", come mostrato nell'immagine:
