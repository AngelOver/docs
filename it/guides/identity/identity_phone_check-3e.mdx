...
Per utilizzare l'API, è necessario prima andare alla pagina corrispondente [Verifica dei tre elementi del numero di telefono API](https://api.xhuoapi.ai/documents/b4c50108-dda5-4ddb-ba84-776060fb0151) per richiedere il servizio corrispondente. Una volta entrati nella pagina, fare clic sul pulsante "Acquire", come mostrato nell'immagine:
