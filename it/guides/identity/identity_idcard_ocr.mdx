...
Per utilizzare l'API, è necessario prima richiedere il servizio corrispondente sulla pagina [API di riconoscimento e verifica delle informazioni della carta d'identità](https://api.xhuoapi.ai/documents/67f96afa-60b8-4cbb-a4bf-0cbfcf139a23); una volta entrati nella pagina, fare clic sul pulsante "Acquire", come mostrato nell'immagine:
