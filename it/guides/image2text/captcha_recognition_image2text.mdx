...
Per utilizzare l'API, è necessario prima visitare la pagina corrispondente all'[API di riconoscimento dei CAPTCHA alfanumerici](https://api.xhuoapi.ai/documents/cd1f56dc-e9c9-4293-9c68-80fa560c9087) e richiedere il servizio corrispondente. Una volta entrati nella pagina, cliccare sul pulsante "Acquire", come mostrato nell'immagine:
