...
[MCP (Model Context Protocol)](https://modelcontextprotocol.io) è un protocollo di contesto del modello lanciato da Anthropic, che consente ai modelli AI (come Claude, GPT, ecc.) di chiamare strumenti esterni tramite interfacce standardizzate. Attraverso il SERP MCP Server fornito da XHuoAPI, puoi effettuare ricerche su Google direttamente nei client AI come Claude Desktop, VS Code, Cursor, ottenendo risultati di ricerca per pagine web, immagini, notizie, video, luoghi, ecc.
...
2. Vai alla pagina [Google SERP API](https://api.xhuoapi.ai/documents/serp-google)
...
- Repository GitHub: [XHuoAPI/SerpMCP](https://github.com/XHuoAPI/SerpMCP)
- Pacchetto PyPI: [mcp-serp](https://pypi.org/project/mcp-serp/)
- Documentazione API: [API del motore di ricerca](https://api.xhuoapi.ai/documents/serp)
