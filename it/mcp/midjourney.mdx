...
[MCP (Model Context Protocol)](https://modelcontextprotocol.io) è un protocollo di contesto del modello lanciato da Anthropic, che consente ai modelli AI (come Claude, GPT, ecc.) di chiamare strumenti esterni tramite interfacce standardizzate. Attraverso il Midjourney MCP Server fornito da XHuoAPI, puoi generare e modificare direttamente immagini AI in client AI come Claude Desktop, VS Code, Cursor, ecc.
...
Prima di utilizzare, è necessario ottenere il token API di XHuoAPI:

1. Registrati o accedi alla [piattaforma XHuoAPI](https://api.xhuoapi.ai)
2. Vai alla pagina [Midjourney Imagine API](https://api.xhuoapi.ai/documents/midjourney-imagine)
...
- Repository GitHub: [XHuoAPI/MidjourneyMCP](https://github.com/XHuoAPI/MidjourneyMCP)
- Pacchetto PyPI: [mcp-midjourney](https://pypi.org/project/mcp-midjourney/)
- Documentazione API: [API di generazione Midjourney](https://api.xhuoapi.ai/documents/midjourney)
