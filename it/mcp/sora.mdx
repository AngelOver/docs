...
[MCP (Model Context Protocol)](https://modelcontextprotocol.io) è un protocollo di contesto del modello lanciato da Anthropic, che consente ai modelli AI (come Claude, GPT, ecc.) di chiamare strumenti esterni tramite interfacce standardizzate. Attraverso il Sora MCP Server fornito da XHuoAPI, puoi utilizzare direttamente OpenAI Sora per generare video AI in client AI come Claude Desktop, VS Code, Cursor, ecc.
...
2. Vai alla pagina [Sora Videos API](https://api.xhuoapi.ai/documents/sora-videos)
...
- Repository GitHub: [XHuoAPI/SoraMCP](https://github.com/XHuoAPI/SoraMCP)
- Pacchetto PyPI: [mcp-sora](https://pypi.org/project/mcp-sora/)
- Documentazione API: [API di generazione video Sora](https://api.xhuoapi.ai/documents/sora)
