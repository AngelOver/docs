...
[MCP (Model Context Protocol)](https://modelcontextprotocol.io) è un protocollo di contesto del modello lanciato da Anthropic, che consente ai modelli AI (come Claude, GPT, ecc.) di chiamare strumenti esterni tramite interfacce standardizzate. Attraverso il Nano Banana MCP Server fornito da XHuoAPI, puoi generare e modificare immagini AI direttamente nei client AI come Claude Desktop, VS Code, Cursor, ecc.
...
2. Vai alla pagina [Nano Banana Images API](https://api.xhuoapi.ai/documents/nano-banana-images)
...
- Repository GitHub: [XHuoAPI/NanoBananaMCP](https://github.com/XHuoAPI/NanoBananaMCP)
- Pacchetto PyPI: [mcp-nanobanana-pro](https://pypi.org/project/mcp-nanobanana-pro/)
- Documentazione API: [Nano Banana API](https://api.xhuoapi.ai/documents/nano-banana)
