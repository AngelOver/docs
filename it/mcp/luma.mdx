...
[MCP (Model Context Protocol)](https://modelcontextprotocol.io) è un protocollo di contesto del modello lanciato da Anthropic, che consente ai modelli AI (come Claude, GPT, ecc.) di chiamare strumenti esterni tramite interfacce standardizzate. Attraverso il Luma MCP Server fornito da XHuoAPI, puoi generare video AI direttamente nei client AI come Claude Desktop, VS Code, Cursor, ecc.
...
2. Vai alla pagina [Luma Videos API](https://api.xhuoapi.ai/documents/luma-videos)
...
- Repository GitHub: [XHuoAPI/LumaMCP](https://github.com/XHuoAPI/LumaMCP)
- Pacchetto PyPI: [mcp-luma](https://pypi.org/project/mcp-luma/)
- Documentazione API: [API di generazione video Luma](https://api.xhuoapi.ai/documents/luma)
