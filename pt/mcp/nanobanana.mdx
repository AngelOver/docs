...
2. Vá para a página da [API de Imagens Nano Banana](https://api.xhuoapi.ai/documents/nano-banana-images)
...
- Repositório no GitHub: [XHuoAPI/NanoBananaMCP](https://github.com/XHuoAPI/NanoBananaMCP)
- Pacote PyPI: [mcp-nanobanana-pro](https://pypi.org/project/mcp-nanobanana-pro/)
- Documentação da API: [Nano Banana API](https://api.xhuoapi.ai/documents/nano-banana)
