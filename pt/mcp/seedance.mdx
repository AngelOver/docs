...
[MCP (Model Context Protocol)](https://modelcontextprotocol.io) é um protocolo de contexto de modelo lançado pela Anthropic, que permite que modelos de IA (como Claude, GPT, etc.) chamem ferramentas externas por meio de uma interface padronizada. Com o Seedance MCP Server fornecido pela XHuoAPI, você pode usar diretamente a geração de vídeos de IA da Seedance da ByteDance em clientes de IA como Claude Desktop, VS Code, Cursor, entre outros.
...
2. Acesse a página da [Seedance Videos API](https://api.xhuoapi.ai/documents/seedance-videos)
...
- Repositório GitHub: [XHuoAPI/SeedanceMCP](https://github.com/XHuoAPI/SeedanceMCP)
- Pacote PyPI: [mcp-seedance](https://pypi.org/project/mcp-seedance/)
- Documentação da API: [Seedance Vídeo API](https://api.xhuoapi.ai/documents/seedance)
