...
2. Vá para a página [Sora Videos API](https://api.xhuoapi.ai/documents/sora-videos)
...
- Repositório no GitHub: [XHuoAPI/SoraMCP](https://github.com/XHuoAPI/SoraMCP)
- Pacote PyPI: [mcp-sora](https://pypi.org/project/mcp-sora/)
- Documentação da API: [API de Geração de Vídeos Sora](https://api.xhuoapi.ai/documents/sora)
