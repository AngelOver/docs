...
2. Vá para a página da [API de Vídeos Luma](https://api.xhuoapi.ai/documents/luma-videos)
...
- Repositório no GitHub: [XHuoAPI/LumaMCP](https://github.com/XHuoAPI/LumaMCP)
- Pacote PyPI: [mcp-luma](https://pypi.org/project/mcp-luma/)
- Documentação da API: [API de Geração de Vídeos Luma](https://api.xhuoapi.ai/documents/luma)
