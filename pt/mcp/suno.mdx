...
2. Vá para a página [Suno Audios API](https://api.xhuoapi.ai/documents/suno-audios)
...
- Repositório no GitHub: [XHuoAPI/SunoMCP](https://github.com/XHuoAPI/SunoMCP)
- Pacote PyPI: [mcp-suno](https://pypi.org/project/mcp-suno/)
- Documentação da API: [API de Geração de Música Suno](https://api.xhuoapi.ai/documents/suno)
