...
Para usar a API, você precisa primeiro acessar a página correspondente da [API de Informação de Identidade e Verificação de Validade](https://api.xhuoapi.ai/documents/667017a4-017f-4af0-870e-807034f70632) para solicitar o serviço correspondente. Após entrar na página, clique no botão "Adquirir", conforme mostrado na imagem:
