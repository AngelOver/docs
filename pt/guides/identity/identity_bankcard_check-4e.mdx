...
Para usar a API, você precisa primeiro acessar a página correspondente da [API de Verificação dos Quatro Elementos do Cartão Bancário](https://api.xhuoapi.ai/documents/02f77369-ec7b-4218-a956-d7a84982a626) para solicitar o serviço correspondente. Após entrar na página, clique no botão "Adquirir", conforme mostrado na imagem:
