...
Este documento descreve principalmente como configurar e usar o Claude Code GitHub Actions através do serviço de proxy da XHuoAPI.

## Processo de Solicitação

Para usar o Claude Code, primeiro você pode acessar a [página de serviços do Claude Messages](https://api.xhuoapi.ai/documents/claude-messages) e clicar no botão "Acquire" para obter as credenciais necessárias para a solicitação:
...
![Página de Instalação do App do GitHub Claude](https://cdn.xhuoapi.ai/ba4b8df66d.png)
...
Adicione a chave da API da XHuoAPI como um Secret do repositório:

1. Acesse **Settings** do repositório → **Secrets and variables** → **Actions**
2. Clique em **New repository secret**
3. No campo Name, preencha `ANTHROPIC_API_KEY`, e no campo Value, insira o token da API que você obteve na XHuoAPI
4. Clique em **Add secret** para salvar

> **Dica**: O token da API pode ser visualizado no [console da XHuoAPI](https://api.xhuoapi.ai/console).
...
Se precisar usar o endpoint da API de proxy da XHuoAPI, também será necessário definir a variável de ambiente no Workflow:
...
Faça login no [Painel de Controle XHuoAPI](https://api.xhuoapi.ai/console) para visualizar o saldo restante e o uso atual da conta.
