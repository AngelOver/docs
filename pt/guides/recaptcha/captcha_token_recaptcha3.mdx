...
Para usar a API, é necessário primeiro acessar a página correspondente da [API de Reconhecimento do Protocolo Recaptcha3](https://api.xhuoapi.ai/documents/1083df69-f2f3-4c13-901e-e5336b0dbe3d) para solicitar o serviço correspondente. Após entrar na página, clique no botão "Adquirir", conforme mostrado na imagem abaixo:
