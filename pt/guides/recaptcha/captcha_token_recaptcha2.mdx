...
Para usar a API, é necessário primeiro acessar a página correspondente da [API de Reconhecimento do Protocolo Recaptcha2](https://api.xhuoapi.ai/documents/597b8f11-26d8-4a1d-9a83-8d33bc4b8af7) para solicitar o serviço correspondente. Ao entrar na página, clique no botão "Adquirir", conforme mostrado na imagem:
