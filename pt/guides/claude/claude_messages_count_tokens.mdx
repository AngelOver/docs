...
Para usar a Claude Messages Count Tokens API, primeiro você pode acessar a página [Claude Messages Count Tokens API](https://api.xhuoapi.ai/documents/claude-messages-count-tokens) e clicar no botão "Acquire" para obter as credenciais necessárias para a solicitação.
