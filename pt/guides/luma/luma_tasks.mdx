...
Para usar a API Luma Tasks, você precisa primeiro ir à página de solicitação [Luma Videos Generation API](https://api.xhuoapi.ai/documents/5bd3597d-1ff8-44ad-a580-b66b48393e7f) para solicitar o serviço correspondente e, em seguida, copiar o ID da tarefa da API Luma Videos Generation, como mostrado na imagem:

![](https://cdn.xhuoapi.ai/ynk4ow.png)

Por fim, acesse a página da API Tasks [Luma Tasks API](https://api.xhuoapi.ai/documents/7d32369c-4ead-4364-a4c5-652bc768b3ff) para solicitar o serviço correspondente. Após acessar a página, clique no botão "Acquire", como mostrado na imagem:
...
A API Luma Tasks pode ser usada para consultar os resultados da API Luma Videos Generation. Para saber como usar a API Luma Videos Generation, consulte o documento [Luma Videos Generation API](https://api.xhuoapi.ai/documents/16bb0108-1f09-45b3-97ac-16a668750a8c).
