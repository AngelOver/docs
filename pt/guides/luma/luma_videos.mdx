...
No entanto, a Luma não fornece uma API oficial, e a XHuoAPI oferece um conjunto de APIs da Luma, simulando a integração com a oficial da Suno, permitindo gerar vídeos desejados de forma rápida e conveniente.

## Solicitação e Uso

Para usar a API de Vídeos da Luma, primeiro você pode acessar a página [Luma Videos Generation API](https://api.xhuoapi.ai/documents/5bd3597d-1ff8-44ad-a580-b66b48393e7f) e clicar no botão "Acquire" para obter as credenciais necessárias para a solicitação:
...
![Quadro Inicial](https://cdn.xhuoapi.ai/r9vsv9.png)
...
![Quadro Final](https://cdn.xhuoapi.ai/0iad3k.png)
...
![Último Quadro](https://cdn.xhuoapi.ai/0iad3k.png)
