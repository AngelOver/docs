...
Para usar a API, é necessário primeiro solicitar o serviço na página correspondente do [SeeDream Images Generation API](https://api.xhuoapi.ai/documents/seedream-images). Ao acessar a página, clique no botão "Acquire", conforme mostrado na imagem:
