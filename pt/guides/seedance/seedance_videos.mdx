...
Para usar a API, você precisa primeiro solicitar o serviço correspondente na página [SeeDance Videos Generation API](https://api.xhuoapi.ai/documents/seedance-videos). Após acessar a página, clique no botão "Acquire", conforme mostrado na imagem:
