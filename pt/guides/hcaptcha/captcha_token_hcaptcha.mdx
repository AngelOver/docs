...
Para usar a API, você precisa primeiro acessar a página correspondente da [API de Reconhecimento do Protocolo hCaptcha](https://api.xhuoapi.ai/documents/34806b3a-f0f6-45c5-b8b1-143ced7b9393) para solicitar o serviço correspondente. Ao entrar na página, clique no botão "Adquirir", conforme mostrado na imagem:
