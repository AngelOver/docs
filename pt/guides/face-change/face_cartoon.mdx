...
Para usar a API, é necessário primeiro acessar a página correspondente da [API de Animeização de Retratos](https://api.xhuoapi.ai/documents/6b6313f1-f398-4d29-933d-5a652cfa1c37) e solicitar o serviço correspondente. Após entrar na página, clique no botão "Acquire", conforme mostrado na imagem:
