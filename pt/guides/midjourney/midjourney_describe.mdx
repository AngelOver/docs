...
Para usar a API Midjourney Describe, você precisa primeiro ir à página de solicitação [Midjourney Describe API](https://api.xhuoapi.ai/documents/870e973b-712a-4686-ab8b-beae27f129ce) para solicitar o serviço correspondente. Ao entrar na página, clique no botão "Acquire", conforme mostrado na imagem:

![Página de Solicitação](https://cdn.xhuoapi.ai/rci31i.png)

Se você ainda não estiver logado ou registrado, será redirecionado automaticamente para a [página de login](https://api.xhuoapi.ai), convidando-o a se registrar e fazer login. Após o login ou registro, você será redirecionado de volta para a página atual.
...
![Imagem de Exemplo](https://cdn.xhuoapi.ai/kg7xp3.png)
