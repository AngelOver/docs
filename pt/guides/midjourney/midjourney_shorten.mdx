...
Para usar a API Midjourney Shorten, é necessário solicitar o serviço na página [Midjourney Shorten API](https://api.xhuoapi.ai/documents/f0c6be1d-c084-43ac-bde6-44ef9cf824a2). Ao acessar a página, clique no botão "Acquire".

Se você ainda não estiver logado ou registrado, será redirecionado automaticamente para a [página de login](https://api.xhuoapi.ai), onde poderá se registrar e fazer login. Após o login, você será redirecionado de volta para a página atual.
