...
Para usar a API, você precisa primeiro acessar a página correspondente da [Fish Audios Generation API](https://api.xhuoapi.ai/documents/e681b715-54fd-4464-a59a-d7f14500e095) para solicitar o serviço correspondente. Após entrar na página, clique no botão "Acquire", como mostrado na imagem:
