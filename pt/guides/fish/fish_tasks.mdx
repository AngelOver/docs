...
Para usar a API Fish Tasks, você precisa primeiro ir à página de solicitação [API Fish Audios Generation](https://api.xhuoapi.ai/documents/e681b715-54fd-4464-a59a-d7f14500e095) para solicitar o serviço correspondente, e então copiar o ID da tarefa da API Fish Audios Generation, como mostrado na imagem:

<p><img src="https://cdn.xhuoapi.ai/jxvue8.png" width="500" className="m-auto" /></p>

Por fim, acesse a página da API Tasks [API Fish Tasks](https://api.xhuoapi.ai/documents/44c93949-1419-4a45-8db5-8a8335de7151) para solicitar o serviço correspondente. Após entrar na página, clique no botão "Acquire", como mostrado na imagem:
...
A API Fish Tasks pode ser usada para consultar os resultados da API Fish Audios Generation. Para saber como usar a API Fish Audios Generation, consulte o documento [API Fish Videos Generation](https://api.xhuoapi.ai/documents/fish-audios-integration).
