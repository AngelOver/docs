...
> Para criar timbres, consulte a [Fish Model Create API](https://api.xhuoapi.ai/documents/62fdf4f1-6a05-4d92-bb15-1bf78b27a14a). Para consultar detalhes de um timbre específico pelo `_id`, consulte a [Fish Model Get API](https://api.xhuoapi.ai/documents/dabdffe7-254b-5a3f-9eca-425d614d82b9).
...
O `_id` retornado pode ser usado como valor do campo `reference_id` na [Fish TTS API](https://api.xhuoapi.ai/documents/77adcb84-d59f-5ef9-b8a0-8b35eb42a71d) para síntese de voz utilizando o timbre clonado.
