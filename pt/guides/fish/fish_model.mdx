...
Para usar a API, é necessário solicitar o serviço correspondente na página do [Fish Model API](https://api.xhuoapi.ai/services/caf99abc-ddcf-4714-b2a5-862d9b469509). Após acessar a página, clique no botão "Acquire".
