...
Para usar a extração do IP da ADSL e adicionar IPs à lista branca da ADSL Proxy, primeiro você pode acessar a página da [ADSL Proxy Extract API](https://platform.acedata.cloud/documents/d8426c17-d22c-449a-b6bf-0a7790928e4d) e da [ADSL Proxy Whitelist API](https://platform.acedata.cloud/documents/c21534fe-1f62-424b-9b10-a805cb473dd1) e clicar no botão "Adquirir" para obter as credenciais necessárias para a solicitação:
...
Em seguida, você pode preencher o conteúdo correspondente na interface da [ADSL Proxy Extract API](https://platform.acedata.cloud/documents/d8426c17-d22c-449a-b6bf-0a7790928e4d), e a seguir, demonstraremos como extrair o IP da ADSL.
