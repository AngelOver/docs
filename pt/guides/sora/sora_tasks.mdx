...
Para usar a API Sora Tasks, você precisa primeiro ir à página de solicitação [Sora Videos Generation API](https://api.xhuoapi.ai/documents/99a24421-2e22-4028-8201-e19cb834b67e) para solicitar o serviço correspondente e, em seguida, copiar o ID da tarefa da API Sora Videos Generation, como mostrado na imagem:

<p><img src="https://cdn.xhuoapi.ai/za62pb.png" width="500" className="m-auto" /></p>

Por fim, acesse a página da API Tasks [Sora Tasks API](https://api.xhuoapi.ai/documents/c9d81bad-9064-4796-86b6-4fb43cc93a16) para solicitar o serviço correspondente. Após acessar a página, clique no botão "Acquire", como mostrado na imagem:
...
A API Sora Tasks pode ser usada para consultar os resultados da API Sora Videos Generation. Para saber como usar a API Sora Videos Generation, consulte o documento [Sora Videos Generation API](https://api.xhuoapi.ai/documents/sora-videos-integration).
