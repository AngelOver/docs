...
Com o ID do personagem de voz, podemos usar a [Suno Audios Generation API](https://api.xhuoapi.ai/documents/4da95d9d-7722-4a72-857d-bf6be86036e9) para gerar música. Defina `action` como `generate` e `persona_id` como o ID retornado acima; a música gerada será cantada com a voz clonada.
