...
Podemos ver que o campo `id` em `data` é o `vox_audio_id` que queremos, e então vamos ao [API Persona](https://api.xhuoapi.ai/documents/78bb6c62-6ce0-490f-a7df-e89d80ec0583) para criar a nova versão do Persona-v2-vox: estilo de cantor, com as seguintes entradas:
