...
Para usar a API DeepSeek Chat Completion, primeiro você pode acessar a página [DeepSeek Chat Completion API](https://api.xhuoapi.ai/documents/2d6a9bae-9a70-4aaa-bd72-28e5bd60fa67) e clicar no botão "Acquire" para obter as credenciais necessárias para a solicitação:
