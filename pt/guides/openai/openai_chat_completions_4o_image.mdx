...
Para usar a API OpenAI Chat Completion 4o Image, primeiro você pode acessar a página [OpenAI Chat Completion 4o Image API](https://api.xhuoapi.ai/documents/1bcf3bba-102b-495d-9bba-47cd96717e45) e clicar no botão "Acquire" para obter as credenciais necessárias para a solicitação:
