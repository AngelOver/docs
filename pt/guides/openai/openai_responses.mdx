...
Para usar a API de Respostas da OpenAI, primeiro você pode acessar a página [API de Respostas da OpenAI](https://api.xhuoapi.ai/documents/81e285a6-d010-4a2d-a3a8-ca113d4ef82a) e clicar no botão "Adquirir" para obter as credenciais necessárias para a solicitação:
