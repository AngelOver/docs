...
Para usar a API OpenAI Chat Completion, primeiro você pode acessar a página [OpenAI Chat Completion API](https://api.xhuoapi.ai/documents/1bcf3bba-102b-495d-9bba-47cd96717e45) e clicar no botão "Acquire" para obter as credenciais necessárias para a solicitação:
...
OPENAI_BASE_URL="https://api.xhuoapi.ai/v1/openai"  # Lembre-se: se você usar a chave do OpenAI oficial, não use este endereço.
```
