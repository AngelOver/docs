...
Para usar a API, você precisa primeiro acessar a página correspondente da [API de Criação de Fotos de Identidade com IA](https://api.xhuoapi.ai/documents/bf7214a3-8447-4157-8a75-f5bb39d5ed1b) e solicitar o serviço desejado. Após acessar a página, clique no botão "Acquire", conforme mostrado na imagem:
