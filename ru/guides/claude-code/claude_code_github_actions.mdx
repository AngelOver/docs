...
Этот документ в основном описывает, как настроить и использовать Claude Code GitHub Actions через прокси-сервис XHuoAPI.

## Процесс подачи заявки

Чтобы использовать Claude Code, сначала перейдите на [страницу сервиса Claude Messages](https://api.xhuoapi.ai/documents/claude-messages) и нажмите кнопку «Acquire», чтобы получить необходимые учетные данные:
...
![Страница установки приложения GitHub Claude](https://cdn.xhuoapi.ai/ba4b8df66d.png)
...
Добавьте API ключ XHuoAPI в качестве секрета репозитория:

1. Перейдите в **Settings** → **Secrets and variables** → **Actions**
2. Нажмите **New repository secret**
3. В поле Name укажите `ANTHROPIC_API_KEY`, в поле Value введите токен API, полученный в XHuoAPI
4. Нажмите **Add secret** для сохранения

> **Подсказка**: Токен API можно просмотреть в [консоли XHuoAPI](https://api.xhuoapi.ai/console).
...
Если необходимо использовать прокси API конечную точку XHuoAPI, также нужно установить переменные окружения в Workflow:
...
Войдите в [консоль XHuoAPI](https://api.xhuoapi.ai/console), чтобы увидеть текущий остаток и использование вашего аккаунта.
