...
Для использования Midjourney Shorten API необходимо подать заявку на странице [Midjourney Shorten API](https://api.xhuoapi.ai/documents/f0c6be1d-c084-43ac-bde6-44ef9cf824a2). После перехода на страницу нажмите кнопку «Acquire».

Если вы не вошли в систему или не зарегистрированы, произойдет автоматический переход на [страницу входа](https://api.xhuoapi.ai) с приглашением зарегистрироваться и войти. После входа или регистрации вы автоматически вернетесь на текущую страницу.
