...
Чтобы использовать Luma Tasks API, сначала необходимо перейти на страницу заявки [Luma Videos Generation API](https://api.xhuoapi.ai/documents/5bd3597d-1ff8-44ad-a580-b66b48393e7f) и подать заявку на соответствующую услугу, затем скопировать ID задачи Luma Videos Generation API, как показано на рисунке:

![](https://cdn.xhuoapi.ai/ynk4ow.png)

Затем перейдите на страницу Tasks API [Luma Tasks API](https://api.xhuoapi.ai/documents/7d32369c-4ead-4364-a4c5-652bc768b3ff) и подайте заявку на соответствующую услугу, после перехода на страницу нажмите кнопку «Acquire», как показано на рисунке:
...
Luma Tasks API можно использовать для запроса результатов Luma Videos Generation API. Для получения информации о том, как использовать Luma Videos Generation API, пожалуйста, обратитесь к документации [Luma Videos Generation API](https://api.xhuoapi.ai/documents/16bb0108-1f09-45b3-97ac-16a668750a8c).
