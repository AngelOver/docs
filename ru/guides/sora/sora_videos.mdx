...
Для использования API необходимо подать заявку на соответствующем [Sora Videos Generation API](https://api.xhuoapi.ai/documents/99a24421-2e22-4028-8201-e19cb834b67e) сайте. После перехода нажмите кнопку «Acquire», как показано на рисунке:
