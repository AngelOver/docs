...
Чтобы использовать извлечение IP ADSL и добавление IP в белый список ADSL Proxy, сначала можно перейти на страницы [ADSL Proxy Extract API](https://platform.acedata.cloud/documents/d8426c17-d22c-449a-b6bf-0a7790928e4d) и [ADSL Proxy Whitelist API](https://platform.acedata.cloud/documents/c21534fe-1f62-424b-9b10-a805cb473dd1) и нажать кнопку «Acquire», чтобы получить необходимые для запроса учетные данные:
...
Далее вы можете заполнить соответствующие данные на странице [ADSL Proxy Extract API](https://platform.acedata.cloud/documents/d8426c17-d22c-449a-b6bf-0a7790928e4d), далее демонстрируется, как извлечь IP ADSL.
