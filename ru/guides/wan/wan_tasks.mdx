...
Чтобы использовать Wan Tasks API, сначала необходимо перейти на страницу заявки [Wan Videos Generation API](https://api.xhuoapi.ai/documents/52b0f490-1bbf-4fe5-b60e-96626d333d2c) и подать заявку на соответствующую услугу, затем скопировать ID задачи Wan Videos Generation API, как показано на рисунке:

<p><img src="https://cdn.xhuoapi.ai/om6p6g.png" width="500" className="m-auto" /></p>

Наконец, перейдите на страницу Tasks API [Wan Tasks API](https://api.xhuoapi.ai/documents/240ef446-cbec-461c-a633-4a64178d7018) и подайте заявку на соответствующую услугу, после перехода на страницу нажмите кнопку «Acquire», как показано на рисунке:
...
Wan Tasks API можно использовать для запроса результатов Wan Videos Generation API. Для получения информации о том, как использовать Wan Videos Generation API, пожалуйста, обратитесь к документу [Wan Videos Generation API](https://api.xhuoapi.ai/documents/52b0f490-1bbf-4fe5-b60e-96626d333d2c).
