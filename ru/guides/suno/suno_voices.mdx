...
После получения ID голосового персонажа можно использовать [Suno Audios Generation API](https://api.xhuoapi.ai/documents/4da95d9d-7722-4a72-857d-bf6be86036e9) для генерации музыки. Установите `action` в `generate`, а `persona_id` — в ID созданного голосового персонажа. Сгенерированная песня будет исполнена клонированным голосом.
