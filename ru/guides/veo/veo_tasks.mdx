...
Чтобы использовать API Veo Tasks, сначала необходимо перейти на страницу заявки [Veo Videos Generation API](https://api.xhuoapi.ai/documents/63e01dc3-eb21-499e-8049-3025c460058f) и подать заявку на соответствующую услугу, затем скопировать ID задачи API Veo Videos Generation, как показано на рисунке:

<p><img src="https://cdn.xhuoapi.ai/txlg6g.png" width="500" className="m-auto" /></p>

Затем перейдите на страницу API Tasks [Veo Tasks API](https://api.xhuoapi.ai/documents/52778f8b-93ce-4db3-a62c-bcf0a92e5f3c) и подайте заявку на соответствующую услугу, после перехода на страницу нажмите кнопку «Acquire», как показано на рисунке:
...
API Veo Tasks можно использовать для запроса результатов API Veo Videos Generation. Для получения информации о том, как использовать API Veo Videos Generation, пожалуйста, обратитесь к документу [Veo Videos Generation API](https://api.xhuoapi.ai/documents/63e01dc3-eb21-499e-8049-3025c460058f).
