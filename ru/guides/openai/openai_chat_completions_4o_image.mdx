...
Чтобы использовать OpenAI Chat Completion 4o Image API, сначала перейдите на страницу [OpenAI Chat Completion 4o Image API](https://api.xhuoapi.ai/documents/1bcf3bba-102b-495d-9bba-47cd96717e45) и нажмите кнопку «Acquire», чтобы получить необходимые для запроса учетные данные:
