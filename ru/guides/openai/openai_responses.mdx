...
Чтобы использовать OpenAI Responses API, сначала перейдите на страницу [OpenAI Responses API](https://api.xhuoapi.ai/documents/81e285a6-d010-4a2d-a3a8-ca113d4ef82a) и нажмите кнопку «Acquire», чтобы получить необходимые для запроса учетные данные:
