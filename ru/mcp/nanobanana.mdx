...
Перед использованием вам необходимо получить XHuoAPI API Token:

1. Зарегистрируйтесь или войдите на [платформу XHuoAPI](https://api.xhuoapi.ai)
2. Перейдите на страницу [Nano Banana Images API](https://api.xhuoapi.ai/documents/nano-banana-images)
...
- Репозиторий на GitHub: [XHuoAPI/NanoBananaMCP](https://github.com/XHuoAPI/NanoBananaMCP)
- Пакет PyPI: [mcp-nanobanana-pro](https://pypi.org/project/mcp-nanobanana-pro/)
- Документация API: [Nano Banana API](https://api.xhuoapi.ai/documents/nano-banana)
