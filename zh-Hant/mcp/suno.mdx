...
[MCP（Model Context Protocol）](https://modelcontextprotocol.io) 是由 Anthropic 推出的模型上下文協議，允許 AI 模型（如 Claude、GPT 等）通過標準化接口調用外部工具。通過 XHuoAPI 提供的 Suno MCP Server，你可以在 Claude Desktop、VS Code、Cursor 等 AI 客戶端中直接生成音樂、歌詞，並管理音頻項目。
...
2. 前往 [Suno Audios API](https://api.xhuoapi.ai/documents/suno-audios) 頁面
...
- GitHub 倉庫：[XHuoAPI/SunoMCP](https://github.com/XHuoAPI/SunoMCP)
- PyPI 包：[mcp-suno](https://pypi.org/project/mcp-suno/)
- API 文檔：[Suno 音樂生成 API](https://api.xhuoapi.ai/documents/suno)
