...
要使用 Suno Tasks API，需要先到 申請頁面 [Suno Audios Generation API](https://api.xhuoapi.ai/documents/4da95d9d-7722-4a72-857d-bf6be86036e9) 申請相應的服務，然後複製 Suno Audios Generation API 的任務ID，如圖所示：

<p><img src="https://cdn.xhuoapi.ai/bc6754.png" width="500" className="m-auto" /></p>

最後進入 Tasks API 頁面 [Suno Tasks API](https://api.xhuoapi.ai/documents/b0dd9823-0e01-4c75-af83-5a6e2e05bfed) 申請相應的服務，進入頁面之後，點擊「Acquire」按鈕，如圖所示：
...
Suno Tasks API 可以用於查詢 Suno Audios Generation API 和 Suno Lyrics Generation API 兩個 API 的結果。關於怎樣使用 Suno Audios Generation API，請參考文檔 [Suno Audios Generation API](https://api.xhuoapi.ai/documents/d016ee3f-421b-4b6e-989a-8beba8701701)。關於怎樣使用 Suno Lyrics Generation API，請參考 [Suno Lyrics Generation API](https://api.xhuoapi.ai/documents/f1c66741-a488-43ca-91fc-e53fbbda639a)。
