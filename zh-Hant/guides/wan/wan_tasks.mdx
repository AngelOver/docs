...
要使用 Wan Tasks API，需要先到 申請頁面 [Wan Videos Generation API](https://api.xhuoapi.ai/documents/52b0f490-1bbf-4fe5-b60e-96626d333d2c) 申請相應的服務，然後複製 Wan Videos Generation API 的任務ID，如圖所示：

<p><img src="https://cdn.xhuoapi.ai/om6p6g.png" width="500" className="m-auto" /></p>

最後進入 Tasks API 頁面 [Wan Tasks API](https://api.xhuoapi.ai/documents/240ef446-cbec-461c-a633-4a64178d7018) 申請相應的服務，進入頁面之後，點擊「Acquire」按鈕，如圖所示：
...
Wan Tasks API 可以用於查詢 Wan Videos Generation API 的結果。關於怎樣使用 Wan Videos Generation API，請參考文檔 [Wan Videos Generation API](https://api.xhuoapi.ai/documents/52b0f490-1bbf-4fe5-b60e-96626d333d2c)。
