...
要使用提取 ADSL 的 IP 和對 ADSL Proxy 添加 IP 白名單，首先可以到 [ADSL Proxy Extract API](https://api.xhuoapi.ai/documents/d8426c17-d22c-449a-b6bf-0a7790928e4d) 和 [ADSL Proxy Whitelist API](https://api.xhuoapi.ai/documents/c21534fe-1f62-424b-9b10-a805cb473dd1) 頁面點擊「Acquire」按鈕，獲取請求所需要的憑證：
...
接下來就可以在介面 [ADSL Proxy Extract API](https://api.xhuoapi.ai/documents/d8426c17-d22c-449a-b6bf-0a7790928e4d) 上填寫對應的內容，接下來演示如何提取 ADSL 的 IP。
