...
要使用 Hailuo Tasks API，需要先到 申請頁面 [Hailuo Videos Generation API](https://api.xhuoapi.ai/documents/ee06377b-9185-438f-ac84-3376bcb1275e) 申請相應的服務，然後複製 Hailuo Videos Generation API 的任務ID，如圖所示：

<p><img src="https://cdn.xhuoapi.ai/4f9d95.png" width="500" className="m-auto" /></p>

最後進入 Tasks API 頁面 [Hailuo Tasks API](https://api.xhuoapi.ai/documents/4b1ccdbc-b8ed-4171-9a14-48e10970ba04) 申請相應的服務，進入頁面之後，點擊「Acquire」按鈕，如圖所示：
...
Hailuo Tasks API 可以用於查詢 Hailuo Videos Generation API 的結果。關於怎樣使用 Hailuo Videos Generation API，請參考文檔 [Hailuo Videos Generation API](https://api.xhuoapi.ai/documents/d2fc9087-2996-4573-bfe5-8b1c828fdfc7)。
