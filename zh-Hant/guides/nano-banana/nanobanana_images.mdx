...
使用前，請在 XHuoAPI 平台中進入 [Nano Banana Images API](https://api.xhuoapi.ai/documents/23985a11-d713-41d1-ad84-24b021805b3d) 並點擊 Acquire 申請開通。首次申請通常會有免費額度可用。開通完成後，即可在平台中獲取到用於調用 API 的 Bearer Token。
