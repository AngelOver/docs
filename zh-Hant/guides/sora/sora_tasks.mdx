...
要使用 Sora Tasks API，需要先到 申請頁面 [Sora Videos Generation API ](https://api.xhuoapi.ai/documents/99a24421-2e22-4028-8201-e19cb834b67e)申請相應的服務，然後複製 Sora Videos Generation API 的任務ID，如圖所示：

<p><img src="https://cdn.xhuoapi.ai/za62pb.png" width="500" className="m-auto" /></p>

最後進入 Tasks API 頁面 [Sora Tasks API ](https://api.xhuoapi.ai/documents/c9d81bad-9064-4796-86b6-4fb43cc93a16)申請相應的服務，進入頁面之後，點擊「Acquire」按鈕，如圖所示：
...
Sora Tasks API 可以用於查詢 Sora Videos Generation API 的結果。關於怎樣使用 Sora Videos Generation API，請參考文檔 [Sora Videos Generation API ](https://api.xhuoapi.ai/documents/sora-videos-integration)。
