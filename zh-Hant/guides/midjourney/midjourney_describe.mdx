...
要使用 Midjourney Describe API，需要先到 申請頁面 [Midjourney Describe API ](https://api.xhuoapi.ai/documents/870e973b-712a-4686-ab8b-beae27f129ce)申請相應的服務，進入頁面之後，點擊「Acquire」按鈕，如圖所示：
...
![示例圖片](https://cdn.xhuoapi.ai/kg7xp3.png)
