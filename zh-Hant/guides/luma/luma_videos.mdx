...
然而 Luma 官方並沒有提供 API 的，XHuoAPI 提供了一套 Luma 的 API，模擬對接了 Suno 官方，可以方便快捷地生成想要的視頻。

## 申請和使用

要使用 Luma Videos API，首先可以到 [Luma Videos Generation API](https://api.xhuoapi.ai/documents/5bd3597d-1ff8-44ad-a580-b66b48393e7f) 頁面點擊「Acquire」按鈕，獲取請求所需要的憑證：
...
![首幀](https://cdn.xhuoapi.ai/r9vsv9.png)
...
![尾幀](https://cdn.xhuoapi.ai/0iad3k.png)
