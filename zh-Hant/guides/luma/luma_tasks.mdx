...
要使用 Luma Tasks API，需要先到 申請頁面 [Luma Videos Generation API](https://api.xhuoapi.ai/documents/5bd3597d-1ff8-44ad-a580-b66b48393e7f) 申請相應的服務，然後複製 Luma Videos Generation API 的任務ID，如圖所示：

![](https://cdn.xhuoapi.ai/ynk4ow.png)

最後進入 Tasks API 頁面 [Luma Tasks API](https://api.xhuoapi.ai/documents/7d32369c-4ead-4364-a4c5-652bc768b3ff) 申請相應的服務，進入頁面之後，點擊「Acquire」按鈕，如圖所示：
...
Luma Tasks API 可以用於查詢 Luma Videos Generation API 的結果。關於怎樣使用 Luma Videos Generation API，請參考文檔 [Luma Videos Generation API](https://api.xhuoapi.ai/documents/16bb0108-1f09-45b3-97ac-16a668750a8c)。
