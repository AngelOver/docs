...
本文档主要介绍如何通过 XHuoAPI 的代理服务，在 JetBrains IDE 中配置和使用 Claude Code。
...
![JetBrains Marketplace 中的 Claude Code 插件](https://cdn.xhuoapi.ai/de78fd305b.png)
...
> **提示**：API 令牌可在 [XHuoAPI 控制台](https://api.xhuoapi.ai/console) 中查看。
...
登入 [XHuoAPI 控制台](https://api.xhuoapi.ai/console)，即可查看當前帳戶的剩餘額度和使用情況。
