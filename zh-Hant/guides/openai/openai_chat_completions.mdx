...
要使用 OpenAI Chat Completion API，首先可以到 [OpenAI Chat Completion API](https://api.xhuoapi.ai/documents/1bcf3bba-102b-495d-9bba-47cd96717e45) 頁面點擊「Acquire」按鈕，獲取請求所需要的憑證：
...
OPENAI_BASE_URL="https://api.xhuoapi.ai/v1/openai"  # 再次提醒：如果你使用官網OpenAI的key，不要用這個地址。
```
