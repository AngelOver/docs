...
要使用 OpenAI Images Generations API，首先可以到 [OpenAI Images Generations API](https://api.xhuoapi.ai/documents/fd932485-90c7-45d6-8394-1e14b6f07b2b) 頁面點擊「Acquire」按鈕，獲取請求所需要的憑證：
