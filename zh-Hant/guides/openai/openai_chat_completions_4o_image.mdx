...
要使用 OpenAI Chat Completion 4o Image API，首先可以到 [OpenAI Chat Completion 4o Image API](https://api.xhuoapi.ai/documents/1bcf3bba-102b-495d-9bba-47cd96717e45) 頁面點擊「Acquire」按鈕，獲取請求所需要的憑證：
