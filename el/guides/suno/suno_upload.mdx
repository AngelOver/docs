...
Εδώ η εισαγωγή μας για το `audio_url` είναι το `https://cdn.acedata.cloud/suno_demo.mp3`, που είναι μια διεύθυνση CDN που μπορεί να προσπελαστεί δημόσια.
...
Με το ID του τραγουδιού, μπορούμε να χρησιμοποιήσουμε το [Suno Audios Generation API](https://platform.acedata.cloud/documents/4da95d9d-7722-4a72-857d-bf6be86036e9) για να δημιουργήσουμε προσαρμοσμένα τραγούδια, για παράδειγμα, αν περάσουμε το `action` ως `upload_extend`, ενώ το `audio_id` ως το επιστρεφόμενο ID του τραγουδιού, μπορούμε να δημιουργήσουμε νέο τραγούδι με βάση την αναφορά ήχου.
