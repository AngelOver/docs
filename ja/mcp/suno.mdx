...
[MCP（Model Context Protocol）](https://modelcontextprotocol.io) は、Anthropic によって提唱されたモデルコンテキストプロトコルで、AI モデル（Claude、GPT など）が標準化されたインターフェースを通じて外部ツールを呼び出すことを可能にします。XHuoAPI が提供する Suno MCP Server を使用することで、Claude Desktop、VS Code、Cursor などの AI クライアントで直接音楽や歌詞を生成し、音声プロジェクトを管理できます。
...
2. [Suno Audios API](https://api.xhuoapi.ai/documents/suno-audios) ページに移動
...
- GitHub リポジトリ：[XHuoAPI/SunoMCP](https://github.com/XHuoAPI/SunoMCP)
- PyPI パッケージ：[mcp-suno](https://pypi.org/project/mcp-suno/)
- API ドキュメント：[Suno 音楽生成 API](https://api.xhuoapi.ai/documents/suno)
