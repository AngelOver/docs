...
音声キャラクター ID を取得したら、[Suno Audios Generation API](https://api.xhuoapi.ai/documents/4da95d9d-7722-4a72-857d-bf6be86036e9) を使って音楽生成が可能です。`action` を `generate` に設定し、`persona_id` に上記で得た音声キャラクター ID を指定すると、生成される楽曲はクローンされた音声で歌唱されます。
