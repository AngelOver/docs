...
Suno Tasks API を使用するには、まず申請ページ [Suno Audios Generation API ](https://api.xhuoapi.ai/documents/4da95d9d-7722-4a72-857d-bf6be86036e9) で該当するサービスを申請し、その後、Suno Audios Generation API のタスクIDをコピーします。以下の図のように：

<p><img src="https://cdn.xhuoapi.ai/bc6754.png" width="500" className="m-auto" /></p>

最後に、Tasks API ページ [Suno Tasks API ](https://api.xhuoapi.ai/documents/b0dd9823-0e01-4c75-af83-5a6e2e05bfed) にアクセスし、該当するサービスを申請します。ページに入ったら、「Acquire」ボタンをクリックします。以下の図のように：
...
Suno Tasks API は、Suno Audios Generation API と Suno Lyrics Generation API の結果を照会するために使用できます。Suno Audios Generation API の使用方法については、文書 [Suno Audios Generation API ](https://api.xhuoapi.ai/documents/d016ee3f-421b-4b6e-989a-8beba8701701) を参照してください。Suno Lyrics Generation API の使用方法については、[Suno Lyrics Generation API ](https://api.xhuoapi.ai/documents/f1c66741-a488-43ca-91fc-e53fbbda639a) を参照してください。
