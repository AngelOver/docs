...
`data`の`id`フィールドが私たちが欲しい`vox_audio_id`であることがわかります。次に、[Persona API](https://platform.acedata.cloud/documents/78bb6c62-6ce0-490f-a7df-e89d80ec0583)を使用して新しいバージョンのPersona-v2-vox:歌手スタイルを作成します。具体的な入力は以下の通りです：
