...
曲の ID を取得した後、[Suno Audios Generation API](https://api.xhuoapi.ai/documents/4da95d9d-7722-4a72-857d-bf6be86036e9) を使用してカスタム曲の生成を行うことができます。例えば、`action` に `upload_extend` を渡し、`audio_id` に返された曲の ID を渡すことで、参考音声に基づいて新しい曲を生成することができます。
