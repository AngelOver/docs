...
Flux Tasks API を使用するには、まず申請ページ [Flux Images Generation API](https://api.xhuoapi.ai/documents/6b9197c5-7a3f-4878-a43f-7f94e7e66394) にアクセスして、該当するサービスを申請し、その後、Flux Images Generation API のタスクIDをコピーします。以下の図のように：

<p><img src="https://cdn.xhuoapi.ai/7furhb.png" width="500" className="m-auto" /></p>

最後に、Flux Tasks API ページ [Flux Tasks API](https://api.xhuoapi.ai/documents/39b38bbe-60f3-40da-b2b6-5ce1e091852b) にアクセスして、該当するサービスを申請します。ページに入ったら、「Acquire」ボタンをクリックします。以下の図のように：
...
Flux Tasks API は、Flux Images Generation API の結果を照会するために使用できます。Flux Images Generation API の使用方法については、文書 [Flux Images Generation API](https://api.xhuoapi.ai/documents/flux-images-integration) を参照してください。
