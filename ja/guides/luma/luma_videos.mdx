...
しかし、Luma 公式は API を提供していません。XHuoAPI は Luma の API を提供し、Suno 公式との接続を模倣して、簡単かつ迅速に希望するビデオを生成できるようにしています。

## 申請と使用

Luma Videos API を使用するには、まず [Luma Videos Generation API](https://api.xhuoapi.ai/documents/5bd3597d-1ff8-44ad-a580-b66b48393e7f) ページにアクセスし、「Acquire」ボタンをクリックして、リクエストに必要な認証情報を取得します：
...
![先頭フレーム](https://cdn.xhuoapi.ai/r9vsv9.png)
...
![尾フレーム](https://cdn.xhuoapi.ai/0iad3k.png)
...
![最後のフレーム](https://cdn.xhuoapi.ai/0iad3k.png)
