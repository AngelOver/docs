...
Luma Tasks API を使用するには、まず申請ページ [Luma Videos Generation API](https://api.xhuoapi.ai/documents/5bd3597d-1ff8-44ad-a580-b66b48393e7f) にアクセスして、該当するサービスを申請し、その後 Luma Videos Generation API のタスクIDをコピーします。以下の図のように：

![](https://cdn.xhuoapi.ai/ynk4ow.png)

最後に、Tasks API ページ [Luma Tasks API](https://api.xhuoapi.ai/documents/7d32369c-4ead-4364-a4c5-652bc768b3ff) にアクセスして、該当するサービスを申請します。ページに入ったら、「Acquire」ボタンをクリックします。以下の図のように：
...
Luma Tasks API は、Luma Videos Generation API の結果を照会するために使用できます。Luma Videos Generation API の使用方法については、文書 [Luma Videos Generation API](https://api.xhuoapi.ai/documents/16bb0108-1f09-45b3-97ac-16a668750a8c) を参照してください。
