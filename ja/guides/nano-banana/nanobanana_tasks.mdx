...
Nano Banana Tasks API は、Nano Banana Images API の結果を照会するために使用できます。Nano Banana Images API の使用方法については、文書 [Nano Banana Images API](https://api.xhuoapi.ai/documents/63e01dc3-eb21-499e-8049-3025c460058f) を参照してください。
