...
Hailuo Tasks API を使用するには、まず申請ページ [Hailuo Videos Generation API](https://api.xhuoapi.ai/documents/ee06377b-9185-438f-ac84-3376bcb1275e) にアクセスして、該当するサービスを申請し、その後、Hailuo Videos Generation API のタスクIDをコピーします。以下の図のように：

<p><img src="https://cdn.xhuoapi.ai/4f9d95.png" width="500" className="m-auto" /></p>

最後に、Tasks API ページ [Hailuo Tasks API](https://api.xhuoapi.ai/documents/4b1ccdbc-b8ed-4171-9a14-48e10970ba04) にアクセスして、該当するサービスを申請します。ページに入ったら、「Acquire」ボタンをクリックします。以下の図のように：
...
Hailuo Tasks API は、Hailuo Videos Generation API の結果を照会するために使用できます。Hailuo Videos Generation API の使用方法については、ドキュメント [Hailuo Videos Generation API](https://api.xhuoapi.ai/documents/d2fc9087-2996-4573-bfe5-8b1c828fdfc7) を参照してください。
