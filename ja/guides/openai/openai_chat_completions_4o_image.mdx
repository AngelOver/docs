...
OpenAI Chat Completion 4o Image APIを使用するには、まず[OpenAI Chat Completion 4o Image API](https://api.xhuoapi.ai/documents/1bcf3bba-102b-495d-9bba-47cd96717e45)ページにアクセスし、「Acquire」ボタンをクリックして、リクエストに必要な資格情報を取得します：
