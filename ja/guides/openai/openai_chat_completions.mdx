...
OpenAI Chat Completion API を使用するには、まず [OpenAI Chat Completion API](https://api.xhuoapi.ai/documents/1bcf3bba-102b-495d-9bba-47cd96717e45) ページにアクセスし、「Acquire」ボタンをクリックして、リクエストに必要な資格情報を取得します：
...
OPENAI_BASE_URL="https://api.xhuoapi.ai/v1/openai"  # 再度注意：公式の OpenAI のキーを使用する場合は、このアドレスを使用しないでください。
```
