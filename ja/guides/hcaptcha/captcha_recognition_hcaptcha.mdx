...
API を使用するには、まず [hCaptcha 画像認識 API](https://api.xhuoapi.ai/documents/c9a5cc2f-e410-425f-857a-f8700205da6c) の該当ページでサービスを申請する必要があります。ページに入ったら、「Acquire」ボタンをクリックします。以下の図のように：
