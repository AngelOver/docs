...
API を使用するには、まず [銀行カード基本情報照会 API](https://api.xhuoapi.ai/documents/3523988d-acba-4362-9def-105657991eb4) の該当ページでサービスを申請する必要があります。ページに入ったら、「Acquire」ボタンをクリックします。以下の図のように：
