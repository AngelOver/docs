...
Claude Messages API を使用するには、まず [Claude Messages API](https://api.xhuoapi.ai/documents/280928a2-2dce-419c-adb5-1ea835e8183a) ページにアクセスし、「Acquire」ボタンをクリックして、リクエストに必要な資格情報を取得します：
