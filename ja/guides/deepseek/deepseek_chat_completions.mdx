...
DeepSeek Chat Completion API を使用するには、まず [DeepSeek Chat Completion API](https://api.xhuoapi.ai/documents/2d6a9bae-9a70-4aaa-bd72-28e5bd60fa67) ページにアクセスし、「Acquire」ボタンをクリックして、リクエストに必要な認証情報を取得します：
