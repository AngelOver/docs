...
Midjourney Describe API を使用するには、まず 申請ページ [Midjourney Describe API ](https://api.xhuoapi.ai/documents/870e973b-712a-4686-ab8b-beae27f129ce) で該当するサービスを申請する必要があります。ページに入ったら、「Acquire」ボタンをクリックします。
...
![例画像](https://cdn.xhuoapi.ai/kg7xp3.png)
