...
Midjourney Tasks API を使用するには、まず申請ページ [Midjourney Imagine API ](https://api.xhuoapi.ai/documents/e52c028d-897a-4d51-b110-60fccbe6118d) で該当するサービスを申請し、次に Imagine API のタスクIDをコピーします。以下の図のように：

<p><img src="https://cdn.xhuoapi.ai/lx4mwb.png" width="500" className="m-auto" /></p>

最後に、Tasks API ページ [Midjourney Tasks API ](https://api.xhuoapi.ai/documents/58ea7cc1-c685-40c3-a619-f29f9ac5d8f4) にアクセスし、該当するサービスを申請します。ページに入ったら、「Acquire」ボタンをクリックします。以下の図のように：
...
Midjourney Tasks API は、Midjourney Imagine API と Midjourney Describe API の結果を照会するために使用できます。Midjourney Imagine API の使用方法については、文書 [Midjourney Imagine API ](https://api.xhuoapi.ai/documents/b0e32002-2707-41cc-b103-a15b1f1efdc1) を参照してください。Midjourney Describe の使用方法については、[Midjourney Describe API ](https://api.xhuoapi.ai/documents/d2a04242-507c-4a49-a17a-01bc382c5756) を参照してください。
