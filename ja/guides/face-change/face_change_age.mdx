...
APIを使用するには、まず [人顔年齢変化 API](https://api.xhuoapi.ai/documents/0c5b4165-25ba-4dc2-8f02-e3cd74ab4238) の該当ページでサービスを申請する必要があります。ページに入ったら、「Acquire」ボタンをクリックします。以下の図のように：
