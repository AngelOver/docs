...
API を利用するには、まず [SeeDream Images Generation API](https://api.xhuoapi.ai/documents/seedream-images) のページで対応するサービスを申請する必要があります。ページにアクセスしたら、「Acquire」ボタンをクリックします。以下の図のように表示されます：
