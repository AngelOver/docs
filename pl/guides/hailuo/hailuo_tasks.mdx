...
Aby korzystać z Hailuo Tasks API, najpierw należy przejść do strony aplikacji [Hailuo Videos Generation API](https://api.xhuoapi.ai/documents/ee06377b-9185-438f-ac84-3376bcb1275e) i złożyć wniosek o odpowiednią usługę, a następnie skopiować ID zadania Hailuo Videos Generation API, jak pokazano na obrazku:

<p><img src="https://cdn.xhuoapi.ai/4f9d95.png" width="500" className="m-auto" /></p>

Na koniec przejdź do strony Tasks API [Hailuo Tasks API](https://api.xhuoapi.ai/documents/4b1ccdbc-b8ed-4171-9a14-48e10970ba04) i złóż wniosek o odpowiednią usługę, po wejściu na stronę kliknij przycisk „Acquire”, jak pokazano na obrazku:
...
Hailuo Tasks API może być używane do sprawdzania wyników Hailuo Videos Generation API. Aby dowiedzieć się, jak korzystać z Hailuo Videos Generation API, zapoznaj się z dokumentem [Hailuo Videos Generation API](https://api.xhuoapi.ai/documents/d2fc9087-2996-4573-bfe5-8b1c828fdfc7).
