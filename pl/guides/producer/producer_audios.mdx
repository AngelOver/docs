...
Aby skorzystać z API, należy najpierw przejść na stronę [Producent Audios Generation API](https://api.xhuoapi.ai/documents/producer-audios) i złożyć wniosek o odpowiednią usługę. Po wejściu na stronę, kliknij przycisk „Acquire”, jak pokazano na obrazku:
...
Jeśli chcesz kontynuować wykonywanie coveru swojej przesłanej piosenki, możesz ustawić parametr `action` na `upload_cover` i wprowadzić ID piosenki, którą chcesz kontynuować, ID piosenki można uzyskać za pomocą [Producer Upload API](https://api.xhuoapi.ai/documents/7fd2cb52-772e-4cc4-a018-e2626ff6f447), jak pokazano na poniższym obrazku:
...
Jeśli chcesz kontynuować piosenkę, którą sam przesłałeś, możesz ustawić parametr `action` na `upload_extend` i wprowadzić ID piosenki, którą chcesz kontynuować. ID piosenki można uzyskać za pomocą [Producer Upload API](https://api.xhuoapi.ai/documents/7fd2cb52-772e-4cc4-a018-e2626ff6f447), jak pokazano na poniższym obrazku:
...
Jeśli chcesz kontynuować zastępowanie fragmentu w przesłanej przez siebie piosence, możesz ustawić parametr `action` na `upload_replace_section` i wprowadzić ID przesłanej piosenki, które można uzyskać za pomocą [Producer Upload API](https://api.xhuoapi.ai/documents/7fd2cb52-772e-4cc4-a018-e2626ff6f447), jak pokazano na poniższym obrazku:
