...
Aby skorzystać z API, należy najpierw przejść do odpowiedniej strony [API do rozpoznawania protokołów hCaptcha](https://api.xhuoapi.ai/documents/34806b3a-f0f6-45c5-b8b1-143ced7b9393) i złożyć wniosek o odpowiednią usługę. Po wejściu na stronę kliknij przycisk „Acquire”, jak pokazano na obrazku:
