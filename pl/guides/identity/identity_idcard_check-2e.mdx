...
Aby skorzystać z API, należy najpierw przejść do strony [API weryfikacji danych osobowych i okresu ważności](https://api.xhuoapi.ai/documents/667017a4-017f-4af0-870e-807034f70632) i złożyć wniosek o odpowiednią usługę. Po wejściu na stronę, kliknij przycisk „Acquire”, jak pokazano na obrazku:
