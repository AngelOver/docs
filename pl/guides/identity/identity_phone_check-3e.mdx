...
Aby skorzystać z API, należy najpierw przejść do odpowiedniej strony [API weryfikacji trzech elementów numeru telefonu](https://api.xhuoapi.ai/documents/b4c50108-dda5-4ddb-ba84-776060fb0151) i złożyć wniosek o odpowiednią usługę. Po wejściu na stronę kliknij przycisk „Acquire”, jak pokazano na obrazku:
