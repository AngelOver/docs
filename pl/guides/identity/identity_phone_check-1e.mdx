...
Aby skorzystać z API, należy najpierw przejść do strony [API do sprawdzania statusu numeru telefonu](https://api.xhuoapi.ai/documents/037e2b5b-d0c0-425c-9e13-955ac64d1e07) i złożyć wniosek o odpowiednią usługę. Po wejściu na stronę kliknij przycisk „Acquire”, jak pokazano na obrazku:
