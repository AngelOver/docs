...
Aby korzystać z OpenAI Responses API, najpierw można przejść na stronę [OpenAI Responses API](https://api.xhuoapi.ai/documents/81e285a6-d010-4a2d-a3a8-ca113d4ef82a) i kliknąć przycisk „Acquire”, aby uzyskać potrzebne poświadczenia do żądania:
