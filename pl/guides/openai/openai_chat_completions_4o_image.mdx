...
Aby korzystać z OpenAI Chat Completion 4o Image API, najpierw można przejść na stronę [OpenAI Chat Completion 4o Image API](https://api.xhuoapi.ai/documents/1bcf3bba-102b-495d-9bba-47cd96717e45) i kliknąć przycisk „Acquire”, aby uzyskać potrzebne do żądania poświadczenia:
