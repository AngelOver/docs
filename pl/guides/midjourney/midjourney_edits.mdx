...
Aby korzystać z API, należy najpierw przejść do strony [Midjourney Edits API](https://api.xhuoapi.ai/documents/midjourney-edits) i złożyć wniosek o odpowiednią usługę. Po wejściu na stronę, kliknij przycisk „Acquire”, jak pokazano na obrazku:
