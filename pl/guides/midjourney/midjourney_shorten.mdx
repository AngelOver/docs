...
Aby korzystać z Midjourney Shorten API, należy najpierw złożyć wniosek na stronie [Midjourney Shorten API](https://api.xhuoapi.ai/documents/f0c6be1d-c084-43ac-bde6-44ef9cf824a2). Po wejściu na stronę kliknij przycisk „Acquire”.

Jeśli nie jesteś zalogowany lub zarejestrowany, nastąpi automatyczne przekierowanie do [strony logowania](https://api.xhuoapi.ai), gdzie możesz się zarejestrować i zalogować. Po zalogowaniu zostaniesz automatycznie przekierowany z powrotem na bieżącą stronę.
