...
Aby korzystać z API Kling Tasks, należy najpierw przejść do strony aplikacji [Kling Videos Generation API](https://api.xhuoapi.ai/documents/3b921a16-a411-4557-8335-53f21d3f9e46) i złożyć wniosek o odpowiednią usługę, a następnie skopiować ID zadania API Kling Videos Generation, jak pokazano na obrazku:

<p><img src="https://cdn.xhuoapi.ai/om6p6g.png" width="500" className="m-auto" /></p>

Na koniec przejdź do strony API Tasks [Kling Tasks API](https://api.xhuoapi.ai/documents/6b43ff7b-8298-49c8-a390-83df85c2c5e5) i złóż wniosek o odpowiednią usługę, po wejściu na stronę kliknij przycisk „Acquire”, jak pokazano na obrazku:
...
API Kling Tasks może być używane do sprawdzania wyników API Kling Videos Generation. Aby dowiedzieć się, jak korzystać z API Kling Videos Generation, zapoznaj się z dokumentem [Kling Videos Generation API](https://api.xhuoapi.ai/documents/3b921a16-a411-4557-8335-53f21d3f9e46).
