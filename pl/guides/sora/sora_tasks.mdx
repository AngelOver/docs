...
Aby korzystać z API Sora Tasks, należy najpierw przejść do strony aplikacji [Sora Videos Generation API](https://api.xhuoapi.ai/documents/99a24421-2e22-4028-8201-e19cb834b67e) i złożyć wniosek o odpowiednią usługę, a następnie skopiować ID zadania API Sora Videos Generation, jak pokazano na obrazku:

<p><img src="https://cdn.xhuoapi.ai/za62pb.png" width="500" className="m-auto" /></p>

Na koniec przejdź do strony API Tasks [Sora Tasks API](https://api.xhuoapi.ai/documents/c9d81bad-9064-4796-86b6-4fb43cc93a16) i złóż wniosek o odpowiednią usługę, po wejściu na stronę kliknij przycisk „Acquire”, jak pokazano na obrazku:
...
API Sora Tasks może być używane do zapytania o wyniki API Sora Videos Generation. Aby dowiedzieć się, jak korzystać z API Sora Videos Generation, zapoznaj się z dokumentem [Sora Videos Generation API](https://api.xhuoapi.ai/documents/sora-videos-integration).
