...
Możemy zobaczyć, że pole `id` w `data` to nasze pożądane `vox_audio_id`, a następnie przechodzimy do [API Persona](https://api.xhuoapi.ai/documents/78bb6c62-6ce0-490f-a7df-e89d80ec0583), aby stworzyć nową wersję Persona-v2-vox: styl piosenkarza, konkretne dane wejściowe są następujące:
...
Następnie możemy na podstawie wartości `persona_id` z powyższego wyniku tworzyć nową wersję Persona-v2-vox: styl piosenkarza, konkretna metoda tworzenia jest zgodna z [Suno API do generowania piosenek](https://api.xhuoapi.ai/documents/suno-audios-integration#%E8%87%AA%E5%AE%9A%E4%B9%89%E6%AD%8C%E6%89%8B%E9%A3%8E%E6%A0%BC%E7%94%9F%E6%88%90%E5%8A%9F%E8%83%BD), a na końcu możemy wykorzystać Suno Vox API do stworzenia nowej wersji Persona-v2-vox: styl piosenkarza w celu tworzenia piosenek.
