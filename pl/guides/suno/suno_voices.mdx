...
Mając ID postaci głosowej, możemy użyć [Suno Audios Generation API](https://api.xhuoapi.ai/documents/4da95d9d-7722-4a72-857d-bf6be86036e9) do generowania muzyki. Ustaw `action` na `generate` oraz `persona_id` na zwrócone wcześniej ID postaci głosowej — wygenerowana piosenka zostanie zaśpiewana klonowanym głosem.
