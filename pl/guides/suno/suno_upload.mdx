...
Mając ID piosenki, możemy użyć [Suno Audios Generation API](https://platform.acedata.cloud/documents/4da95d9d-7722-4a72-857d-bf6be86036e9) do generacji spersonalizowanej piosenki, na przykład przekazując `action` jako `upload_extend`, a `audio_id` jako zwrócone ID piosenki, możemy wygenerować nową piosenkę na podstawie referencyjnego audio.
