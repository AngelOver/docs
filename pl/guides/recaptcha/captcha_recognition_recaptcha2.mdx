...
Aby skorzystać z API, należy najpierw przejść do odpowiedniej strony [API rozpoznawania obrazów Recaptcha2](https://api.xhuoapi.ai/documents/b9bf7d07-b178-4881-ae45-a852ec40f53e) i złożyć wniosek o odpowiednią usługę. Po wejściu na stronę, kliknij przycisk „Acquire”, jak pokazano na poniższym obrazku:
