...
Aby korzystać z API Face Swap, należy najpierw przejść do strony aplikacji [Face Swap API](https://api.xhuoapi.ai/documents/d10df07a-66a6-4c37-b114-3a003fc9bd55), klikając przycisk „Acquire”, jak pokazano na poniższym obrazku:

![Strona aplikacji](https://cdn.xhuoapi.ai/rci31i.png)

Jeśli nie jesteś zalogowany lub zarejestrowany, automatycznie zostaniesz przekierowany na [stronę logowania](https://api.xhuoapi.ai), aby zarejestrować się i zalogować. Po zalogowaniu lub rejestracji zostaniesz automatycznie przekierowany z powrotem na bieżącą stronę.
