...
Aby korzystać z Wan Tasks API, najpierw należy przejść do strony aplikacji [Wan Videos Generation API](https://api.xhuoapi.ai/documents/52b0f490-1bbf-4fe5-b60e-96626d333d2c) i złożyć wniosek o odpowiednią usługę, a następnie skopiować ID zadania z Wan Videos Generation API, jak pokazano na obrazku:

<p><img src="https://cdn.xhuoapi.ai/om6p6g.png" width="500" className="m-auto" /></p>

Na koniec przejdź do strony Tasks API [Wan Tasks API](https://api.xhuoapi.ai/documents/240ef446-cbec-461c-a633-4a64178d7018) i złóż wniosek o odpowiednią usługę, po wejściu na stronę kliknij przycisk „Acquire”, jak pokazano na obrazku:
...
Wan Tasks API może być używane do sprawdzania wyników Wan Videos Generation API. Aby dowiedzieć się, jak korzystać z Wan Videos Generation API, zapoznaj się z dokumentem [Wan Videos Generation API](https://api.xhuoapi.ai/documents/52b0f490-1bbf-4fe5-b60e-96626d333d2c).
