...
Jednak Luma oficjalnie nie oferuje API, XHuoAPI dostarcza zestaw API Luma, symulując integrację z oficjalnym Suno, co umożliwia szybkie i wygodne generowanie pożądanych wideo.

## Aplikacja i użycie

Aby korzystać z Luma Videos API, najpierw można przejść na stronę [Luma Videos Generation API](https://api.xhuoapi.ai/documents/5bd3597d-1ff8-44ad-a580-b66b48393e7f) i kliknąć przycisk „Acquire”, aby uzyskać potrzebne poświadczenia:
...
![Klatka początkowa](https://cdn.xhuoapi.ai/r9vsv9.png)
...
![Klatka końcowa](https://cdn.xhuoapi.ai/0iad3k.png)
