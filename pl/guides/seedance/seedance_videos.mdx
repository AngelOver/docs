...
Aby skorzystać z API, należy najpierw przejść do strony [SeeDance Videos Generation API](https://api.xhuoapi.ai/documents/seedance-videos) i złożyć wniosek o odpowiednią usługę. Po wejściu na stronę, kliknij przycisk „Acquire”, jak pokazano na obrazku:
