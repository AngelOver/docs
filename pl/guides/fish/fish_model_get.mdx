...
> Tworzenie brzmień opisano w [Fish Model Create API](https://api.xhuoapi.ai/documents/62fdf4f1-6a05-4d92-bb15-1bf78b27a14a), a paginowane listy można pobierać za pomocą [Fish Model Query API](https://api.xhuoapi.ai/documents/5a9b3e03-2896-5606-a6b9-d9f4469f0e9d).

## Proces aplikacji

Aby korzystać z API, należy najpierw złożyć wniosek o dostęp do odpowiedniej usługi na stronie [Fish Model API](https://api.xhuoapi.ai/services/caf99abc-ddcf-4714-b2a5-862d9b469509). Po wejściu na stronę kliknij przycisk „Acquire”.
...
- **Parametr ścieżki**: `{id}` to `_id` brzmienia, które jest zwracane podczas tworzenia w [Fish Model Create API](https://api.xhuoapi.ai/documents/62fdf4f1-6a05-4d92-bb15-1bf78b27a14a) lub można je uzyskać z paginowanych wyników [Fish Model Query API](https://api.xhuoapi.ai/documents/5a9b3e03-2896-5606-a6b9-d9f4469f0e9d).
...
Zwrócone `_id` może być użyte jako wartość pola `reference_id` w [Fish TTS API](https://api.xhuoapi.ai/documents/77adcb84-d59f-5ef9-b8a0-8b35eb42a71d) do syntezy mowy z wykorzystaniem tego klonowanego brzmienia.
