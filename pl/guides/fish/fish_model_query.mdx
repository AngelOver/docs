...
> Tworzenie głosów proszę realizować za pomocą [Fish Model Create API](https://api.xhuoapi.ai/documents/62fdf4f1-6a05-4d92-bb15-1bf78b27a14a), a zapytania o pojedynczy głos po `_id` za pomocą [Fish Model Get API](https://api.xhuoapi.ai/documents/dabdffe7-254b-5a3f-9eca-425d614d82b9).
...
Zwrócone `_id` może być użyte jako wartość pola `reference_id` w kolejnych wywołaniach [Fish TTS API](https://api.xhuoapi.ai/documents/77adcb84-d59f-5ef9-b8a0-8b35eb42a71d) do syntezy mowy z wykorzystaniem tego klonowanego głosu.
