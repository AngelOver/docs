...
API Nano Banana Tasks może być używane do sprawdzania wyników API Nano Banana Images. Aby dowiedzieć się, jak korzystać z API Nano Banana Images, zapoznaj się z dokumentem [Nano Banana Images API](https://api.xhuoapi.ai/documents/63e01dc3-eb21-499e-8049-3025c460058f).
