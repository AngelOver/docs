...
Aby skorzystać z wydobywania IP ADSL i dodawania IP do białej listy ADSL Proxy, najpierw można przejść do strony [ADSL Proxy Extract API](https://api.xhuoapi.ai/documents/d8426c17-d22c-449a-b6bf-0a7790928e4d) oraz [ADSL Proxy Whitelist API](https://api.xhuoapi.ai/documents/c21534fe-1f62-424b-9b10-a805cb473dd1) i kliknąć przycisk „Acquire”, aby uzyskać potrzebne poświadczenia:
...
Następnie możesz wypełnić odpowiednie treści na stronie [ADSL Proxy Extract API](https://api.xhuoapi.ai/documents/d8426c17-d22c-449a-b6bf-0a7790928e4d), a poniżej pokazano, jak wydobyć IP ADSL.
