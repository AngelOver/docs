...
[MCP (Model Context Protocol)](https://modelcontextprotocol.io) to protokół kontekstu modelu wprowadzony przez Anthropic, który pozwala modelom AI (takim jak Claude, GPT itp.) na wywoływanie zewnętrznych narzędzi za pomocą znormalizowanego interfejsu. Dzięki Suno MCP Server dostarczonemu przez XHuoAPI, możesz bezpośrednio generować muzykę, teksty piosenek i zarządzać projektami audio w klientach AI, takich jak Claude Desktop, VS Code, Cursor.
...
2. Przejdź do strony [Suno Audios API](https://api.xhuoapi.ai/documents/suno-audios)
...
- Repozytorium GitHub: [XHuoAPI/SunoMCP](https://github.com/XHuoAPI/SunoMCP)
- Pakiet PyPI: [mcp-suno](https://pypi.org/project/mcp-suno/)
- Dokumentacja API: [Suno API do generowania muzyki](https://api.xhuoapi.ai/documents/suno)
