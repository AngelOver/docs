...
[MCP (Model Context Protocol)](https://modelcontextprotocol.io) to protokół kontekstu modelu wprowadzony przez Anthropic, który pozwala modelom AI (takim jak Claude, GPT itp.) na wywoływanie zewnętrznych narzędzi za pomocą znormalizowanego interfejsu. Dzięki serwerowi Nano Banana MCP udostępnionemu przez XHuoAPI, możesz bezpośrednio generować i edytować obrazy AI w klientach AI, takich jak Claude Desktop, VS Code, Cursor itp.
...
2. Przejdź do strony [Nano Banana Images API](https://api.xhuoapi.ai/documents/nano-banana-images)
...
- Repozytorium GitHub: [XHuoAPI/NanoBananaMCP](https://github.com/XHuoAPI/NanoBananaMCP)
- Pakiet PyPI: [mcp-nanobanana-pro](https://pypi.org/project/mcp-nanobanana-pro/)
- Dokumentacja API: [Nano Banana API](https://api.xhuoapi.ai/documents/nano-banana)
