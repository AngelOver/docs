...
[MCP (Model Context Protocol)](https://modelcontextprotocol.io) to protokół kontekstu modelu wprowadzony przez Anthropic, który pozwala modelom AI (takim jak Claude, GPT itp.) na wywoływanie zewnętrznych narzędzi za pomocą znormalizowanego interfejsu. Dzięki Luma MCP Server dostarczonemu przez XHuoAPI, możesz bezpośrednio generować filmy AI w klientach AI, takich jak Claude Desktop, VS Code, Cursor itp.
...
2. Przejdź do strony [Luma Videos API](https://api.xhuoapi.ai/documents/luma-videos)
...
- Repozytorium GitHub: [XHuoAPI/LumaMCP](https://github.com/XHuoAPI/LumaMCP)
- Pakiet PyPI: [mcp-luma](https://pypi.org/project/mcp-luma/)
- Dokumentacja API: [API do generowania wideo Luma](https://api.xhuoapi.ai/documents/luma)
