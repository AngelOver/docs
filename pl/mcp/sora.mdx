...
[MCP (Model Context Protocol)](https://modelcontextprotocol.io) to protokół kontekstu modelu wprowadzony przez Anthropic, który pozwala modelom AI (takim jak Claude, GPT itp.) na wywoływanie zewnętrznych narzędzi za pomocą znormalizowanego interfejsu. Dzięki Sora MCP Server dostarczonemu przez XHuoAPI, możesz bezpośrednio używać OpenAI Sora do generowania filmów AI w klientach AI takich jak Claude Desktop, VS Code, Cursor itp.
...
2. Przejdź do strony [Sora Videos API](https://api.xhuoapi.ai/documents/sora-videos)
...
- Repozytorium GitHub: [XHuoAPI/SoraMCP](https://github.com/XHuoAPI/SoraMCP)
- Pakiet PyPI: [mcp-sora](https://pypi.org/project/mcp-sora/)
- Dokumentacja API: [API do generowania wideo Sora](https://api.xhuoapi.ai/documents/sora)
