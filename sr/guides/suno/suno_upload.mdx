...
Овде уносимо `audio_url` као `https://cdn.acedata.cloud/suno_demo.mp3`, што је јавна CDN адреса.
...
Када имамо идентификатор песме, можемо користити [Suno Audios Generation API](https://platform.acedata.cloud/documents/4da95d9d-7722-4a72-857d-bf6be86036e9) за генерисање прилагођених песама, на пример, `action` преносимо као `upload_extend`, а `audio_id` преносимо као враћени идентификатор песме, тако можемо генерисати нову песму на основу референтног аудио.
