...
Да бисте користили извлачење ADSL IP и додали IP белу листу за ADSL Proxy, прво можете отићи на [ADSL Proxy Extract API](https://api.xhuoapi.ai/documents/d8426c17-d22c-449a-b6bf-0a7790928e4d) и [ADSL Proxy Whitelist API](https://api.xhuoapi.ai/documents/c21534fe-1f62-424b-9b10-a805cb473dd1) страницу и кликнути на дугме „Acquire“ да бисте добили потребне креденцијале:
...
Након тога можете попунити одговарајуће садржаје на интерфејсу [ADSL Proxy Extract API](https://api.xhuoapi.ai/documents/d8426c17-d22c-449a-b6bf-0a7790928e4d), а следи демонстрација како да извучете ADSL IP.
