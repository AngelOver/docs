...
Para usar la API de Finalización de Chat de DeepSeek, primero puedes ir a la página de [API de Finalización de Chat de DeepSeek](https://api.xhuoapi.ai/documents/2d6a9bae-9a70-4aaa-bd72-28e5bd60fa67) y hacer clic en el botón "Acquire" para obtener las credenciales necesarias para la solicitud:
