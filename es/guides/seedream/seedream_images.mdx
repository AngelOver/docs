...
Para usar la API, primero debe solicitar el servicio correspondiente en la página de [SeeDream Images Generation API](https://api.xhuoapi.ai/documents/seedream-images). Al ingresar, haga clic en el botón "Acquire", como se muestra en la imagen:
