...
Para usar la API de Claude Messages, primero puedes ir a la página de [Claude Messages API](https://api.xhuoapi.ai/documents/280928a2-2dce-419c-adb5-1ea835e8183a) y hacer clic en el botón "Acquire" para obtener las credenciales necesarias para la solicitud:
...
XHuoAPI ofrece dos formatos de API de Claude, y las principales diferencias son las siguientes:
