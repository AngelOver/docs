...
Para usar la API de Finalización de Chat de Claude, primero puedes ir a la página de [API de Finalización de Chat de Claude](https://api.xhuoapi.ai/documents/280928a2-2dce-419c-adb5-1ea835e8183a) y hacer clic en el botón "Acquire" para obtener las credenciales necesarias para la solicitud:
