...
Para usar la API de Respuestas de OpenAI, primero puede ir a la página de [API de Respuestas de OpenAI](https://api.xhuoapi.ai/documents/81e285a6-d010-4a2d-a3a8-ca113d4ef82a) y hacer clic en el botón "Adquirir" para obtener las credenciales necesarias para la solicitud:
