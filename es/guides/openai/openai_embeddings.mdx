...
Para utilizar la API de Embeddings de OpenAI, primero puede ir a la página de [API de Embeddings de OpenAI](https://api.xhuoapi.ai/documents/0f2e63fa-5890-4bdd-84f0-1706b5c9a387) y hacer clic en el botón "Acquire" para obtener las credenciales necesarias para la solicitud:
