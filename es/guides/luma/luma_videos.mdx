...
Sin embargo, Luma no proporciona oficialmente una API, XHuoAPI ofrece un conjunto de API de Luma, simulando la integración con la oficial de Suno, lo que permite generar videos deseados de manera rápida y conveniente.

## Solicitud y uso

Para usar la API de Luma Videos, primero puedes ir a la página de [Luma Videos Generation API](https://api.xhuoapi.ai/documents/5bd3597d-1ff8-44ad-a580-b66b48393e7f) y hacer clic en el botón "Acquire" para obtener las credenciales necesarias para la solicitud:
...
![Fotograma inicial](https://cdn.xhuoapi.ai/r9vsv9.png)
...
![Fotograma final](https://cdn.xhuoapi.ai/0iad3k.png)
