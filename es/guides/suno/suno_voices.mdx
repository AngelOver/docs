...
Con el ID del personaje de voz, podemos usar la [Suno Audios Generation API](https://api.xhuoapi.ai/documents/4da95d9d-7722-4a72-857d-bf6be86036e9) para generar música. Establece `action` a `generate` y `persona_id` al ID del personaje de voz obtenido arriba; la canción generada usará la voz clonada para la interpretación.
