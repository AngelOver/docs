...
Para utilizar la extracción de la IP de ADSL y agregar IPs a la lista blanca del Proxy ADSL, primero puedes ir a las páginas de [API de Extracción de Proxy ADSL](https://api.xhuoapi.ai/documents/d8426c17-d22c-449a-b6bf-0a7790928e4d) y [API de Lista Blanca de Proxy ADSL](https://api.xhuoapi.ai/documents/c21534fe-1f62-424b-9b10-a805cb473dd1) y hacer clic en el botón "Adquirir" para obtener las credenciales necesarias para la solicitud:
...
A continuación, puedes completar el contenido correspondiente en la interfaz de [API de Extracción de Proxy ADSL](https://api.xhuoapi.ai/documents/d8426c17-d22c-449a-b6bf-0a7790928e4d), a continuación se muestra cómo extraer la IP de ADSL.
