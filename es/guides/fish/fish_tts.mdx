...
Para usar la API, primero debe solicitar el servicio correspondiente en la página de [Fish TTS API](https://api.xhuoapi.ai/services/caf99abc-ddcf-4714-b2a5-862d9b469509). Al ingresar a la página, haga clic en el botón «Acquire».
...
También puede usar la [Fish Tasks API](https://api.xhuoapi.ai/documents/fc541fac-a941-47fd-b6f7-48d6cb9da523) para consultar el estado de la tarea mediante `task_id`.
