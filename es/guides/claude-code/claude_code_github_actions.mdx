...
Este documento describe principalmente cómo configurar y usar Claude Code GitHub Actions a través del servicio proxy de XHuoAPI.
...
![Página de instalación de la aplicación GitHub Claude](https://cdn.xhuoapi.ai/ba4b8df66d.png)
...
Agrega la clave API de XHuoAPI como un secreto del repositorio:

1. Ve a **Settings** del repositorio → **Secrets and variables** → **Actions**
2. Haz clic en **New repository secret**
3. En el campo Name escribe `ANTHROPIC_API_KEY`, y en Value ingresa el token API que obtuviste en XHuoAPI
4. Haz clic en **Add secret** para guardar

> **Consejo**: El token API se puede ver en el [panel de control de XHuoAPI](https://api.xhuoapi.ai/console).
...
Si necesitas usar el punto final de la API proxy de XHuoAPI, también debes configurar la variable de entorno en el Workflow:
...
Inicie sesión en [XHuoAPI Console](https://api.xhuoapi.ai/console) para ver el saldo restante y el uso actual de la cuenta.
