...
Para utilizar la API, primero debes ir a la página correspondiente de la [API de creación de fotos de identificación con IA](https://api.xhuoapi.ai/documents/bf7214a3-8447-4157-8a75-f5bb39d5ed1b) para solicitar el servicio correspondiente. Una vez en la página, haz clic en el botón "Acquire", como se muestra en la imagen:
