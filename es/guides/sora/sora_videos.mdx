...
Para usar la API, primero debe solicitar el servicio correspondiente en la página [Sora Videos Generation API](https://api.xhuoapi.ai/documents/99a24421-2e22-4028-8201-e19cb834b67e). Al ingresar a la página, haga clic en el botón "Acquire", como se muestra en la imagen:
