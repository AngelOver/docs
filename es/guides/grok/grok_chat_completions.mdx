...
Para usar la API de Compleción de Chat de Grok, primero puedes ir a la página de [API de Compleción de Chat de Grok](https://api.xhuoapi.ai/documents/faf08b59-36aa-4d26-b5d9-a18f113cc2be) y hacer clic en el botón "Acquire" para obtener las credenciales necesarias para la solicitud:
