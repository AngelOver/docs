...
Para utilizar la API Midjourney Describe, primero debe ir a la página de solicitud [Midjourney Describe API](https://api.xhuoapi.ai/documents/870e973b-712a-4686-ab8b-beae27f129ce) para solicitar el servicio correspondiente. Una vez en la página, haga clic en el botón "Acquire", como se muestra en la imagen:
...
![Imagen de ejemplo](https://cdn.xhuoapi.ai/kg7xp3.png)
