...
Para utilizar la API de Tareas de Midjourney, primero debe ir a la página de solicitud [Midjourney Imagine API](https://api.xhuoapi.ai/documents/e52c028d-897a-4d51-b110-60fccbe6118d) para solicitar el servicio correspondiente, y luego copiar el ID de tarea de la API Imagine, como se muestra en la imagen:

<p><img src="https://cdn.xhuoapi.ai/lx4mwb.png" width="500" className="m-auto" /></p>

Finalmente, acceda a la página de la API de Tareas [Midjourney Tasks API](https://api.xhuoapi.ai/documents/58ea7cc1-c685-40c3-a619-f29f9ac5d8f4) para solicitar el servicio correspondiente. Una vez en la página, haga clic en el botón "Acquire", como se muestra en la imagen:
...
La API de Tareas de Midjourney se puede utilizar para consultar los resultados de las APIs de Midjourney Imagine y Midjourney Describe. Para saber cómo utilizar la API de Midjourney Imagine, consulte el documento [Midjourney Imagine API](https://api.xhuoapi.ai/documents/b0e32002-2707-41cc-b103-a15b1f1efdc1). Para saber cómo utilizar Midjourney Describe, consulte [Midjourney Describe API](https://api.xhuoapi.ai/documents/d2a04242-507c-4a49-a17a-01bc382c5756).
