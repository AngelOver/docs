...
Para utilizar la API, primero debe ir a la página correspondiente de la [API de verificación de fotos de identificación](https://api.xhuoapi.ai/documents/7a3f14f7-f1eb-41c2-816c-9f18caca6883) para solicitar el servicio correspondiente. Una vez en la página, haga clic en el botón "Acquire", como se muestra en la imagen:
