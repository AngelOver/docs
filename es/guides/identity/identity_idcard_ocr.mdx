...
Para usar la API, primero debe ir a la página correspondiente de la [API de reconocimiento de identificación y verificación de información](https://api.xhuoapi.ai/documents/67f96afa-60b8-4cbb-a4bf-0cbfcf139a23) para solicitar el servicio correspondiente. Después de ingresar a la página, haga clic en el botón "Acquire", como se muestra en la imagen:
