...
Para utilizar la API, primero debes ir a la página correspondiente de [Productor Audios Generation API](https://api.xhuoapi.ai/documents/producer-audios) para solicitar el servicio correspondiente. Una vez en la página, haz clic en el botón "Acquire", como se muestra en la imagen:
...
Si deseas continuar escribiendo una canción que has subido, puedes establecer el parámetro `action` como `upload_extend` y también ingresar el ID de la canción que deseas continuar escribiendo. El ID de la canción se obtiene utilizando la [API de carga de productores](https://api.xhuoapi.ai/documents/7fd2cb52-772e-4cc4-a018-e2626ff6f447), como se muestra en la imagen a continuación:
...
Si desea continuar reemplazando fragmentos de la canción que ha subido, puede establecer el parámetro `action` en `upload_replace_section` e ingresar el ID de la canción que necesita continuar escribiendo. El ID de la canción se obtiene utilizando la [API de carga de productores](https://api.xhuoapi.ai/documents/7fd2cb52-772e-4cc4-a018-e2626ff6f447) como se muestra en la imagen a continuación:
