...
[MCP (Modelo Contexto Protocolo)](https://modelcontextprotocol.io) es un protocolo de contexto de modelo lanzado por Anthropic, que permite a los modelos de IA (como Claude, GPT, etc.) llamar a herramientas externas a través de interfaces estandarizadas. A través del Midjourney MCP Server proporcionado por XHuoAPI, puedes generar y editar imágenes de IA directamente en clientes de IA como Claude Desktop, VS Code, Cursor, etc.
...
2. Ve a la página de [Midjourney Imagine API](https://api.xhuoapi.ai/documents/midjourney-imagine)
...
- Repositorio de GitHub: [XHuoAPI/MidjourneyMCP](https://github.com/XHuoAPI/MidjourneyMCP)
- Paquete de PyPI: [mcp-midjourney](https://pypi.org/project/mcp-midjourney/)
- Documentación de API: [API de generación de Midjourney](https://api.xhuoapi.ai/documents/midjourney)
