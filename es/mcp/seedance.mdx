...
[MCP (Model Context Protocol)](https://modelcontextprotocol.io) es un protocolo de contexto de modelo lanzado por Anthropic, que permite a los modelos de IA (como Claude, GPT, etc.) llamar a herramientas externas a través de una interfaz estandarizada. Mediante el Seedance MCP Server proporcionado por XHuoAPI, puedes usar directamente la generación de videos AI de Seedance de ByteDance en clientes de IA como Claude Desktop, VS Code, Cursor, entre otros.
...
2. Accede a la página de [Seedance Videos API](https://api.xhuoapi.ai/documents/seedance-videos)
...
- Repositorio GitHub: [XHuoAPI/SeedanceMCP](https://github.com/XHuoAPI/SeedanceMCP)
- Paquete PyPI: [mcp-seedance](https://pypi.org/project/mcp-seedance/)
- Documentación API: [Seedance Video Generation API](https://api.xhuoapi.ai/documents/seedance)
