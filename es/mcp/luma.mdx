...
[MCP (Modelo Contexto Protocolo)](https://modelcontextprotocol.io) es un protocolo de contexto de modelo lanzado por Anthropic, que permite a los modelos de IA (como Claude, GPT, etc.) llamar a herramientas externas a través de interfaces estandarizadas. A través del Luma MCP Server proporcionado por XHuoAPI, puedes generar videos de IA directamente en clientes de IA como Claude Desktop, VS Code, Cursor, etc.
...
Antes de usar, necesitas obtener un Token de API de XHuoAPI:

1. Regístrate o inicia sesión en la [plataforma XHuoAPI](https://api.xhuoapi.ai)
2. Ve a la página de [API de Luma Videos](https://api.xhuoapi.ai/documents/luma-videos)
...
- Repositorio de GitHub: [XHuoAPI/LumaMCP](https://github.com/XHuoAPI/LumaMCP)
- Paquete de PyPI: [mcp-luma](https://pypi.org/project/mcp-luma/)
- Documentación de API: [API de generación de videos Luma](https://api.xhuoapi.ai/documents/luma)
