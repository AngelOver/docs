...
API를 사용하려면 먼저 [Hailuo 비디오 생성 API](https://api.xhuoapi.ai/documents/ee06377b-9185-438f-ac84-3376bcb1275e) 해당 페이지에서 서비스를 신청해야 합니다. 페이지에 들어가면 "Acquire" 버튼을 클릭합니다. 아래 그림과 같이:
