...
Wan Tasks API를 사용하려면 먼저 신청 페이지 [Wan Videos Generation API](https://api.xhuoapi.ai/documents/52b0f490-1bbf-4fe5-b60e-96626d333d2c)에서 해당 서비스를 신청한 후, Wan Videos Generation API의 작업 ID를 복사해야 합니다. 아래 그림과 같이:

<p><img src="https://cdn.xhuoapi.ai/om6p6g.png" width="500" className="m-auto" /></p>

마지막으로 Tasks API 페이지 [Wan Tasks API](https://api.xhuoapi.ai/documents/240ef446-cbec-461c-a633-4a64178d7018)에서 해당 서비스를 신청하고, 페이지에 들어가면 「Acquire」 버튼을 클릭합니다. 아래 그림과 같이:
...
Wan Tasks API는 Wan Videos Generation API의 결과를 조회하는 데 사용할 수 있습니다. Wan Videos Generation API를 사용하는 방법에 대한 자세한 내용은 문서 [Wan Videos Generation API](https://api.xhuoapi.ai/documents/52b0f490-1bbf-4fe5-b60e-96626d333d2c)를 참조하십시오.
