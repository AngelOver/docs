...
Midjourney Describe API를 사용하려면 먼저 신청 페이지 [Midjourney Describe API](https://api.xhuoapi.ai/documents/870e973b-712a-4686-ab8b-beae27f129ce)에서 해당 서비스를 신청해야 합니다. 페이지에 들어가면 "Acquire" 버튼을 클릭합니다, 아래 그림과 같이:
...
![예시 이미지](https://cdn.xhuoapi.ai/kg7xp3.png)
