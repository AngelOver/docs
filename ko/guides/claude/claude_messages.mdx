...
Claude Messages API를 사용하려면 먼저 [Claude Messages API](https://api.xhuoapi.ai/documents/280928a2-2dce-419c-adb5-1ea835e8183a) 페이지에서 "Acquire" 버튼을 클릭하여 요청에 필요한 자격 증명을 얻을 수 있습니다:
...
XHuoAPI는 두 가지 Claude API 형식을 제공하며, 두 형식의 주요 차이점은 다음과 같습니다:
