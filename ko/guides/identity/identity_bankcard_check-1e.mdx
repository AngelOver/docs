...
API를 사용하려면 먼저 [은행 카드 기본 정보 조회 API](https://api.xhuoapi.ai/documents/3523988d-acba-4362-9def-105657991eb4) 해당 페이지에서 서비스를 신청해야 합니다. 페이지에 들어가면 "Acquire" 버튼을 클릭합니다, 아래 그림과 같이:
