...
API를 사용하려면 먼저 [휴대폰 번호 이요소 검증 API](https://api.xhuoapi.ai/documents/1f39c948-6d9b-48f5-83fb-0719da4f6ab0) 해당 페이지에서 서비스를 신청해야 하며, 페이지에 들어가면 「Acquire」 버튼을 클릭합니다, 아래 그림과 같이:
