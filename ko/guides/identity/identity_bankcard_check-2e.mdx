...
API를 사용하려면 먼저 [은행 카드 이요소 검증 API](https://api.xhuoapi.ai/documents/06efe2aa-5443-4dcc-af2f-28236bfb2158) 해당 페이지에서 서비스를 신청해야 하며, 페이지에 들어가면 「Acquire」 버튼을 클릭합니다, 아래 그림과 같이:
