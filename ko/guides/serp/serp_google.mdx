...
Google SERP API를 사용하려면 먼저 [Google SERP API](https://api.xhuoapi.ai/documents/44c86226-8eaa-49bf-85f3-1fae8d2e23f1) 해당 페이지에서 서비스를 신청해야 하며, 페이지에 들어가면 "Acquire" 버튼을 클릭합니다. 아래 그림과 같이:
