...
Veo Tasks API를 사용하려면 먼저 신청 페이지 [Veo Videos Generation API](https://api.xhuoapi.ai/documents/63e01dc3-eb21-499e-8049-3025c460058f)에서 해당 서비스를 신청한 후, Veo Videos Generation API의 작업 ID를 복사합니다. 아래 그림과 같이:

<p><img src="https://cdn.xhuoapi.ai/txlg6g.png" width="500" className="m-auto" /></p>

마지막으로 Tasks API 페이지 [Veo Tasks API](https://api.xhuoapi.ai/documents/52778f8b-93ce-4db3-a62c-bcf0a92e5f3c)에서 해당 서비스를 신청하고, 페이지에 들어가면 「Acquire」 버튼을 클릭합니다. 아래 그림과 같이:
...
Veo Tasks API는 Veo Videos Generation API의 결과를 조회하는 데 사용할 수 있습니다. Veo Videos Generation API를 사용하는 방법에 대한 자세한 내용은 문서 [Veo Videos Generation API](https://api.xhuoapi.ai/documents/63e01dc3-eb21-499e-8049-3025c460058f)를 참조하십시오.
