...
OpenAI Embeddings API를 사용하려면 먼저 [OpenAI Embeddings API](https://api.xhuoapi.ai/documents/0f2e63fa-5890-4bdd-84f0-1706b5c9a387) 페이지에서 "Acquire" 버튼을 클릭하여 요청에 필요한 자격 증명을 얻습니다:
