...
Localization Translate API를 사용하려면 먼저 신청 페이지 [Localization Translate API](https://api.xhuoapi.ai/documents/6dcc60d0-a973-4ad2-92d8-11f4d3775532)에서 해당 서비스를 신청해야 합니다. 페이지에 들어가면 "Acquire" 버튼을 클릭합니다. 아래와 같이 표시됩니다:
