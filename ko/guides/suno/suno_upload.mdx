...
곡 ID를 얻은 후, 우리는 [Suno Audios Generation API](https://api.xhuoapi.ai/documents/4da95d9d-7722-4a72-857d-bf6be86036e9)를 사용하여 사용자 정의 곡 생성을 할 수 있습니다. 예를 들어, `action`에 `upload_extend`를 전달하고, `audio_id`에 반환된 곡 ID를 전달하면 참조 오디오에 따라 새로운 곡을 생성할 수 있습니다.
