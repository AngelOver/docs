...
API를 사용하려면 먼저 [Recaptcha3 프로토콜 인식 API](https://api.xhuoapi.ai/documents/1083df69-f2f3-4c13-901e-e5336b0dbe3d) 해당 페이지에서 서비스를 신청해야 하며, 페이지에 들어가면 「Acquire」 버튼을 클릭합니다. 아래와 같이 표시됩니다:
