...
API를 사용하려면 먼저 [Recaptcha2 프로토콜 인식 API](https://api.xhuoapi.ai/documents/597b8f11-26d8-4a1d-9a83-8d33bc4b8af7) 해당 페이지에서 서비스를 신청해야 합니다. 페이지에 들어가면 「Acquire」 버튼을 클릭합니다. 아래와 같이 표시됩니다:
