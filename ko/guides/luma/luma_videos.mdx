...
하지만 Luma 공식에서는 API를 제공하지 않으며, XHuoAPI는 Luma의 API를 제공하여 Suno 공식과의 연동을 모방하여 원하는 비디오를 편리하고 신속하게 생성할 수 있도록 합니다.

## 신청 및 사용

Luma Videos API를 사용하려면 먼저 [Luma Videos Generation API](https://api.xhuoapi.ai/documents/5bd3597d-1ff8-44ad-a580-b66b48393e7f) 페이지에서 "Acquire" 버튼을 클릭하여 요청에 필요한 자격 증명을 얻을 수 있습니다:
...
![시작 프레임](https://cdn.xhuoapi.ai/r9vsv9.png)
...
![종료 프레임](https://cdn.xhuoapi.ai/0iad3k.png)
...
![마지막 프레임](https://cdn.xhuoapi.ai/0iad3k.png)
