...
För att använda OpenAI Images Generations API kan du först gå till sidan [OpenAI Images Generations API](https://api.xhuoapi.ai/documents/fd932485-90c7-45d6-8394-1e14b6f07b2b) och klicka på knappen "Acquire" för att få de nödvändiga autentiseringsuppgifterna:
