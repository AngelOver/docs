...
För att använda OpenAI Chat Completion 4o Image API kan du först gå till [OpenAI Chat Completion 4o Image API](https://api.xhuoapi.ai/documents/1bcf3bba-102b-495d-9bba-47cd96717e45) sidan och klicka på "Acquire"-knappen för att få de nödvändiga autentiseringsuppgifterna:
