...
För att använda OpenAI Responses API kan du först gå till [OpenAI Responses API](https://api.xhuoapi.ai/documents/81e285a6-d010-4a2d-a3a8-ca113d4ef82a) sidan och klicka på "Acquire" knappen för att få de nödvändiga autentiseringsuppgifterna:
