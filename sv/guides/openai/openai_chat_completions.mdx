...
För att använda OpenAI Chat Completion API kan du först gå till [OpenAI Chat Completion API](https://api.xhuoapi.ai/documents/1bcf3bba-102b-495d-9bba-47cd96717e45) sidan och klicka på "Acquire" knappen för att få de nödvändiga autentiseringsuppgifterna:
...
OPENAI_BASE_URL="https://api.xhuoapi.ai/v1/openai"  # Återigen påminner jag: om du använder officiella OpenAI-nyckeln, använd inte denna adress.
```
