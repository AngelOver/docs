...
För att använda OpenAI Embeddings API kan du först gå till [OpenAI Embeddings API](https://api.xhuoapi.ai/documents/0f2e63fa-5890-4bdd-84f0-1706b5c9a387) sidan och klicka på "Acquire"-knappen för att få de nödvändiga autentiseringsuppgifterna:
