...
För att använda API:et måste du först gå till [SeeDance Videos Generation API](https://api.xhuoapi.ai/documents/seedance-videos) motsvarande sida för att ansöka om den tjänst som behövs. När du kommer till sidan, klicka på knappen "Acquire", som visas i bilden nedan:
