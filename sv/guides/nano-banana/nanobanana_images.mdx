...
Innan användning, vänligen gå till [Nano Banana Images API](https://api.xhuoapi.ai/documents/23985a11-d713-41d1-ad84-24b021805b3d) på XHuoAPI-plattformen och klicka på Acquire för att ansöka om aktivering. Första gången du ansöker finns det vanligtvis en gratis kvot tillgänglig. När aktiveringen är klar kan du hämta Bearer Token som används för att anropa API:et.

## Gränssnittsöversikt

- **Bas-URL**: `https://api.xhuoapi.ai/v1`
