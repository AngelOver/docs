...
För att använda API:et måste du först ansöka om motsvarande tjänst på [SeeDream Images Generation API](https://api.xhuoapi.ai/documents/seedream-images). När du går in på sidan klickar du på knappen "Acquire", som visas nedan:
