...
Denna dokumentation introducerar integrationsbeskrivningen för Fish TTS API. Detta gränssnitt är helt kompatibelt med [Fish Audio officiella OpenAPI](https://docs.fish.audio/text-to-speech/text-to-speech) och kan direkt migreras från kod som använder `https://api.fish.audio/v1/tts` till `https://api.xhuoapi.ai/v1/fish/tts` genom att bara byta autentiseringsuppgifter, utan att ändra request-strukturen.

## Ansökningsprocess

För att använda API:et måste du först ansöka om motsvarande tjänst på sidan [Fish TTS API](https://api.xhuoapi.ai/services/caf99abc-ddcf-4714-b2a5-862d9b469509). När du är på sidan klickar du på knappen „Acquire“.
...
Du kan även använda [Fish Tasks API](https://api.xhuoapi.ai/documents/fc541fac-a941-47fd-b6f7-48d6cb9da523) för att aktivt poll:a status via `task_id`.
