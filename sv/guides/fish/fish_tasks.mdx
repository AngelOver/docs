...
För att använda Fish Tasks API måste du först gå till ansökningssidan [Fish Audios Generation API](https://api.xhuoapi.ai/documents/e681b715-54fd-4464-a59a-d7f14500e095) för att ansöka om den aktuella tjänsten, och sedan kopiera uppdrag-ID:t från Fish Audios Generation API, som visas i bilden:

<p><img src="https://cdn.xhuoapi.ai/jxvue8.png" width="500" className="m-auto" /></p>

Slutligen går du till Tasks API-sidan [Fish Tasks API](https://api.xhuoapi.ai/documents/44c93949-1419-4a45-8db5-8a8335de7151) för att ansöka om den aktuella tjänsten. När du kommer till sidan klickar du på knappen "Acquire", som visas i bilden:
...
Fish Tasks API kan användas för att kontrollera resultaten från Fish Audios Generation API. För information om hur man använder Fish Audios Generation API, se dokumentet [Fish Videos Generation API](https://api.xhuoapi.ai/documents/fish-audios-integration).
