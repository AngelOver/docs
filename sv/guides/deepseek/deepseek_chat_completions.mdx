...
För att använda DeepSeek Chat Completion API kan du först gå till [DeepSeek Chat Completion API](https://api.xhuoapi.ai/documents/2d6a9bae-9a70-4aaa-bd72-28e5bd60fa67) sidan och klicka på "Acquire"-knappen för att få de nödvändiga autentiseringsuppgifterna:
