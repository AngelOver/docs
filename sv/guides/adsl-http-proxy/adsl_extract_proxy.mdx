...
För att använda extraheringen av ADSL:s IP och lägga till IP-whitelist för ADSL Proxy, kan du först gå till [ADSL Proxy Extract API](https://api.xhuoapi.ai/documents/d8426c17-d22c-449a-b6bf-0a7790928e4d) och [ADSL Proxy Whitelist API](https://api.xhuoapi.ai/documents/c21534fe-1f62-424b-9b10-a805cb473dd1) sidorna och klicka på "Acquire"-knappen för att få de nödvändiga autentiseringsuppgifterna:
...
Därefter kan du fylla i motsvarande innehåll på sidan [ADSL Proxy Extract API](https://api.xhuoapi.ai/documents/d8426c17-d22c-449a-b6bf-0a7790928e4d), här visas hur man extraherar ADSL:s IP.
