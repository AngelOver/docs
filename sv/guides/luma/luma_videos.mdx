...
Men Luma erbjuder officiellt ingen API, XHuoAPI tillhandahåller en uppsättning Luma API:er som simulerar integrationen med Suno officiellt, vilket gör det enkelt och snabbt att generera önskade videor.

## Ansökan och användning

För att använda Luma Videos API kan du först gå till [Luma Videos Generation API](https://api.xhuoapi.ai/documents/5bd3597d-1ff8-44ad-a580-b66b48393e7f) sidan och klicka på "Acquire" knappen för att få de nödvändiga autentiseringsuppgifterna:
...
![Första bild](https://cdn.xhuoapi.ai/r9vsv9.png)
...
![Sista bild](https://cdn.xhuoapi.ai/0iad3k.png)
