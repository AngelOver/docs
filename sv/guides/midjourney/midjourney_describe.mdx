...
För att använda Midjourney Describe API måste du först gå till ansökningssidan [Midjourney Describe API](https://api.xhuoapi.ai/documents/870e973b-712a-4686-ab8b-beae27f129ce) för att ansöka om den aktuella tjänsten. När du kommer till sidan, klicka på knappen "Acquire", som visas i bilden nedan:
...
![Exempelbild](https://cdn.xhuoapi.ai/kg7xp3.png)
