...
För att använda Midjourney Translate API måste du först gå till ansökningssidan [Midjourney Translate API](https://api.xhuoapi.ai/documents/e067d19b-7a66-4458-a45f-0fe88c1d5d34) för att ansöka om den tjänst som behövs. När du kommer till sidan, klicka på knappen "Acquire", som visas i bilden:

![Ansökningssidan](https://cdn.xhuoapi.ai/rci31i.png)

Om du inte har loggat in eller registrerat dig kommer du automatiskt att omdirigeras till [inloggningssidan](https://api.xhuoapi.ai) där du uppmanas att registrera dig och logga in. Efter inloggning kommer du automatiskt att återvända till den aktuella sidan.
