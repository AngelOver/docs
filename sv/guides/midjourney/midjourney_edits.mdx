...
För att använda API:et måste du först gå till [Midjourney Edits API](https://api.xhuoapi.ai/documents/midjourney-edits) motsvarande sida för att ansöka om den tjänst som behövs. När du kommer till sidan, klicka på knappen "Acquire", som visas i bilden nedan:
