...
För att använda API:et måste du först gå till [Midjourney Videos API](https://api.xhuoapi.ai/documents/midjourney-videos) motsvarande sida för att ansöka om den tjänst som behövs. När du kommer till sidan, klicka på knappen "Acquire", som visas i bilden nedan:
