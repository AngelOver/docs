...
要使用 Midjourney Shorten API，需要先到申请页面 [Midjourney Shorten API](https://api.xhuoapi.ai/documents/f0c6be1d-c084-43ac-bde6-44ef9cf824a2) 申请相应的服务，进入页面之后，点击「Acquire」按钮。
