...
För att använda API:et måste du först gå till [API för ansiktsåldersförändring](https://api.xhuoapi.ai/documents/0c5b4165-25ba-4dc2-8f02-e3cd74ab4238) och ansöka om den tjänst som motsvarar. När du kommer till sidan klickar du på knappen "Acquire", som visas i bilden nedan:
