...
För att använda API:et måste du först gå till [Fem kännetecken positionering API](https://api.xhuoapi.ai/documents/20945baf-b263-457b-be5f-0332c2180a57) motsvarande sida för att ansöka om den tjänst som behövs, när du kommer in på sidan, klicka på "Acquire" knappen, som visas i bilden nedan:
