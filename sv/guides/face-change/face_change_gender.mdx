...
För att använda API:et måste du först gå till [API för ansikts könsbyte](https://api.xhuoapi.ai/documents/0e4e5318-060e-4976-8d3a-171301240f8c) och ansöka om den tjänst som motsvarar sidan. När du kommer till sidan, klicka på knappen "Acquire", som visas i bilden nedan:
