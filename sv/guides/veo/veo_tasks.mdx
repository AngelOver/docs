...
För att använda Veo Tasks API måste du först gå till ansökningssidan [Veo Videos Generation API](https://api.xhuoapi.ai/documents/63e01dc3-eb21-499e-8049-3025c460058f) för att ansöka om den aktuella tjänsten, och sedan kopiera uppgiftens ID från Veo Videos Generation API, som visas i bilden:

<p><img src="https://cdn.xhuoapi.ai/txlg6g.png" width="500" className="m-auto" /></p>

Slutligen går du till Tasks API-sidan [Veo Tasks API](https://api.xhuoapi.ai/documents/52778f8b-93ce-4db3-a62c-bcf0a92e5f3c) för att ansöka om den aktuella tjänsten. När du kommer till sidan klickar du på "Acquire"-knappen, som visas i bilden:
...
Veo Tasks API kan användas för att kontrollera resultaten från Veo Videos Generation API. För information om hur man använder Veo Videos Generation API, se dokumentet [Veo Videos Generation API](https://api.xhuoapi.ai/documents/63e01dc3-eb21-499e-8049-3025c460058f).
