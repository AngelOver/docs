...
När du har röstkaraktärens ID kan du använda [Suno Audios Generation API](https://api.xhuoapi.ai/documents/4da95d9d-7722-4a72-857d-bf6be86036e9) för musikgenerering. Sätt `action` till `generate` och `persona_id` till det röstkaraktärs-ID som returnerades ovan, så kommer den genererade låten att sjungas med den klonade rösten.
