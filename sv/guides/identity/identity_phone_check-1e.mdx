...
För att använda API:et måste du först gå till [Mobilnummerstatuskontroll API](https://api.xhuoapi.ai/documents/037e2b5b-d0c0-425c-9e13-955ac64d1e07) motsvarande sida för att ansöka om den tjänst som behövs, när du kommer in på sidan, klicka på "Acquire"-knappen, som visas i bilden:
