...
För att använda API:et måste du först gå till [Identitetsinformation och giltighetsverifiering API](https://api.xhuoapi.ai/documents/667017a4-017f-4af0-870e-807034f70632) motsvarande sida för att ansöka om den tjänst som behövs. När du kommer till sidan, klicka på "Acquire" knappen, som visas i bilden nedan:
