...
För att använda API:et måste du först gå till [Bankkort tre element verifiering API](https://api.xhuoapi.ai/documents/eb9c6677-68db-4549-a207-41f8a1084634) motsvarande sida för att ansöka om den tjänst som behövs. När du kommer till sidan, klicka på "Acquire" knappen, som visas i bilden:
