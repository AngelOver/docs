...
För att använda API:et måste du först gå till [Bankkortets grundläggande informationssökning API](https://api.xhuoapi.ai/documents/3523988d-acba-4362-9def-105657991eb4) motsvarande sida för att ansöka om den tjänst som behövs. När du kommer till sidan, klicka på knappen "Acquire", som visas i bilden:
