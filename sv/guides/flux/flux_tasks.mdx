...
För att använda Flux Tasks API måste du först gå till ansökningssidan [Flux Images Generation API](https://api.xhuoapi.ai/documents/6b9197c5-7a3f-4878-a43f-7f94e7e66394) för att ansöka om den aktuella tjänsten, och sedan kopiera uppdragets ID från Flux Images Generation API, som visas i bilden nedan:

<p><img src="https://cdn.xhuoapi.ai/7furhb.png" width="500" className="m-auto" /></p>

Slutligen går du till Flux Tasks API-sidan [Flux Tasks API](https://api.xhuoapi.ai/documents/39b38bbe-60f3-40da-b2b6-5ce1e091852b) för att ansöka om den aktuella tjänsten. När du kommer till sidan klickar du på knappen "Acquire", som visas i bilden nedan.
...
Flux Tasks API kan användas för att kontrollera resultaten från Flux Images Generation API. För information om hur man använder Flux Images Generation API, se dokumentet [Flux Images Generation API](https://api.xhuoapi.ai/documents/flux-images-integration).
