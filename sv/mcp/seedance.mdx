...
2. Gå till sidan för [Seedance Videos API](https://api.xhuoapi.ai/documents/seedance-videos)
...
- GitHub-repo: [XHuoAPI/SeedanceMCP](https://github.com/XHuoAPI/SeedanceMCP)
- PyPI-paket: [mcp-seedance](https://pypi.org/project/mcp-seedance/)
- API-dokumentation: [Seedance Video Generation API](https://api.xhuoapi.ai/documents/seedance)
