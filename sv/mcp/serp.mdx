...
[MCP (Model Context Protocol)](https://modelcontextprotocol.io) är en modellkontextprotokoll som lanserats av Anthropic, vilket tillåter AI-modeller (som Claude, GPT etc.) att anropa externa verktyg via standardiserade gränssnitt. Genom SERP MCP Server som tillhandahålls av XHuoAPI kan du direkt göra Google-sökningar i AI-klienter som Claude Desktop, VS Code, Cursor etc., och få webbplatser, bilder, nyheter, videor, platser och andra sökresultat.
...
2. Gå till sidan [Google SERP API](https://api.xhuoapi.ai/documents/serp-google)
...
- GitHub-repo: [XHuoAPI/SerpMCP](https://github.com/XHuoAPI/SerpMCP)
- PyPI-paket: [mcp-serp](https://pypi.org/project/mcp-serp/)
- API-dokumentation: [Sökmotor API](https://api.xhuoapi.ai/documents/serp)
