...
2. Go to the [Luma Videos API](https://api.xhuoapi.ai/documents/luma-videos) page
...
- API Documentation: [Luma Video Generation API](https://api.xhuoapi.ai/documents/luma)
