...
2. Go to the [Midjourney Imagine API](https://api.xhuoapi.ai/documents/midjourney-imagine) page
...
- API Documentation: [Midjourney Generation API](https://api.xhuoapi.ai/documents/midjourney)
