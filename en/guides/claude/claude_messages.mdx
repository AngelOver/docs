...
To use the Claude Messages API, you can first visit the [Claude Messages API](https://api.xhuoapi.ai/documents/280928a2-2dce-419c-adb5-1ea835e8183a) page and click the "Acquire" button to obtain the credentials needed for the request:
...
XHuoAPI provides two formats of the Claude API, with the main differences as follows:
