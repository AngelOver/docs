...
To use the API, you need to first apply for the corresponding service on the [Kling Motion Generation API](https://api.xhuoapi.ai/documents/d3f2c369-102d-4856-9565-702ac5f2df63) page. After entering the page, click the "Acquire" button, as shown in the image:
