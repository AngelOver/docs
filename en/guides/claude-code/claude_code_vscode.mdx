...
This document mainly introduces how to configure and use the Claude Code extension in VS Code through the XHuoAPI proxy service.
...
![Claude Code Plugin in VS Code Marketplace](https://cdn.xhuoapi.ai/10ddf71320.png)
...
![Claude Code Panel in VS Code](https://cdn.xhuoapi.ai/b84b878420.jpg)
...
![Claude Code Conversation and Prompts in VS Code](https://cdn.xhuoapi.ai/650377f5cc.png)
...
![Diff comparison view in VS Code](https://cdn.xhuoapi.ai/c42381ea9f.png)
...
2. Confirm that the API token is valid (can be checked in the [console](https://api.xhuoapi.ai/console))
3. Check if the network connection is normal and ensure access to `https://api.xhuoapi.ai/v1`
