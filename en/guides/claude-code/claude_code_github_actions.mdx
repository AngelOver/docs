...
This document mainly introduces how to configure and use Claude Code GitHub Actions through XHuoAPI's proxy service.

## Application Process

To use Claude Code, first visit the [Claude Messages service page](https://api.xhuoapi.ai/documents/claude-messages) and click the "Acquire" button to obtain the credentials needed for the request:
...
![GitHub Claude App Installation Page](https://cdn.xhuoapi.ai/ba4b8df66d.png)
...
Add the XHuoAPI API key as a repository Secret:

1. Go to the repository **Settings** → **Secrets and variables** → **Actions**
2. Click **New repository secret**
3. Name it `ANTHROPIC_API_KEY`, and enter the API token you obtained from XHuoAPI in the Value field.
4. Click **Add secret** to save.

> **Tip**: The API token can be viewed in the [XHuoAPI Console](https://api.xhuoapi.ai/console).
...
If you need to use XHuoAPI's proxy API endpoint, you also need to set environment variables in the Workflow:
