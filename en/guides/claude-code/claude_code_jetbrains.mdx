...
This document mainly introduces how to configure and use Claude Code in JetBrains IDE through the proxy service of XHuoAPI.
...
![Claude Code Plugin in JetBrains Marketplace](https://cdn.xhuoapi.ai/de78fd305b.png)
