...
To use the API, you need to first apply for the corresponding service on the [hCaptcha Image Recognition API](https://api.xhuoapi.ai/documents/c9a5cc2f-e410-425f-857a-f8700205da6c) page. After entering the page, click the "Acquire" button, as shown in the image below:
