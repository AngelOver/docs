...
To use the Localization Translate API, you need to first apply for the corresponding service on the application page [Localization Translate API](https://api.xhuoapi.ai/documents/6dcc60d0-a973-4ad2-92d8-11f4d3775532). After entering the page, click the "Acquire" button, as shown in the image:

![Application Page](https://cdn.xhuoapi.ai/rci31i.png)

If you are not logged in or registered, you will be automatically redirected to the [login page](https://api.xhuoapi.ai) inviting you to register and log in. After logging in or registering, you will be automatically returned to the current page.
