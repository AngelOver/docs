...
If you want to customize song generation but don't want to write the lyrics yourself, you can use the lyrics generation API provided by XHuoAPI to generate lyrics through a prompt. The API is the [Suno Lyrics Generation API](https://api.xhuoapi.ai/documents/514d82dc-f7ab-4638-9f21-8b9275916b08).
...
With the lyrics in hand, we can then use the [Suno Audios Generation API](https://api.xhuoapi.ai/documents/4da95d9d-7722-4a72-857d-bf6be86036e9) to generate a custom song.
