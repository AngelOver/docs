...
To use the API, you need to apply for the corresponding service on the [SeeDream Images Generation API](https://api.xhuoapi.ai/documents/seedream-images) page. After entering the page, click the "Acquire" button, as shown below:
