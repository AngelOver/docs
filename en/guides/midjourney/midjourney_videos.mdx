...
To use the API, you need to first apply for the corresponding service on the [Midjourney Videos API](https://api.xhuoapi.ai/documents/midjourney-videos) page. After entering the page, click the "Acquire" button, as shown in the image below:
