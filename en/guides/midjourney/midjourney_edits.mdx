...
To use the API, you first need to apply for the corresponding service on the [Midjourney Edits API](https://api.xhuoapi.ai/documents/midjourney-edits) page. After entering the page, click the "Acquire" button, as shown in the image below:
