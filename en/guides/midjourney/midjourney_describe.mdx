...
To use the Midjourney Describe API, you need to first apply for the corresponding service on the application page [Midjourney Describe API](https://api.xhuoapi.ai/documents/870e973b-712a-4686-ab8b-beae27f129ce). After entering the page, click the "Acquire" button, as shown in the image below:
...
![Example Image](https://cdn.xhuoapi.ai/kg7xp3.png)
