...
To use the Midjourney Translate API, you first need to apply for the corresponding service on the application page [Midjourney Translate API](https://api.xhuoapi.ai/documents/e067d19b-7a66-4458-a45f-0fe88c1d5d34). After entering the page, click the "Acquire" button, as shown in the image:
