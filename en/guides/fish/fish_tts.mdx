...
To use the API, you need to apply for the corresponding service on the [Fish TTS API](https://api.xhuoapi.ai/services/caf99abc-ddcf-4714-b2a5-862d9b469509) page. After entering the page, click the "Acquire" button.
...
You can also actively poll the task status using the [Fish Tasks API](https://api.xhuoapi.ai/documents/fc541fac-a941-47fd-b6f7-48d6cb9da523) with the `task_id`.
