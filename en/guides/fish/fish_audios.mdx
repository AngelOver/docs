...
To use the API, you need to first apply for the corresponding service on the [Fish Audios Generation API](https://api.xhuoapi.ai/documents/e681b715-54fd-4464-a59a-d7f14500e095) page. After entering the page, click the "Acquire" button, as shown in the image below:
