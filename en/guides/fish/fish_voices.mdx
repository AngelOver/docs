...
To use the API, you need to first apply for the corresponding service on the [Fish Voices Generation API](https://api.xhuoapi.ai/documents/55e61b64-ac7d-4710-a7f1-57a4ba786b17) page. After entering the page, click the "Acquire" button, as shown in the image below:
