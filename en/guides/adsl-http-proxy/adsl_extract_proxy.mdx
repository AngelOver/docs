...
To use the extraction of ADSL IPs and add IPs to the ADSL Proxy whitelist, you can first go to the [ADSL Proxy Extract API](https://api.xhuoapi.ai/documents/d8426c17-d22c-449a-b6bf-0a7790928e4d) and [ADSL Proxy Whitelist API](https://api.xhuoapi.ai/documents/c21534fe-1f62-424b-9b10-a805cb473dd1) pages and click the "Acquire" button to obtain the credentials needed for the request:
...
Next, you can fill in the corresponding content on the [ADSL Proxy Extract API](https://api.xhuoapi.ai/documents/d8426c17-d22c-449a-b6bf-0a7790928e4d) interface. Below is a demonstration of how to extract ADSL IPs.
