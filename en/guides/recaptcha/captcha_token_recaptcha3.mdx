...
To use the API, you need to first apply for the corresponding service on the [Recaptcha3 Protocol Recognition API](https://api.xhuoapi.ai/documents/1083df69-f2f3-4c13-901e-e5336b0dbe3d) page. After entering the page, click the "Acquire" button, as shown in the image below:
