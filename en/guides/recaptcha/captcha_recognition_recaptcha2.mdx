...
To use the API, you need to first apply for the corresponding service on the [Recaptcha2 Image Recognition API](https://api.xhuoapi.ai/documents/b9bf7d07-b178-4881-ae45-a852ec40f53e) page. After entering the page, click the "Acquire" button, as shown in the image below:
