...
To use the API, you need to first apply for the corresponding service on the [Recaptcha2 Protocol Recognition API](https://api.xhuoapi.ai/documents/597b8f11-26d8-4a1d-9a83-8d33bc4b8af7) page. After entering the page, click the "Acquire" button, as shown in the image below:
