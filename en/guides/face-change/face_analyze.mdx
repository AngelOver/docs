...
To use the API, you need to first apply for the corresponding service on the [Facial Feature Localization API](https://api.xhuoapi.ai/documents/20945baf-b263-457b-be5f-0332c2180a57) page. After entering the page, click the "Acquire" button, as shown in the image below:
