...
To use the API, you need to first apply for the corresponding service on the [Face Gender Transformation API](https://api.xhuoapi.ai/documents/0e4e5318-060e-4976-8d3a-171301240f8c) page. After entering the page, click the "Acquire" button, as shown in the image below:
