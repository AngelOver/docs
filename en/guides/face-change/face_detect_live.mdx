...
To use the API, you need to first apply for the corresponding service on the [Face Static Liveness Detection (High Precision Version) API](https://api.xhuoapi.ai/documents/df41d411-6ba8-41d3-a56f-3f6ec9acaa36) page. After entering the page, click the "Acquire" button, as shown in the image below:
