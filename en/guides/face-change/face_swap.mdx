...
To use the Face Swap API, you need to first apply for the corresponding service on the application page [Face Swap API](https://api.xhuoapi.ai/documents/d10df07a-66a6-4c37-b114-3a003fc9bd55). After entering the page, click the "Acquire" button, as shown in the image below:
