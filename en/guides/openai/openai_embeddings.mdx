...
To use the OpenAI Embeddings API, you can first go to the [OpenAI Embeddings API](https://api.xhuoapi.ai/documents/0f2e63fa-5890-4bdd-84f0-1706b5c9a387) page and click the "Acquire" button to obtain the credentials needed for the request:
