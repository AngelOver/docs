...
To use the API, you need to first apply for the corresponding service on the [Digital English Captcha Recognition API](https://api.xhuoapi.ai/documents/cd1f56dc-e9c9-4293-9c68-80fa560c9087) page. After entering the page, click the "Acquire" button, as shown in the image:
