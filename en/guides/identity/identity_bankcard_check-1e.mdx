...
To use the API, you need to first apply for the corresponding service on the [Bank Card Basic Information Query API](https://api.xhuoapi.ai/documents/3523988d-acba-4362-9def-105657991eb4) page. After entering the page, click the "Acquire" button, as shown in the image:
