...
To use the API, you need to first apply for the corresponding service on the [ID Card Portrait Photo Verification API](https://api.xhuoapi.ai/documents/7a3f14f7-f1eb-41c2-816c-9f18caca6883) page. After entering the page, click the "Acquire" button, as shown in the figure:
