...
To use the API, you need to first apply for the corresponding service on the [Mobile Number Two-Factor Verification API](https://api.xhuoapi.ai/documents/1f39c948-6d9b-48f5-83fb-0719da4f6ab0) page. After entering the page, click the "Acquire" button, as shown in the image:
