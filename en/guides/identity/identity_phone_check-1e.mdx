...
To use the API, you need to first apply for the corresponding service on the [Mobile Number Status Query API](https://api.xhuoapi.ai/documents/037e2b5b-d0c0-425c-9e13-955ac64d1e07) page. After entering the page, click the "Acquire" button, as shown in the image:
