...
To use the API, you need to first apply for the corresponding service on the [ID Card Recognition and Information Verification API](https://api.xhuoapi.ai/documents/67f96afa-60b8-4cbb-a4bf-0cbfcf139a23) page. After entering the page, click the "Acquire" button, as shown in the image below:
