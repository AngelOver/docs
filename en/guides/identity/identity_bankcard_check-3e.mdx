...
To use the API, you need to first apply for the corresponding service on the [Bank Card Three Elements Verification API](https://api.xhuoapi.ai/documents/eb9c6677-68db-4549-a207-41f8a1084634) page. After entering the page, click the "Acquire" button, as shown in the image:
