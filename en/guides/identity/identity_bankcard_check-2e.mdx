...
To use the API, you need to first apply for the corresponding service on the [Bank Card Two-Factor Verification API](https://api.xhuoapi.ai/documents/06efe2aa-5443-4dcc-af2f-28236bfb2158) page. After entering the page, click the "Acquire" button, as shown in the image:
