...
To use the API, you need to first apply for the corresponding service on the [Bank Card Four Elements Verification API](https://api.xhuoapi.ai/documents/02f77369-ec7b-4218-a956-d7a84982a626) page. After entering the page, click the "Acquire" button, as shown in the image:
