...
To use the API, you need to first apply for the corresponding service on the [Mobile Number Three Elements Verification API](https://api.xhuoapi.ai/documents/b4c50108-dda5-4ddb-ba84-776060fb0151) page. After entering the page, click the "Acquire" button, as shown in the image:
