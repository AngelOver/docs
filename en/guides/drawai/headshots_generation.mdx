...
To use the API, you need to first apply for the corresponding service on the [AI ID Photo Production API](https://api.xhuoapi.ai/documents/bf7214a3-8447-4157-8a75-f5bb39d5ed1b) page. After entering the page, click the "Acquire" button, as shown in the image:
