...
The AI Chat v2 API (`/aichat2/conversations`) is the next-generation conversational interface, a comprehensive upgrade of the [AI Chat API](https://api.xhuoapi.ai/documents/59fb1199-6694-4afb-a222-3554d7f7d05a). Building on the simplicity and multi-turn conversation hosting of v1, it extends with:
...
To use the API, first apply for the corresponding service on the [AI Chat v2 API](https://api.xhuoapi.ai/documents/e4a7c2b9-3f1d-4e8a-9b6c-a5d2f8e1b4c7) page. After entering the page, click the "Acquire" button to obtain the credentials needed for requests.
...
- User has authorized Google Drive / GitHub / Notion, etc. in [Connections](https://api.xhuoapi.ai/connections) → model can invoke corresponding MCP tools to read/write data.
...
If you are already using [`/aichat/conversations`](https://api.xhuoapi.ai/documents/59fb1199-6694-4afb-a222-3554d7f7d05a), migrating to v2 requires almost no code changes:
