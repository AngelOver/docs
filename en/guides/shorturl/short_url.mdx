...
To use the API, you need to first apply for the corresponding service on the [Short URL API](https://api.xhuoapi.ai/documents/a2303356-6672-4eb8-9778-75f55c998fe9) page. After entering the page, click the "Acquire" button, as shown in the image:
...
It can be seen that the original long URL `https://api.xhuoapi.ai/documents/a2303356-6672-4eb8-9778-75f55c998fe9` has been successfully converted to the short URL `https://surl.id/1uHCs01xa5`.
