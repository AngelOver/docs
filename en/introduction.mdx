---
title: "Introduction"
description: "XHuoAPI provides a unified AI API platform, allowing access to over 50 AI services including LLM chat, image generation, video generation, music generation, web search, and more with a single API Key."
