...
要使用 Localization Translate API，需要先到 申请页面 [Localization Translate API ](https://api.xhuoapi.ai/documents/6dcc60d0-a973-4ad2-92d8-11f4d3775532)申请相应的服务，进入页面之后，点击「Acquire」按钮，如图所示：
