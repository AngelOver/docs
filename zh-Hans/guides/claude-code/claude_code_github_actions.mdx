...
本文档主要介绍如何通过 XHuoAPI 的代理服务，配置和使用 Claude Code GitHub Actions。
...
![GitHub Claude App 安装页面](https://cdn.xhuoapi.ai/ba4b8df66d.png)
...
将 XHuoAPI 的 API 密钥添加为仓库 Secret：

1. 进入仓库 **Settings** → **Secrets and variables** → **Actions**
2. 点击 **New repository secret**
3. Name 填写 `ANTHROPIC_API_KEY`，Value 填入你在 XHuoAPI 获取的 API 令牌
4. 点击 **Add secret** 保存
...
如果需要使用 XHuoAPI 的代理 API 端点，还需要在 Workflow 中设置环境变量：
