...
## 申请流程
要使用 Hailuo Tasks API，需要先到 申请页面 [Hailuo Videos Generation API ](https://api.xhuoapi.ai/documents/ee06377b-9185-438f-ac84-3376bcb1275e)申请相应的服务，然后复制 Hailuo Videos Generation API的任务ID，如图所示：

<p><img src="https://cdn.xhuoapi.ai/4f9d95.png" width="500" className="m-auto" /></p>

最后进入Tasks API页面 [Hailuo Tasks API ](https://api.xhuoapi.ai/documents/4b1ccdbc-b8ed-4171-9a14-48e10970ba04)申请相应的服务，进入页面之后，点击「Acquire」按钮，如图所示：
...
## 请求示例
Hailuo Tasks API 可以用于查询 Hailuo Videos Generation API 的结果。关于怎样使用 Hailuo Videos Generation API，请参考文档 [Hailuo Videos Generation API ](https://api.xhuoapi.ai/documents/d2fc9087-2996-4573-bfe5-8b1c828fdfc7)。
