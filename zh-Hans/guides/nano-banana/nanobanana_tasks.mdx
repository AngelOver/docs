...
Nano Banana Tasks API 可以用于查询 Nano Banana Images API 的结果。关于怎样使用 Nano Banana Images API，请参考文档 [Nano Banana Images API ](https://api.xhuoapi.ai/documents/63e01dc3-eb21-499e-8049-3025c460058f)。
