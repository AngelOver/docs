...
## 申请流程
要使用 Veo Tasks API，需要先到 申请页面 [Veo Videos Generation API ](https://api.xhuoapi.ai/documents/63e01dc3-eb21-499e-8049-3025c460058f)申请相应的服务，然后复制 Veo Videos Generation API的任务ID，如图所示：

<p><img src="https://cdn.xhuoapi.ai/txlg6g.png" width="500" className="m-auto" /></p>

最后进入Tasks API页面 [Veo Tasks API ](https://api.xhuoapi.ai/documents/52778f8b-93ce-4db3-a62c-bcf0a92e5f3c)申请相应的服务，进入页面之后，点击「Acquire」按钮，如图所示：
...
## 请求示例
Veo Tasks API 可以用于查询 Veo Videos Generation API 的结果。关于怎样使用 Veo Videos Generation API，请参考文档 [Veo Videos Generation API ](https://api.xhuoapi.ai/documents/63e01dc3-eb21-499e-8049-3025c460058f)。
