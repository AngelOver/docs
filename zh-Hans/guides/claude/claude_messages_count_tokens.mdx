...
要使用 Claude Messages Count Tokens API，首先可以到 [Claude Messages Count Tokens API](https://api.xhuoapi.ai/documents/claude-messages-count-tokens) 页面点击「Acquire」按钮，获取请求所需要的凭证。
