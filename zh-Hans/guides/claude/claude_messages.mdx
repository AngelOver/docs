...
要使用 Claude Messages API，首先可以到 [Claude Messages API](https://api.xhuoapi.ai/documents/280928a2-2dce-419c-adb5-1ea835e8183a) 页面点击「Acquire」按钮，获取请求所需要的凭证：
...
XHuoAPI 同时提供两种 Claude API 格式，两者的主要区别如下：
