...
要使用 Claude Chat Completion API，首先可以到 [Claude Chat Completion API](https://api.xhuoapi.ai/documents/280928a2-2dce-419c-adb5-1ea835e8183a) 页面点击「Acquire」按钮，获取请求所需要的凭证：
