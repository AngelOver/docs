...
要使用 Kling Tasks API，需要先到 申请页面 [Kling Videos Generation API ](https://api.xhuoapi.ai/documents/3b921a16-a411-4557-8335-53f21d3f9e46)申请相应的服务，然后复制 Kling Videos Generation API的任务ID，如图所示：

<p><img src="https://cdn.xhuoapi.ai/om6p6g.png" width="500" className="m-auto" /></p>

最后进入Tasks API页面 [Kling Tasks API ](https://api.xhuoapi.ai/documents/6b43ff7b-8298-49c8-a390-83df85c2c5e5)申请相应的服务，进入页面之后，点击「Acquire」按钮，如图所示：
...
Kling Tasks API 可以用于查询 Kling Videos Generation API 的结果。关于怎样使用 Kling Videos Generation API，请参考文档 [Kling Videos Generation API ](https://api.xhuoapi.ai/documents/3b921a16-a411-4557-8335-53f21d3f9e46)。
