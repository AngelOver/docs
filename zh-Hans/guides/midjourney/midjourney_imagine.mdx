...
要使用 Midjourney Imagine API，首先可以到 [Midjourney Imagine API](https://api.xhuoapi.ai/documents/e52c028d-897a-4d51-b110-60fccbe6118d "Midjourney Imagine API") 页面点击「Acquire」按钮，获取请求所需要的凭证：
