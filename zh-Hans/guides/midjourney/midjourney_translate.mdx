...
## 申请流程
要使用 Midjourney Translate API，需要先到 申请页面 [Midjourney Translate API ](https://api.xhuoapi.ai/documents/e067d19b-7a66-4458-a45f-0fe88c1d5d34)申请相应的服务，进入页面之后，点击「Acquire」按钮，如图所示：
