...
## 申请流程
要使用 Midjourney Tasks API，需要先到 申请页面 [Midjourney Imagine API ](https://api.xhuoapi.ai/documents/e52c028d-897a-4d51-b110-60fccbe6118d)申请相应的服务，然后复制Imagine API的任务ID，如图所示：

<p><img src="https://cdn.xhuoapi.ai/lx4mwb.png" width="500" className="m-auto" /></p>

最后进入Tasks API页面 [Midjourney Tasks API ](https://api.xhuoapi.ai/documents/58ea7cc1-c685-40c3-a619-f29f9ac5d8f4)申请相应的服务，进入页面之后，点击「Acquire」按钮，如图所示：
...
## 请求示例
MIdjourney Tasks API 可以用于查询 MIdjourney Imagine API 和 MIdjourney Describe API 两个 API 的结果。关于怎样使用 MIdjourney Imagine API，请参考文档 [Midjourney Imagine API ](https://api.xhuoapi.ai/documents/b0e32002-2707-41cc-b103-a15b1f1efdc1)。关于怎样使用 Midjourney Describe，请参考 [Midjourney Describe API ](https://api.xhuoapi.ai/documents/d2a04242-507c-4a49-a17a-01bc382c5756)。
