...
要使用 Midjourney Describe API，需要先到 申请页面 [Midjourney Describe API ](https://api.xhuoapi.ai/documents/870e973b-712a-4686-ab8b-beae27f129ce)申请相应的服务，进入页面之后，点击「Acquire」按钮，如图所示：
...
![示例图片](https://cdn.xhuoapi.ai/kg7xp3.png)
