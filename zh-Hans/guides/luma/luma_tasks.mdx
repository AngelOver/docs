...
## 申请流程
要使用 Luma Tasks API，需要先到 申请页面 [Luma Videos Generation API](https://api.xhuoapi.ai/documents/5bd3597d-1ff8-44ad-a580-b66b48393e7f)申请相应的服务，然后复制 Luma Videos Generation API 的任务ID，如图所示：

![](https://cdn.xhuoapi.ai/ynk4ow.png)

最后进入Tasks API页面 [Luma Tasks API ](https://api.xhuoapi.ai/documents/7d32369c-4ead-4364-a4c5-652bc768b3ff)申请相应的服务，进入页面之后，点击「Acquire」按钮，如图所示：
...
## 请求示例
Luma Tasks API 可以用于查询 Luma Videos Generation API 的结果。关于怎样使用 Luma Videos Generation API，请参考文档 [Luma Videos Generation API](https://api.xhuoapi.ai/documents/16bb0108-1f09-45b3-97ac-16a668750a8c)。
