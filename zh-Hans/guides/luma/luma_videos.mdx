...
然而 Luma 官方是并没有提供 API 的，XHuoAPI 提供了一套 Luma 的 API，模拟对接了 Suno 官方，可以方便快捷地生成想要的视频。

## 申请和使用

要使用 Luma Videos API，首先可以到 [Luma Videos Generation API](https://api.xhuoapi.ai/documents/5bd3597d-1ff8-44ad-a580-b66b48393e7f) 页面点击「Acquire」按钮，获取请求所需要的凭证：
...
![首帧](https://cdn.xhuoapi.ai/r9vsv9.png)
...
![尾帧](https://cdn.xhuoapi.ai/0iad3k.png)
