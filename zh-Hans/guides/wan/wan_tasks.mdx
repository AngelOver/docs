...
## 申请流程
要使用 Wan Tasks API，需要先到 申请页面 [Wan Videos Generation API ](https://api.xhuoapi.ai/documents/52b0f490-1bbf-4fe5-b60e-96626d333d2c)申请相应的服务，然后复制 Wan Videos Generation API的任务ID，如图所示：

<p><img src="https://cdn.xhuoapi.ai/om6p6g.png" width="500" className="m-auto" /></p>

最后进入Tasks API页面 [Wan Tasks API ](https://api.xhuoapi.ai/documents/240ef446-cbec-461c-a633-4a64178d7018)申请相应的服务，进入页面之后，点击「Acquire」按钮，如图所示：
...
## 请求示例
Wan Tasks API 可以用于查询 Wan Videos Generation API 的结果。关于怎样使用 Wan Videos Generation API，请参考文档 [Wan Videos Generation API ](https://api.xhuoapi.ai/documents/52b0f490-1bbf-4fe5-b60e-96626d333d2c)。
