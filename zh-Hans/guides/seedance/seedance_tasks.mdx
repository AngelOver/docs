...
## 申请流程
要使用 SeeDance Tasks API，需要先到 申请页面 [SeeDance Video Generation API](https://api.xhuoapi.ai/documents/seedance-videos)申请相应的服务，然后复制 SeeDance Video Generation API的任务ID，如图所示：

<p><img src="https://cdn.xhuoapi.ai/om6p6g.png" width="500" className="m-auto" /></p>

最后进入Tasks API页面 [SeeDance Tasks API](https://api.xhuoapi.ai/documents/seedance-tasks)申请相应的服务，进入页面之后，点击「Acquire」按钮，如图所示：
...
## 请求示例
SeeDance Tasks API 可以用于查询 SeeDance Video Generation API 的结果。关于怎样使用 SeeDance Video Generation API，请参考文档 [SeeDance Video Generation API ](https://api.xhuoapi.ai/documents/seedance-videos-integration)。
