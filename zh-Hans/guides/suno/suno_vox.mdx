...
可以看到，`data` 的 `id` 字段就是我们想要的`vox_audio_id`，然后我们去[Persona API](https://api.xhuoapi.ai/documents/78bb6c62-6ce0-490f-a7df-e89d80ec0583)创建新版的Persona-v2-vox:歌手风格，具体输入如下所示：
...
然后我们可以根据上面的`persona_id`值进行新版的Persona-v2-vox:歌手风格进行创作，具体的创作方法和[Suno 歌曲生成 API 对接说明](https://api.xhuoapi.ai/documents/suno-audios-integration#%E8%87%AA%E5%AE%9A%E4%B9%89%E6%AD%8C%E6%89%8B%E9%A3%8E%E6%A0%BC%E7%94%9F%E6%88%90%E5%8A%9F%E8%83%BD)一致，最后我们就可以通过Suno Vox API来实现新版的Persona-v2-vox:歌手风格进行创作歌曲。
