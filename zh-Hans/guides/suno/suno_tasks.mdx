...
## 申请流程
要使用 Suno Tasks API，需要先到 申请页面 [Suno Audios Generation API ](https://api.xhuoapi.ai/documents/4da95d9d-7722-4a72-857d-bf6be86036e9)申请相应的服务，然后复制 Suno Audios Generation API的任务ID，如图所示：

<p><img src="https://cdn.xhuoapi.ai/bc6754.png" width="500" className="m-auto" /></p>

最后进入Tasks API页面 [Suno Tasks API ](https://api.xhuoapi.ai/documents/b0dd9823-0e01-4c75-af83-5a6e2e05bfed)申请相应的服务，进入页面之后，点击「Acquire」按钮，如图所示：
...
## 请求示例
Suno Tasks API 可以用于查询 Suno Audios Generation API 和 Suno Lyrics Generation API 两个 API 的结果。关于怎样使用 Suno Audios Generation API，请参考文档 [Suno Audios Generation API ](https://api.xhuoapi.ai/documents/d016ee3f-421b-4b6e-989a-8beba8701701)。关于怎样使用 Suno Lyrics Generation API，请参考 [Suno Lyrics Generation API ](https://api.xhuoapi.ai/documents/f1c66741-a488-43ca-91fc-e53fbbda639a)。
