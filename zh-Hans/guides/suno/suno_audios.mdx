...
然而 Suno 官方是并没有提供 API 的，XHuoAPI 提供了一套 Suno 的 API，模拟对接了 Suno 官方，可以方便快捷地生成想要的音乐。

## 申请和使用

要使用 Suno Audios API，首先可以到 [Suno Audios Generation API](https://api.xhuoapi.ai/documents/4da95d9d-7722-4a72-857d-bf6be86036e9) 页面点击「Acquire」按钮，获取请求所需要的凭证：
...
最后得到了需要设置这个歌曲为歌手风格，然后需要进入[Suno Persona API](https://api.xhuoapi.ai/documents/78bb6c62-6ce0-490f-a7df-e89d80ec0583)根据官方生成的音乐 ID `audio_id` 来生成一个歌手风格的 id 参数 `persona_id`，具体的参数如下图所示：
...
2025 年 8 月份 suno 新出 Add Insterumental 功能，首先需要上传一首清唱无配音的歌曲, 让 suno 帮你配乐，首先可以先到 [Suno Upload API](https://api.xhuoapi.ai/documents/766db278-012c-43c4-9245-5f18d8dc4d82)上传一首清唱无配乐的歌曲，对应如下如的操作如下图所示：
...
2025 年 8 月份 suno 新出 Add Vocals 功能，首先需要上传一首纯音乐，让 suno 填词、出人声歌唱，首先可以先到 [Suno Upload API](https://api.xhuoapi.ai/documents/766db278-012c-43c4-9245-5f18d8dc4d82)上传一首清唱无配乐的歌曲，对应如下如的操作如下图所示：
...
<p><img src="https://cdn.xhuoapi.ai/vkzumz.png" width="500" className="m-auto" /></p>
