...
Щоб використовувати API, спочатку потрібно перейти на відповідну сторінку [API для ідентифікації протоколу Recaptcha2](https://api.xhuoapi.ai/documents/597b8f11-26d8-4a1d-9a83-8d33bc4b8af7) для подачі заявки на відповідну послугу, після переходу на сторінку натисніть кнопку «Acquire», як показано на малюнку:
