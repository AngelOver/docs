...
Щоб використовувати Claude Chat Completion API, спочатку можна перейти на сторінку [Claude Chat Completion API](https://api.xhuoapi.ai/documents/280928a2-2dce-419c-adb5-1ea835e8183a) та натиснути кнопку «Acquire», щоб отримати необхідні для запиту облікові дані:
