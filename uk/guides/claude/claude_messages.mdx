...
Щоб використовувати Claude Messages API, спочатку можна перейти на сторінку [Claude Messages API](https://api.xhuoapi.ai/documents/280928a2-2dce-419c-adb5-1ea835e8183a) та натиснути кнопку «Acquire», щоб отримати необхідні для запиту облікові дані:
...
XHuoAPI одночасно надає два формати API Claude, основні відмінності між якими наведені нижче:
