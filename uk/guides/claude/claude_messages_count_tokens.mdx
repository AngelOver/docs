...
Щоб використовувати Claude Messages Count Tokens API, спочатку можна перейти на сторінку [Claude Messages Count Tokens API](https://api.xhuoapi.ai/documents/claude-messages-count-tokens) та натиснути кнопку «Acquire», щоб отримати необхідні для запиту облікові дані.
