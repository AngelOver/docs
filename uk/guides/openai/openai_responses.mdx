...
Щоб використовувати OpenAI Responses API, спочатку можна перейти на сторінку [OpenAI Responses API](https://api.xhuoapi.ai/documents/81e285a6-d010-4a2d-a3a8-ca113d4ef82a) і натиснути кнопку «Acquire», щоб отримати необхідні для запиту облікові дані:
