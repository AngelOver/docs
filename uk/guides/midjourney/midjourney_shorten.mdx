...
Щоб користуватися Midjourney Shorten API, потрібно спочатку подати заявку на сторінці [Midjourney Shorten API](https://api.xhuoapi.ai/documents/f0c6be1d-c084-43ac-bde6-44ef9cf824a2). Після переходу на сторінку натисніть кнопку «Acquire».

Якщо ви ще не увійшли в систему або не зареєстровані, вас автоматично перенаправлять на [сторінку входу](https://api.xhuoapi.ai) для реєстрації та авторизації. Після входу ви повернетесь на цю сторінку.
