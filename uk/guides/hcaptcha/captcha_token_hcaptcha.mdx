...
Щоб використовувати API, спочатку потрібно перейти на відповідну сторінку [hCaptcha протоколу розпізнавання API](https://api.xhuoapi.ai/documents/34806b3a-f0f6-45c5-b8b1-143ced7b9393) для подачі заявки на відповідну послугу, після переходу на сторінку натисніть кнопку «Acquire», як показано на малюнку:
