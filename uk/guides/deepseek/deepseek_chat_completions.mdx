...
Щоб використовувати DeepSeek Chat Completion API, спочатку можна перейти на сторінку [DeepSeek Chat Completion API](https://api.xhuoapi.ai/documents/2d6a9bae-9a70-4aaa-bd72-28e5bd60fa67) та натиснути кнопку «Acquire», щоб отримати необхідні для запиту облікові дані:
