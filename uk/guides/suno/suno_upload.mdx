...
Тут ми вводимо `audio_url`, який є `https://cdn.xhuoapi.ai/suno_demo.mp3`, це відкрита CDN адреса.
...
Отримавши ID пісні, ми можемо використовувати [Suno Audios Generation API](https://api.xhuoapi.ai/documents/4da95d9d-7722-4a72-857d-bf6be86036e9) для генерації кастомізованих пісень, наприклад, передавши `action` як `upload_extend`, а `audio_id` як повернений ID пісні, ми можемо створити нову пісню на основі референсного аудіо.
