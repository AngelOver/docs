...
Після отримання ID голосового персонажа можна використовувати [Suno Audios Generation API](https://api.xhuoapi.ai/documents/4da95d9d-7722-4a72-857d-bf6be86036e9) для генерації музики. Встановіть `action` у `generate`, а `persona_id` — у ID створеного голосового персонажа. Згенерована пісня буде виконана клонованим голосом.
