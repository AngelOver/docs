...
Щоб використовувати Sora Tasks API, спочатку потрібно перейти на сторінку подачі заявки [Sora Videos Generation API](https://api.xhuoapi.ai/documents/99a24421-2e22-4028-8201-e19cb834b67e) та подати заявку на відповідну послугу, а потім скопіювати ID завдання Sora Videos Generation API, як показано на малюнку:

<p><img src="https://cdn.xhuoapi.ai/za62pb.png" width="500" className="m-auto" /></p>

Нарешті, перейдіть на сторінку Tasks API [Sora Tasks API](https://api.xhuoapi.ai/documents/c9d81bad-9064-4796-86b6-4fb43cc93a16) та подайте заявку на відповідну послугу, після входу на сторінку натисніть кнопку «Acquire», як показано на малюнку:

![Сторінка подачі заявки](https://cdn.xhuoapi.ai/rci31i.png)

Якщо ви ще не увійшли в систему або не зареєструвалися, вас автоматично перенаправлять на [сторінку входу](https://api.xhuoapi.ai), щоб запросити вас зареєструватися та увійти. Після входу або реєстрації ви автоматично повернетеся на поточну сторінку.

При першій подачі заявки вам буде надано безкоштовний ліміт, який дозволяє безкоштовно використовувати цей API.

## Приклад запиту

Sora Tasks API можна використовувати для перевірки результатів Sora Videos Generation API. Щоб дізнатися, як використовувати Sora Videos Generation API, зверніться до документа [Sora Videos Generation API](https://api.xhuoapi.ai/documents/sora-videos-integration).
