...
Щоб використовувати Gemini Chat Completion API, спочатку можна перейти на сторінку [Kimi Chat Completion API](https://api.xhuoapi.ai/documents/b23bbfa3-c820-47ee-b307-6c6dedc9d0cf) і натиснути кнопку «Acquire», щоб отримати необхідні для запиту облікові дані:
