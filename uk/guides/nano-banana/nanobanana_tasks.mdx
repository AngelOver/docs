...
Nano Banana Tasks API можна використовувати для перевірки результатів Nano Banana Images API. Щоб дізнатися, як використовувати Nano Banana Images API, будь ласка, зверніться до документа [Nano Banana Images API](https://api.xhuoapi.ai/documents/63e01dc3-eb21-499e-8049-3025c460058f).
