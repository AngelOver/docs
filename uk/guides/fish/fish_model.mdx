...
Для використання API необхідно спочатку подати заявку на відповідний сервіс на сторінці [Fish Model API](https://api.xhuoapi.ai/services/caf99abc-ddcf-4714-b2a5-862d9b469509). Після переходу на сторінку натисніть кнопку «Acquire».
