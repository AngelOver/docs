...
Щоб використовувати Wan Tasks API, спочатку потрібно перейти на сторінку подачі заявки [Wan Videos Generation API](https://api.xhuoapi.ai/documents/52b0f490-1bbf-4fe5-b60e-96626d333d2c) для отримання відповідної послуги, а потім скопіювати ID завдання Wan Videos Generation API, як показано на малюнку:

<p><img src="https://cdn.xhuoapi.ai/om6p6g.png" width="500" className="m-auto" /></p>

Нарешті, перейдіть на сторінку Tasks API [Wan Tasks API](https://api.xhuoapi.ai/documents/240ef446-cbec-461c-a633-4a64178d7018) для отримання відповідної послуги, після входу на сторінку натисніть кнопку «Acquire», як показано на малюнку:
...
Wan Tasks API можна використовувати для перевірки результатів Wan Videos Generation API. Щоб дізнатися, як використовувати Wan Videos Generation API, будь ласка, зверніться до документа [Wan Videos Generation API](https://api.xhuoapi.ai/documents/52b0f490-1bbf-4fe5-b60e-96626d333d2c).
