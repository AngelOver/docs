...
[MCP (Model Context Protocol)](https://modelcontextprotocol.io) ist ein von Anthropic eingeführtes Modellkontextprotokoll, das es KI-Modellen (wie Claude, GPT usw.) ermöglicht, externe Werkzeuge über standardisierte Schnittstellen aufzurufen. Über den von XHuoAPI bereitgestellten Sora MCP Server kannst du in AI-Clients wie Claude Desktop, VS Code, Cursor usw. direkt OpenAI Sora zur Erstellung von KI-Videos verwenden.
...
2. Gehe zur Seite [Sora Videos API](https://api.xhuoapi.ai/documents/sora-videos)
...
- GitHub Repository: [XHuoAPI/SoraMCP](https://github.com/XHuoAPI/SoraMCP)
- PyPI Paket: [mcp-sora](https://pypi.org/project/mcp-sora/)
- API Dokumentation: [Sora Video Generierungs API](https://api.xhuoapi.ai/documents/sora)
