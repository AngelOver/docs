...
[MCP (Model Context Protocol)](https://modelcontextprotocol.io) ist ein von Anthropic entwickeltes Modellkontextprotokoll, das es KI-Modellen (wie Claude, GPT usw.) ermöglicht, externe Tools über standardisierte Schnittstellen aufzurufen. Mit dem von XHuoAPI bereitgestellten Seedance MCP Server können Sie in AI-Clients wie Claude Desktop, VS Code, Cursor direkt die von ByteDance Seedance erzeugten AI-Videos nutzen.
...
2. Navigieren zur [Seedance Videos API](https://api.xhuoapi.ai/documents/seedance-videos) Seite
...
- API Dokumentation: [Seedance Videoerzeugungs-API](https://api.xhuoapi.ai/documents/seedance)
