...
[MCP (Model Context Protocol)](https://modelcontextprotocol.io) ist ein von Anthropic eingeführtes Modellkontextprotokoll, das es KI-Modellen (wie Claude, GPT usw.) ermöglicht, externe Werkzeuge über standardisierte Schnittstellen aufzurufen. Über den von XHuoAPI bereitgestellten Nano Banana MCP Server kannst du direkt in AI-Clients wie Claude Desktop, VS Code, Cursor usw. KI-Bilder generieren und bearbeiten.
...
2. Gehe zur Seite [Nano Banana Images API](https://api.xhuoapi.ai/documents/nano-banana-images)
