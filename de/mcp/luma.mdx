...
[MCP (Model Context Protocol)](https://modelcontextprotocol.io) ist ein von Anthropic eingeführtes Modellkontextprotokoll, das es KI-Modellen (wie Claude, GPT usw.) ermöglicht, externe Tools über standardisierte Schnittstellen aufzurufen. Über den von XHuoAPI bereitgestellten Luma MCP Server kannst du direkt in AI-Clients wie Claude Desktop, VS Code, Cursor usw. KI-Videos generieren.
...
2. Gehe zur Seite [Luma Videos API](https://api.xhuoapi.ai/documents/luma-videos)
...
- GitHub Repository: [XHuoAPI/LumaMCP](https://github.com/XHuoAPI/LumaMCP)
- PyPI Paket: [mcp-luma](https://pypi.org/project/mcp-luma/)
- API Dokumentation: [Luma Video Generierungs API](https://api.xhuoapi.ai/documents/luma)
