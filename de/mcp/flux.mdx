...
[MCP (Model Context Protocol)](https://modelcontextprotocol.io) ist ein von Anthropic entwickeltes Modellkontextprotokoll, das es KI-Modellen (wie Claude, GPT usw.) ermöglicht, über standardisierte Schnittstellen externe Tools aufzurufen. Über den von XHuoAPI bereitgestellten Flux MCP Server kannst du in AI-Clients wie Claude Desktop, VS Code, Cursor direkt AI-Bilder generieren und bearbeiten.
...
Vor der Nutzung benötigst du einen XHuoAPI API Token:

1. Registriere dich oder melde dich an auf der [XHuoAPI Plattform](https://api.xhuoapi.ai)
2. Gehe zur [Flux Images API](https://api.xhuoapi.ai/documents/flux-images) Seite
...
- API Dokumentation: [Flux Bildgenerierungs-API](https://api.xhuoapi.ai/documents/flux)
