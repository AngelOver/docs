...
[MCP (Model Context Protocol)](https://modelcontextprotocol.io) ist ein von Anthropic eingeführtes Modellkontextprotokoll, das es KI-Modellen (wie Claude, GPT usw.) ermöglicht, externe Werkzeuge über standardisierte Schnittstellen aufzurufen. Über den von XHuoAPI bereitgestellten Midjourney MCP Server kannst du direkt in KI-Clients wie Claude Desktop, VS Code, Cursor usw. KI-Bilder generieren und bearbeiten.
...
2. Gehe zur [Midjourney Imagine API](https://api.xhuoapi.ai/documents/midjourney-imagine) Seite
...
- GitHub Repository: [XHuoAPI/MidjourneyMCP](https://github.com/XHuoAPI/MidjourneyMCP)
- PyPI Paket: [mcp-midjourney](https://pypi.org/project/mcp-midjourney/)
- API Dokumentation: [Midjourney Generierungs-API](https://api.xhuoapi.ai/documents/midjourney)
