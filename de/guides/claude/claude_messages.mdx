...
Um die Claude Messages API zu nutzen, können Sie zunächst die Seite [Claude Messages API](https://api.xhuoapi.ai/documents/280928a2-2dce-419c-adb5-1ea835e8183a) besuchen und auf die Schaltfläche „Acquire“ klicken, um die erforderlichen Anmeldeinformationen zu erhalten:
...
XHuoAPI bietet zwei Formate der Claude API an, die Hauptunterschiede sind wie folgt:
