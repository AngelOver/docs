...
Um die API zu nutzen, müssen Sie zunächst auf die entsprechende Seite der [hCaptcha Protokoll Erkennungs-API](https://api.xhuoapi.ai/documents/34806b3a-f0f6-45c5-b8b1-143ced7b9393) gehen und den entsprechenden Dienst beantragen. Nachdem Sie die Seite betreten haben, klicken Sie auf die Schaltfläche „Acquire“, wie im Bild gezeigt:
