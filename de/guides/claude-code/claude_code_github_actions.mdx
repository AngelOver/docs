...
Dieses Dokument beschreibt hauptsächlich, wie man über den Proxy-Service von XHuoAPI Claude Code GitHub Actions konfiguriert und verwendet.

## Antragsprozess

Um Claude Code zu verwenden, kannst du zunächst zur [Claude Messages Service-Seite](https://api.xhuoapi.ai/documents/claude-messages) gehen und auf die Schaltfläche „Acquire“ klicken, um die benötigten Anmeldeinformationen zu erhalten:
...
![GitHub Claude App Installationsseite](https://cdn.xhuoapi.ai/ba4b8df66d.png)
...
Füge den API-Schlüssel von XHuoAPI als Repository-Secret hinzu:

1. Gehe zu **Settings** → **Secrets and variables** → **Actions** im Repository.
2. Klicke auf **New repository secret**.
3. Gib bei Name `ANTHROPIC_API_KEY` ein und füge den API-Token ein, den du bei XHuoAPI erhalten hast.
4. Klicke auf **Add secret**, um zu speichern.

> **Hinweis**: Der API-Token kann im [XHuoAPI Dashboard](https://api.xhuoapi.ai/console) eingesehen werden.
...
Wenn du den Proxy-API-Endpunkt von XHuoAPI verwenden möchtest, musst du auch Umgebungsvariablen im Workflow festlegen:
