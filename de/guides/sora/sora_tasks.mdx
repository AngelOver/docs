...
Um die Sora Tasks API zu nutzen, müssen Sie zunächst auf die Anmeldeseite [Sora Videos Generation API](https://api.xhuoapi.ai/documents/99a24421-2e22-4028-8201-e19cb834b67e) gehen und den entsprechenden Service beantragen, dann kopieren Sie die Task-ID der Sora Videos Generation API, wie im Bild gezeigt:

<p><img src="https://cdn.xhuoapi.ai/za62pb.png" width="500" className="m-auto" /></p>

Gehen Sie schließlich zur Tasks API-Seite [Sora Tasks API](https://api.xhuoapi.ai/documents/c9d81bad-9064-4796-86b6-4fb43cc93a16), um den entsprechenden Service zu beantragen. Klicken Sie nach dem Betreten der Seite auf die Schaltfläche „Acquire“, wie im Bild gezeigt:
...
Die Sora Tasks API kann verwendet werden, um die Ergebnisse der Sora Videos Generation API abzufragen. Informationen zur Nutzung der Sora Videos Generation API finden Sie im Dokument [Sora Videos Generation API](https://api.xhuoapi.ai/documents/sora-videos-integration).
