...
Um die OpenAI Chat Completion API zu nutzen, können Sie zunächst auf die Seite [OpenAI Chat Completion API](https://api.xhuoapi.ai/documents/1bcf3bba-102b-495d-9bba-47cd96717e45) gehen und auf die Schaltfläche „Acquire“ klicken, um die benötigten Anmeldeinformationen zu erhalten:
...
OPENAI_BASE_URL="https://api.xhuoapi.ai/v1/openai"  # Nochmals zur Erinnerung: Wenn Sie den Key von der offiziellen OpenAI verwenden, verwenden Sie diese Adresse nicht.
```
