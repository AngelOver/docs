...
Um die Midjourney Tasks API zu nutzen, müssen Sie zunächst auf die Anmeldeseite [Midjourney Imagine API](https://api.xhuoapi.ai/documents/e52c028d-897a-4d51-b110-60fccbe6118d) gehen und den entsprechenden Service beantragen, dann kopieren Sie die Task-ID der Imagine API, wie im Bild gezeigt:

<p><img src="https://cdn.xhuoapi.ai/lx4mwb.png" width="500" className="m-auto" /></p>

Gehen Sie schließlich zur Tasks API-Seite [Midjourney Tasks API](https://api.xhuoapi.ai/documents/58ea7cc1-c685-40c3-a619-f29f9ac5d8f4), um den entsprechenden Service zu beantragen. Klicken Sie nach dem Betreten der Seite auf die Schaltfläche „Acquire“, wie im Bild gezeigt:
...
Die Midjourney Tasks API kann verwendet werden, um die Ergebnisse der Midjourney Imagine API und der Midjourney Describe API abzufragen. Informationen zur Verwendung der Midjourney Imagine API finden Sie in der Dokumentation [Midjourney Imagine API](https://api.xhuoapi.ai/documents/b0e32002-2707-41cc-b103-a15b1f1efdc1). Informationen zur Verwendung der Midjourney Describe API finden Sie unter [Midjourney Describe API](https://api.xhuoapi.ai/documents/d2a04242-507c-4a49-a17a-01bc382c5756).
