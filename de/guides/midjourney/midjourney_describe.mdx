...
Um die Midjourney Describe API zu nutzen, müssen Sie zunächst auf die Anmeldeseite [Midjourney Describe API](https://api.xhuoapi.ai/documents/870e973b-712a-4686-ab8b-beae27f129ce) gehen und den entsprechenden Dienst beantragen. Nach dem Betreten der Seite klicken Sie auf die Schaltfläche „Acquire“, wie im Bild gezeigt:
...
![Beispielbild](https://cdn.xhuoapi.ai/kg7xp3.png)
