...
Um die API zu nutzen, müssen Sie zunächst auf die entsprechende Seite der [Midjourney Edits API](https://api.xhuoapi.ai/documents/midjourney-edits) gehen und den entsprechenden Dienst beantragen. Nach dem Betreten der Seite klicken Sie auf die Schaltfläche „Acquire“, wie im Bild gezeigt:
