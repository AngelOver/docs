...
Allerdings bietet Luma offiziell keine API an. XHuoAPI stellt eine Reihe von Luma-APIs zur Verfügung, die die offizielle Suno-Integration simulieren und es ermöglichen, schnell und einfach die gewünschten Videos zu generieren.

## Antrag und Nutzung

Um die Luma Videos API zu nutzen, können Sie zunächst die Seite [Luma Videos Generation API](https://api.xhuoapi.ai/documents/5bd3597d-1ff8-44ad-a580-b66b48393e7f) besuchen und auf die Schaltfläche „Acquire“ klicken, um die benötigten Anmeldeinformationen zu erhalten:
...
![Startbild](https://cdn.xhuoapi.ai/r9vsv9.png)
...
![Endbild](https://cdn.xhuoapi.ai/0iad3k.png)
