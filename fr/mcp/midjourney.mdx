...
Avant d'utiliser, vous devez obtenir un token API XHuoAPI :

1. Inscrivez-vous ou connectez-vous à la [plateforme XHuoAPI](https://api.xhuoapi.ai)
2. Allez à la page [Midjourney Imagine API](https://api.xhuoapi.ai/documents/midjourney-imagine)
...
- Dépôt GitHub : [XHuoAPI/MidjourneyMCP](https://github.com/XHuoAPI/MidjourneyMCP)
- Package PyPI : [mcp-midjourney](https://pypi.org/project/mcp-midjourney/)
- Documentation API : [API de génération Midjourney](https://api.xhuoapi.ai/documents/midjourney)
