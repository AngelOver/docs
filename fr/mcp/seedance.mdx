...
2. Rendez-vous sur la page [Seedance Videos API](https://api.xhuoapi.ai/documents/seedance-videos)
...
```json
{
  "mcpServers": {
    "seedance": {
      ...
      "env": {
        "XHuoAPI_API_TOKEN": "votreTokenAPI"
      }
    }
  }
}
...
- Dépôt GitHub : [XHuoAPI/SeedanceMCP](https://github.com/XHuoAPI/SeedanceMCP)
- Package PyPI : [mcp-seedance](https://pypi.org/project/mcp-seedance/)
- Documentation API : [Seedance vidéo génération API](https://api.xhuoapi.ai/documents/seedance)
