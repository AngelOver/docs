...
2. Rendez-vous sur la page [Luma Videos API](https://api.xhuoapi.ai/documents/luma-videos)
...
- Dépôt GitHub : [XHuoAPI/LumaMCP](https://github.com/XHuoAPI/LumaMCP)
- Package PyPI : [mcp-luma](https://pypi.org/project/mcp-luma/)
- Documentation API : [API de génération de vidéos Luma](https://api.xhuoapi.ai/documents/luma)
