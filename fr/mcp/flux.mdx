...
2. Rendez-vous sur la page [Flux Images API](https://api.xhuoapi.ai/documents/flux-images)
...
- Dépôt GitHub : [XHuoAPI/FluxMCP](https://github.com/XHuoAPI/FluxMCP)
- Package PyPI : [mcp-flux-pro](https://pypi.org/project/mcp-flux-pro/)
- Documentation API : [Flux Image Generation API](https://api.xhuoapi.ai/documents/flux)
