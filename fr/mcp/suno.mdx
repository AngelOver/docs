...
2. Allez à la page [Suno Audios API](https://api.xhuoapi.ai/documents/suno-audios)
...
- Dépôt GitHub : [XHuoAPI/SunoMCP](https://github.com/XHuoAPI/SunoMCP)
- Paquet PyPI : [mcp-suno](https://pypi.org/project/mcp-suno/)
- Documentation API : [API de génération de musique Suno](https://api.xhuoapi.ai/documents/suno)
