...
2. Rendez-vous sur la page [Sora Videos API](https://api.xhuoapi.ai/documents/sora-videos)
...
- Dépôt GitHub : [XHuoAPI/SoraMCP](https://github.com/XHuoAPI/SoraMCP)
- Package PyPI : [mcp-sora](https://pypi.org/project/mcp-sora/)
- Documentation API : [API de génération de vidéos Sora](https://api.xhuoapi.ai/documents/sora)
