...
Pour utiliser l'API Claude Chat Completion, vous pouvez d'abord vous rendre sur la page [Claude Chat Completion API](https://api.xhuoapi.ai/documents/280928a2-2dce-419c-adb5-1ea835e8183a) et cliquer sur le bouton « Acquire » pour obtenir les informations d'identification nécessaires à la demande :
