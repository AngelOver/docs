...
Pour utiliser l'API, vous devez d'abord vous rendre sur la page correspondante de l'[API de vérification des trois éléments du numéro de téléphone](https://api.xhuoapi.ai/documents/b4c50108-dda5-4ddb-ba84-776060fb0151) pour demander le service correspondant. Une fois sur la page, cliquez sur le bouton « Acquire », comme indiqué dans l'image :
