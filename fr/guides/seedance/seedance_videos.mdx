...
Pour utiliser l'API, vous devez d'abord vous rendre sur la page [API de génération de vidéos SeeDance](https://api.xhuoapi.ai/documents/seedance-videos) pour demander le service correspondant. Une fois sur la page, cliquez sur le bouton « Acquire », comme indiqué dans l'image ci-dessous :
