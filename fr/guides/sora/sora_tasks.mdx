...
Pour utiliser l'API Sora Tasks, vous devez d'abord vous rendre sur la page de demande [Sora Videos Generation API](https://api.xhuoapi.ai/documents/99a24421-2e22-4028-8201-e19cb834b67e) pour demander le service correspondant, puis copier l'ID de tâche de l'API Sora Videos Generation, comme indiqué sur l'image :

<p><img src="https://cdn.xhuoapi.ai/za62pb.png" width="500" className="m-auto" /></p>

Enfin, accédez à la page de l'API Tasks [Sora Tasks API](https://api.xhuoapi.ai/documents/c9d81bad-9064-4796-86b6-4fb43cc93a16) pour demander le service correspondant. Une fois sur la page, cliquez sur le bouton « Acquire », comme indiqué sur l'image :
...
L'API Sora Tasks peut être utilisée pour interroger les résultats de l'API Sora Videos Generation. Pour savoir comment utiliser l'API Sora Videos Generation, veuillez consulter le document [Sora Videos Generation API](https://api.xhuoapi.ai/documents/sora-videos-integration).
