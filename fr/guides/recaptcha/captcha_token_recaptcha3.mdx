...
Pour utiliser l'API, vous devez d'abord vous rendre sur la page correspondante de l'[API d'identification de protocole Recaptcha3](https://api.xhuoapi.ai/documents/1083df69-f2f3-4c13-901e-e5336b0dbe3d) pour demander le service correspondant. Une fois sur la page, cliquez sur le bouton « Acquire », comme illustré ci-dessous :
