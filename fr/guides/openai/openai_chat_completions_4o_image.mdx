...
Pour utiliser l'API OpenAI Chat Completion 4o Image, vous pouvez d'abord vous rendre sur la page [OpenAI Chat Completion 4o Image API](https://api.xhuoapi.ai/documents/1bcf3bba-102b-495d-9bba-47cd96717e45) et cliquer sur le bouton « Acquire » pour obtenir les informations d'identification nécessaires à la demande :
