...
Pour utiliser l'API des réponses OpenAI, vous pouvez d'abord vous rendre sur la page [API des réponses OpenAI](https://api.xhuoapi.ai/documents/81e285a6-d010-4a2d-a3a8-ca113d4ef82a) et cliquer sur le bouton « Acquérir » pour obtenir les informations d'identification nécessaires à la demande :
