...
Pour utiliser l'API de Complétion de Chat OpenAI, vous pouvez d'abord vous rendre sur la page [OpenAI Chat Completion API](https://api.xhuoapi.ai/documents/1bcf3bba-102b-495d-9bba-47cd96717e45) et cliquer sur le bouton « Acquire » pour obtenir les informations d'identification nécessaires à la demande :
...
OPENAI_BASE_URL="https://api.xhuoapi.ai/v1/openai"  # Rappel : si vous utilisez la clé OpenAI officielle, n'utilisez pas cette adresse.
```
