...
Pour utiliser l'API, vous devez d'abord vous rendre sur la page correspondante de l'[API de reconnaissance de protocole hCaptcha](https://api.xhuoapi.ai/documents/34806b3a-f0f6-45c5-b8b1-143ced7b9393) pour demander le service correspondant. Une fois sur la page, cliquez sur le bouton « Acquire », comme indiqué ci-dessous :
