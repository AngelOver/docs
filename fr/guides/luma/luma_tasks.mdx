...
Pour utiliser l'API Luma Tasks, vous devez d'abord vous rendre sur la page de demande [Luma Videos Generation API](https://api.xhuoapi.ai/documents/5bd3597d-1ff8-44ad-a580-b66b48393e7f) pour demander le service correspondant, puis copier l'ID de tâche de l'API Luma Videos Generation, comme indiqué sur l'image :

![](https://cdn.xhuoapi.ai/ynk4ow.png)

Enfin, accédez à la page de l'API Tasks [Luma Tasks API](https://api.xhuoapi.ai/documents/7d32369c-4ead-4364-a4c5-652bc768b3ff) pour demander le service correspondant. Une fois sur la page, cliquez sur le bouton « Acquire », comme indiqué sur l'image :
...
L'API Luma Tasks peut être utilisée pour interroger les résultats de l'API Luma Videos Generation. Pour savoir comment utiliser l'API Luma Videos Generation, veuillez consulter le document [Luma Videos Generation API](https://api.xhuoapi.ai/documents/16bb0108-1f09-45b3-97ac-16a668750a8c).
