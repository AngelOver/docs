...
Cependant, Luma n'offre pas d'API officielle, XHuoAPI propose un ensemble d'API Luma, simulant l'intégration avec l'officiel de Suno, permettant de générer rapidement et facilement les vidéos souhaitées.

## Demande et utilisation

Pour utiliser l'API Luma Videos, vous pouvez d'abord vous rendre sur la page [Luma Videos Generation API](https://api.xhuoapi.ai/documents/5bd3597d-1ff8-44ad-a580-b66b48393e7f) et cliquer sur le bouton « Acquire » pour obtenir les informations d'identification nécessaires à la demande :
...
![Première image](https://cdn.xhuoapi.ai/r9vsv9.png)
...
![Dernière image](https://cdn.xhuoapi.ai/0iad3k.png)
