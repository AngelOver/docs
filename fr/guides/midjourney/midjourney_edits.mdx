...
Pour utiliser l'API, vous devez d'abord vous rendre sur la page correspondante de [Midjourney Edits API](https://api.xhuoapi.ai/documents/midjourney-edits) pour demander le service correspondant. Une fois sur la page, cliquez sur le bouton « Acquire », comme illustré ci-dessous :
