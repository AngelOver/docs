...
Pour utiliser l'API Midjourney Describe, vous devez d'abord vous rendre sur la page de demande [Midjourney Describe API](https://api.xhuoapi.ai/documents/870e973b-712a-4686-ab8b-beae27f129ce) pour demander le service correspondant. Une fois sur la page, cliquez sur le bouton « Acquire », comme indiqué sur l'image :
...
![Image d'exemple](https://cdn.xhuoapi.ai/kg7xp3.png)
