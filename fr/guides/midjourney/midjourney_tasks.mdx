...
Pour utiliser l'API Midjourney Tasks, vous devez d'abord vous rendre sur la page de demande [Midjourney Imagine API](https://api.xhuoapi.ai/documents/e52c028d-897a-4d51-b110-60fccbe6118d) pour demander le service correspondant, puis copier l'ID de tâche de l'API Imagine, comme indiqué dans l'image ci-dessous :

<p><img src="https://cdn.xhuoapi.ai/lx4mwb.png" width="500" className="m-auto" /></p>

Enfin, accédez à la page de l'API Tasks [Midjourney Tasks API](https://api.xhuoapi.ai/documents/58ea7cc1-c685-40c3-a619-f29f9ac5d8f4) pour demander le service correspondant. Une fois sur la page, cliquez sur le bouton « Acquire », comme indiqué dans l'image ci-dessous :
...
L'API Midjourney Tasks peut être utilisée pour interroger les résultats des API Midjourney Imagine et Midjourney Describe. Pour savoir comment utiliser l'API Midjourney Imagine, veuillez consulter le document [Midjourney Imagine API](https://api.xhuoapi.ai/documents/b0e32002-2707-41cc-b103-a15b1f1efdc1). Pour savoir comment utiliser Midjourney Describe, veuillez consulter [Midjourney Describe API](https://api.xhuoapi.ai/documents/d2a04242-507c-4a49-a17a-01bc382c5756).
