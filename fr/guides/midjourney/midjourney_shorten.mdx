...
Pour utiliser l’API Midjourney Shorten, il faut d’abord faire une demande sur la page [Midjourney Shorten API](https://api.xhuoapi.ai/documents/f0c6be1d-c084-43ac-bde6-44ef9cf824a2). Sur la page, cliquez sur le bouton « Acquire ».

Si vous n’êtes pas connecté ou inscrit, vous serez automatiquement redirigé vers la [page de connexion](https://api.xhuoapi.ai) pour vous inscrire ou vous connecter. Après connexion, vous serez ramené à cette page.
