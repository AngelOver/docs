...
Pour utiliser l'API, vous devez d'abord demander le service correspondant sur la page [SeeDream Images Generation API](https://api.xhuoapi.ai/documents/seedream-images). Une fois sur la page, cliquez sur le bouton « Acquire », comme illustré ci-dessous :
