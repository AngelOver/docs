...
L'API AI Chat v2 (`/aichat2/conversations`) est la nouvelle génération d'interface de conversation, une version entièrement améliorée de l'[API AI Chat](https://api.xhuoapi.ai/documents/59fb1199-6694-4afb-a222-3554d7f7d05a). Elle étend la simplicité et la gestion des conversations multi-tours de la v1 avec :
...
Pour utiliser l’API, rendez-vous sur la page correspondante de l'[API AI Chat v2](https://api.xhuoapi.ai/documents/e4a7c2b9-3f1d-4e8a-9b6c-a5d2f8e1b4c7) et cliquez sur le bouton « Acquire » pour obtenir les identifiants nécessaires.
...
- L’utilisateur a autorisé Google Drive / GitHub / Notion via [Connections](https://api.xhuoapi.ai/connections) → le modèle peut lire/écrire via les outils MCP correspondants.
...
Si vous utilisez déjà [`/aichat/conversations`](https://api.xhuoapi.ai/documents/59fb1199-6694-4afb-a222-3554d7f7d05a), la migration vers v2 nécessite peu de modifications :
