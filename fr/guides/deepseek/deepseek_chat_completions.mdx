...
Pour utiliser l'API de Complétion de Chat DeepSeek, vous pouvez d'abord vous rendre sur la page [API de Complétion de Chat DeepSeek](https://api.xhuoapi.ai/documents/2d6a9bae-9a70-4aaa-bd72-28e5bd60fa67) et cliquer sur le bouton « Acquire » pour obtenir les informations d'identification nécessaires à la demande :
