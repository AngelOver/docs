...
Pour utiliser l'API Kling Tasks, vous devez d'abord vous rendre sur la page de demande [Kling Videos Generation API](https://api.xhuoapi.ai/documents/3b921a16-a411-4557-8335-53f21d3f9e46) pour demander le service correspondant, puis copier l'ID de tâche de l'API Kling Videos Generation, comme indiqué dans l'image ci-dessous :

<p><img src="https://cdn.xhuoapi.ai/om6p6g.png" width="500" className="m-auto" /></p>

Enfin, accédez à la page de l'API Tasks [Kling Tasks API](https://api.xhuoapi.ai/documents/6b43ff7b-8298-49c8-a390-83df85c2c5e5) pour demander le service correspondant. Une fois sur la page, cliquez sur le bouton « Acquire », comme indiqué dans l'image ci-dessous :
...
L'API Kling Tasks peut être utilisée pour interroger les résultats de l'API Kling Videos Generation. Pour savoir comment utiliser l'API Kling Videos Generation, veuillez consulter le document [Kling Videos Generation API](https://api.xhuoapi.ai/documents/3b921a16-a411-4557-8335-53f21d3f9e46).
