...
L'API Nano Banana Tasks peut être utilisée pour interroger les résultats de l'API Nano Banana Images. Pour savoir comment utiliser l'API Nano Banana Images, veuillez consulter le document [API Nano Banana Images](https://api.xhuoapi.ai/documents/63e01dc3-eb21-499e-8049-3025c460058f).
