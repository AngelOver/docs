...
Avant utilisation, veuillez accéder à [Nano Banana Images API](https://api.xhuoapi.ai/documents/23985a11-d713-41d1-ad84-24b021805b3d) sur la plateforme XHuoAPI et cliquer sur Acquire pour demander l'activation. La première demande dispose généralement d'un quota gratuit disponible. Une fois l'activation terminée, vous pourrez obtenir le Bearer Token nécessaire pour appeler l'API sur la plateforme.
