...
Pour utiliser l'API Gemini Chat Completion, vous pouvez d'abord vous rendre sur la page [Kimi Chat Completion API](https://api.xhuoapi.ai/documents/b23bbfa3-c820-47ee-b307-6c6dedc9d0cf) et cliquer sur le bouton « Acquire » pour obtenir les informations d'identification nécessaires à la demande :
