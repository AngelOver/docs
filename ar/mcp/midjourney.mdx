...
[MCP (نموذج بروتوكول السياق)](https://modelcontextprotocol.io) هو بروتوكول سياق النموذج الذي أطلقته شركة Anthropic، والذي يسمح لنماذج الذكاء الاصطناعي (مثل Claude وGPT وغيرها) باستدعاء أدوات خارجية من خلال واجهات موحدة. من خلال خادم Midjourney MCP المقدم من XHuoAPI، يمكنك مباشرةً إنشاء وتحرير صور الذكاء الاصطناعي في عملاء الذكاء الاصطناعي مثل Claude Desktop وVS Code وCursor.
...
2. انتقل إلى صفحة [API تخيل Midjourney](https://api.xhuoapi.ai/documents/midjourney-imagine)
...
- مستودع GitHub: [XHuoAPI/MidjourneyMCP](https://github.com/XHuoAPI/MidjourneyMCP)
- حزمة PyPI: [mcp-midjourney](https://pypi.org/project/mcp-midjourney/)
- وثائق API: [API توليد Midjourney](https://api.xhuoapi.ai/documents/midjourney)
