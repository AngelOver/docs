...
لاستخدام واجهة برمجة تطبيقات مهام المنتج، يجب أولاً زيارة صفحة التقديم [واجهة برمجة تطبيقات إنتاج الصوتيات](https://api.xhuoapi.ai/documents/producer-audios) لتقديم طلب الخدمة المناسبة، ثم نسخ معرف المهمة من واجهة برمجة تطبيقات إنتاج الصوتيات كما هو موضح في الصورة:

<p><img src="https://cdn.xhuoapi.ai/om6p6g.png" width="500" className="m-auto" /></p>

أخيرًا، انتقل إلى صفحة واجهة برمجة تطبيقات المهام [واجهة برمجة تطبيقات مهام المنتج](https://api.xhuoapi.ai/documents/622626b1-30a7-4799-a772-4946e1df3ac0) لتقديم طلب الخدمة المناسبة، بعد دخول الصفحة، انقر على زر "Acquire" كما هو موضح في الصورة:
...
يمكن استخدام واجهة برمجة تطبيقات مهام المنتج لاستعلام نتائج واجهة برمجة تطبيقات إنتاج الصوتيات. لمزيد من المعلومات حول كيفية استخدام واجهة برمجة تطبيقات إنتاج الصوتيات، يرجى الرجوع إلى الوثيقة [واجهة برمجة تطبيقات إنتاج الصوتيات](https://api.xhuoapi.ai/documents/producer-audios-integration).
