...
لاستخدام واجهة برمجة التطبيقات، يجب أولاً زيارة صفحة [واجهة برمجة تطبيقات توليد الصوتيات للمنتج](https://api.xhuoapi.ai/documents/producer-audios) للتقدم للحصول على الخدمة المناسبة، بعد دخول الصفحة، انقر على زر "Acquire"، كما هو موضح في الصورة:
...
إذا كنت ترغب في الاستمرار في ترجمة الأغاني التي قمت بتحميلها، يمكنك تعيين المعامل `action` إلى `upload_cover`، وإدخال ID الأغنية التي تحتاج إلى الاستمرار في ترجمتها، يمكن الحصول على ID الأغنية باستخدام [Producer Upload API](https://api.xhuoapi.ai/documents/7fd2cb52-772e-4cc4-a018-e2626ff6f447) كما هو موضح في الصورة أدناه:
...
إذا كنت ترغب في متابعة كتابة الأغاني التي قمت بتحميلها، يمكنك تعيين المعامل `action` إلى `upload_extend`، وإدخال معرف الأغنية التي تحتاج إلى متابعة كتابتها، يمكن الحصول على معرف الأغنية باستخدام [Producer Upload API](https://api.xhuoapi.ai/documents/7fd2cb52-772e-4cc4-a018-e2626ff6f447) كما هو موضح في الصورة أدناه:
...
إذا كنت ترغب في الاستمرار في استبدال مقطع من الأغاني التي قمت بتحميلها، يمكنك تعيين معلمة `action` إلى `upload_replace_section`، وإدخال ID الأغنية التي تحتاج إلى الاستمرار في كتابتها، يمكن الحصول على ID الأغنية باستخدام [Producer Upload API](https://api.xhuoapi.ai/documents/7fd2cb52-772e-4cc4-a018-e2626ff6f447) كما هو موضح في الصورة أدناه:
