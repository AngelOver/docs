...
تتناول هذه الوثيقة كيفية تكوين واستخدام Claude Code في JetBrains IDE من خلال خدمة الوكيل XHuoAPI.

## عملية التقديم

لاستخدام Claude Code، يمكنك أولاً زيارة [صفحة خدمة Claude Messages](https://api.xhuoapi.ai/documents/claude-messages) والنقر على زر "Acquire" للحصول على الشهادات المطلوبة:
...
![ملحق Claude Code في JetBrains Marketplace](https://cdn.xhuoapi.ai/de78fd305b.png)
...
```bash
# تكوين وكيل Claude Code - XHuoAPI
...
> **تلميح**: يمكنك العثور على رمز API في [لوحة تحكم XHuoAPI](https://api.xhuoapi.ai/console).
...
3. تأكد من أن رمز API صالح (يمكنك التحقق في [اللوحة](https://api.xhuoapi.ai/console))
...
قم بتسجيل الدخول إلى [وحدة تحكم XHuoAPI](https://api.xhuoapi.ai/console) ، يمكنك من خلالها الاطلاع على الرصيد المتبقي الحالي وحالة الاستخدام.

## لمعرفة المزيد

- 📖 [وثائق Claude Code JetBrains الرسمية](https://code.claude.com/docs/en/jetbrains)
- 🔧 [خدمة XHuoAPI Claude Code](https://api.xhuoapi.ai/documents/claude-messages)
