...
لاستخدام واجهة برمجة التطبيقات لحساب رموز رسائل كلود، يمكنك أولاً زيارة صفحة [واجهة برمجة التطبيقات لحساب رموز رسائل كلود](https://api.xhuoapi.ai/documents/claude-messages-count-tokens) والنقر على زر "Acquire" للحصول على الشهادات المطلوبة للطلب.
