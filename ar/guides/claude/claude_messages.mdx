...
لاستخدام واجهة برمجة تطبيقات رسائل كلود، يمكنك أولاً زيارة صفحة [واجهة برمجة تطبيقات رسائل كلود](https://api.xhuoapi.ai/documents/280928a2-2dce-419c-adb5-1ea835e8183a) والنقر على زر "Acquire" للحصول على الشهادات المطلوبة للطلب:
...
تقدم XHuoAPI نوعين من تنسيقات واجهة برمجة تطبيقات Claude، والفرق الرئيسي بينهما كما يلي:
