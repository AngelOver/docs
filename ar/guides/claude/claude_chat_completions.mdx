...
لاستخدام واجهة برمجة تطبيقات إكمال الدردشة Claude، يمكنك أولاً زيارة صفحة [واجهة برمجة تطبيقات إكمال الدردشة Claude](https://api.xhuoapi.ai/documents/280928a2-2dce-419c-adb5-1ea835e8183a) والنقر على زر "Acquire" للحصول على الشهادات المطلوبة للطلب:
