...
لاستخدام API، يجب أولاً التقدم للحصول على الخدمة المناسبة من خلال صفحة [SeeDream Images Generation API](https://api.xhuoapi.ai/documents/seedream-images). بعد الدخول إلى الصفحة، اضغط على زر "Acquire" كما هو موضح في الصورة:
