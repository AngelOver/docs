...
لاستخدام واجهة برمجة تطبيقات مهام Midjourney، تحتاج أولاً إلى زيارة صفحة التقديم [Midjourney Imagine API](https://api.xhuoapi.ai/documents/e52c028d-897a-4d51-b110-60fccbe6118d) لتقديم الطلب للخدمة المناسبة، ثم نسخ معرف المهمة من واجهة برمجة التطبيقات كما هو موضح في الصورة:

<p><img src="https://cdn.xhuoapi.ai/lx4mwb.png" width="500" className="m-auto" /></p>

أخيرًا، انتقل إلى صفحة واجهة برمجة تطبيقات المهام [Midjourney Tasks API](https://api.xhuoapi.ai/documents/58ea7cc1-c685-40c3-a619-f29f9ac5d8f4) لتقديم الطلب للخدمة المناسبة، بعد دخول الصفحة، انقر على زر "Acquire" كما هو موضح في الصورة:
...
يمكن استخدام واجهة برمجة تطبيقات مهام Midjourney لاستعلام نتائج واجهتي برمجة التطبيقات Midjourney Imagine وMidjourney Describe. لمزيد من المعلومات حول كيفية استخدام واجهة برمجة تطبيقات Midjourney Imagine، يرجى الرجوع إلى الوثيقة [Midjourney Imagine API](https://api.xhuoapi.ai/documents/b0e32002-2707-41cc-b103-a15b1f1efdc1). لمزيد من المعلومات حول كيفية استخدام واجهة برمجة تطبيقات Midjourney Describe، يرجى الرجوع إلى [Midjourney Describe API](https://api.xhuoapi.ai/documents/d2a04242-507c-4a49-a17a-01bc382c5756).
