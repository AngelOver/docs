...
لاستخدام Midjourney Shorten API، يجب أولاً التقديم عبر صفحة التقديم [Midjourney Shorten API](https://api.xhuoapi.ai/documents/f0c6be1d-c084-43ac-bde6-44ef9cf824a2)، وبعد الدخول إلى الصفحة، اضغط على زر "Acquire".

إذا لم تكن مسجلاً أو مسجلاً دخولك، سيتم توجيهك تلقائياً إلى [صفحة تسجيل الدخول](https://api.xhuoapi.ai) لتسجيل حساب أو تسجيل الدخول، وبعد ذلك ستعود تلقائياً إلى الصفحة الحالية.
