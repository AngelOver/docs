...
لاستخدام OpenAI Chat Completion API، يمكنك أولاً زيارة صفحة [OpenAI Chat Completion API](https://api.xhuoapi.ai/documents/1bcf3bba-102b-495d-9bba-47cd96717e45) والنقر على زر "Acquire" للحصول على الشهادات المطلوبة:
...
OPENAI_BASE_URL="https://api.xhuoapi.ai/v1/openai"  # تذكير: إذا كنت تستخدم مفتاح OpenAI الرسمي، فلا تستخدم هذا العنوان.
```
