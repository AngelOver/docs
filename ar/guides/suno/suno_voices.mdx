...
بعد الحصول على معرف الشخصية الصوتية، يمكننا استخدام [واجهة برمجة تطبيقات توليد الصوتيات Suno](https://api.xhuoapi.ai/documents/4da95d9d-7722-4a72-857d-bf6be86036e9) لتوليد الموسيقى. قم بتعيين `action` إلى `generate`، و`persona_id` إلى معرف الشخصية الصوتية الذي تم إرجاعه أعلاه، وسيتم أداء الأغنية باستخدام الصوت المستنسخ.
