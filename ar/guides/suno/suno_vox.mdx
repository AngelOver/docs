...
يمكننا أن نرى أن حقل `id` في `data` هو ما نريده من `vox_audio_id`، ثم نذهب إلى [واجهة برمجة تطبيقات Persona](https://api.xhuoapi.ai/documents/78bb6c62-6ce0-490f-a7df-e89d80ec0583) لإنشاء نسخة جديدة من Persona-v2-vox: أسلوب المغني، المدخلات المحددة كما يلي:
...
ثم يمكننا استخدام قيمة `persona_id` المذكورة أعلاه لإنشاء نسخة جديدة من Persona-v2-vox: أسلوب المغني، وطريقة الإبداع المحددة تتوافق مع [تعليمات دمج واجهة برمجة تطبيقات توليد الأغاني Suno](https://api.xhuoapi.ai/documents/suno-audios-integration#%E8%87%AA%E5%AE%9A%E4%B9%89%E6%AD%8C%E6%89%8B%E9%A3%8E%E6%A0%BC%E7%94%9F%E6%88%90%E5%8A%9F%E8%83%BD)، وأخيرًا يمكننا استخدام واجهة برمجة تطبيقات Suno Vox لتحقيق الإبداع في الأغاني بأسلوب Persona-v2-vox الجديد.
