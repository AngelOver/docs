...
يمكننا أن نرى أن حقل `id` في `data` هو ما نريده من `vox_audio_id`، ثم نذهب إلى [واجهة برمجة تطبيقات Persona](https://platform.acedata.cloud/documents/78bb6c62-6ce0-490f-a7df-e89d80ec0583) لإنشاء نسخة جديدة من Persona-v2-vox: أسلوب المغني، المدخلات المحددة كما يلي:
