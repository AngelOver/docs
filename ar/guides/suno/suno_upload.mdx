...
مع معرف الأغنية، يمكننا استخدام [Suno Audios Generation API](https://platform.acedata.cloud/documents/4da95d9d-7722-4a72-857d-bf6be86036e9) لإنشاء أغاني مخصصة، على سبيل المثال، إذا تم تمرير `action` كـ `upload_extend`، وتم تمرير `audio_id` كمعرف الأغنية الذي تم إرجاعه، يمكننا إنشاء أغنية جديدة بناءً على مرجع الصوت.
