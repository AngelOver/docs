...
لاستخدام واجهة برمجة تطبيقات Luma Tasks، يجب أولاً زيارة صفحة التقديم [واجهة برمجة تطبيقات Luma Videos Generation](https://api.xhuoapi.ai/documents/5bd3597d-1ff8-44ad-a580-b66b48393e7f) لتقديم الطلب للخدمة المناسبة، ثم نسخ معرف المهمة من واجهة برمجة تطبيقات Luma Videos Generation، كما هو موضح في الصورة:

![](https://cdn.xhuoapi.ai/ynk4ow.png)

أخيرًا، انتقل إلى صفحة واجهة برمجة تطبيقات Tasks [واجهة برمجة تطبيقات Luma Tasks](https://api.xhuoapi.ai/documents/7d32369c-4ead-4364-a4c5-652bc768b3ff) لتقديم الطلب للخدمة المناسبة، بعد دخول الصفحة، انقر على زر "Acquire"، كما هو موضح في الصورة:
