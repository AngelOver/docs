...
لاستخدام DeepSeek Chat Completion API، يمكنك أولاً زيارة صفحة [DeepSeek Chat Completion API](https://api.xhuoapi.ai/documents/2d6a9bae-9a70-4aaa-bd72-28e5bd60fa67) والنقر على زر "Acquire" للحصول على الشهادات المطلوبة:
