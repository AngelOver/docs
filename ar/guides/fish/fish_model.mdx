...
لاستخدام API، يجب أولاً التقديم للحصول على الخدمة المناسبة عبر صفحة [Fish Model API](https://api.xhuoapi.ai/services/caf99abc-ddcf-4714-b2a5-862d9b469509)، وعند الدخول إلى الصفحة، اضغط على زر "Acquire".
