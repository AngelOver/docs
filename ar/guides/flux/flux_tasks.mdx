...
لاستخدام واجهة برمجة تطبيقات مهام Flux، يجب أولاً الذهاب إلى صفحة التقديم [واجهة برمجة تطبيقات توليد صور Flux](https://api.xhuoapi.ai/documents/6b9197c5-7a3f-4878-a43f-7f94e7e66394) لتقديم الطلب للخدمة المناسبة، ثم نسخ معرف المهمة من واجهة برمجة تطبيقات توليد صور Flux، كما هو موضح في الصورة:

<p><img src="https://cdn.xhuoapi.ai/7furhb.png" width="500" className="m-auto" /></p>

أخيرًا، انتقل إلى صفحة واجهة برمجة تطبيقات مهام Flux [واجهة برمجة تطبيقات مهام Flux](https://api.xhuoapi.ai/documents/39b38bbe-60f3-40da-b2b6-5ce1e091852b) لتقديم الطلب للخدمة المناسبة، بعد دخول الصفحة، انقر على زر "Acquire"، كما هو موضح في الصورة
...
يمكن استخدام واجهة برمجة تطبيقات مهام Flux لاستعلام نتائج واجهة برمجة تطبيقات توليد صور Flux. لمزيد من المعلومات حول كيفية استخدام واجهة برمجة تطبيقات توليد صور Flux، يرجى الرجوع إلى الوثيقة [واجهة برمجة تطبيقات توليد صور Flux](https://api.xhuoapi.ai/documents/flux-images-integration).
